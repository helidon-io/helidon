...
class CustomAnnotationProcessorTest {
    ...
    void extensibleGET() {
        ...
        TypeName generatedTypeName =
                TypeName.create("io.helidon.inject.processor.testsubjects.BasicEndpoint_ExtensibleGET_itWorks");
        ...
        MatcherAssert.assertThat(generatedSource,
                                 equalTo(TestUtils.loadStringFromResource("expected/BasicEndpoint_ExtensibleGET._java_")));
    }
