 ...
 */
@Prototype.Blueprint(decorator = CallingContextBlueprint.BuilderInterceptor.class)
interface CallingContextBlueprint {
    ...
    class BuilderInterceptor implements Prototype.BuilderDecorator<CallingContext.BuilderBase<?, ?>> {
        @Override
        public CallingContext.BuilderBase<?, ?> decorate(CallingContext.BuilderBase<?, ?> target) {
