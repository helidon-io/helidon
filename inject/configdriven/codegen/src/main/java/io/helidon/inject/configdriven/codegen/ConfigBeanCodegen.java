...
class ConfigBeanCodegen implements InjectCodegenExtension {
    private static final Annotation SINGLETON_ANNOTATION = Annotation.create(InjectCodegenTypes.INJECTION_SINGLETON);
    private static final Annotation EAGER_ANNOTATION = Annotation.create(InjectCodegenTypes.INJECTION_EAGER);
    private static final Annotation INJECT_ANNOTATION = Annotation.create(InjectCodegenTypes.INJECTION_INJECT);
    private static final Annotation CONFIG_BEAN_ANNOTATION = Annotation.create(ConfigBeanAnnotation.CONFIG_BEAN_TYPE);
    ...
    public void process(RoundContext roundContext) {
        ...
        for (TypeInfo typeInfo : roundContext.annotatedTypes(ConfigBeanAnnotation.CONFIG_BEAN_TYPE)) {
            if (typeInfo.hasAnnotation(InjectCodegenTypes.INJECTION_SINGLETON)) {
            ...
            ClassModel.Builder classModel = ClassModel.builder()
                    ...
                    .addAnnotation(EAGER_ANNOTATION)
