...
class NoScopeLookupTest {
    ...
    void allSuppliersLookupTest() {
        List<Supplier<ContractNoScope>> suppliers = services.allSuppliers(LOOKUP);
        ...
        List<Supplier<ContractNoScope>> noIpProviderSuppliers = services.allSuppliers(LOOKUP_NO_IP_PROVIDER);
    ...
    void allSuppliersTypeTest() {
        List<Supplier<ContractNoScope>> suppliers = services.allSuppliers(CONTRACT);
