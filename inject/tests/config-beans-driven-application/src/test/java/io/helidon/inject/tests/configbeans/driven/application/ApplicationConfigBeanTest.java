...
import io.helidon.inject.tests.configbeans.driven.configuredby.test.AbstractConfigBeanTest;

/**
 * Designed to re-run the same tests from base, but using the application-created DI model instead.
 */
class ApplicationConfigBeanTest extends AbstractConfigBeanTest {
