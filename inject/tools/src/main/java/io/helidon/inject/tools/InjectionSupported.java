 ...
 */
class InjectionSupported {

    private InjectionSupported() {
    }

    /**
     * Returns true if the targetElement can be supported within the model as an injection point target.
     *
     ...
     * @return true if the target supports injection, false otherwise (assuming not throwIfNotSupported)
     */
