...
public class TypeToolsTest {
    ...
    void optionalsProvidersAndListsOfFieldInfo() {
        ...
        optionalsProvidersAndListsException("Unsupported type for D in abstract static class io.helidon.inject.tools"
    ...
    private void optionalsProvidersAndLists(TypeName expectedType,
        ...
        MatcherAssert.assertThat(TypeTools.extractInjectionPointTypeInfo(fld, isProvider, isList, isOptional), equalTo(expectedType));
    ...
    private void optionalsProvidersAndListsException(String exceptedException,
        ...
        Exception te = assertThrows(IllegalStateException.class,
                                         () -> TypeTools.extractInjectionPointTypeInfo(fld, isProvider, isList, isOptional));
