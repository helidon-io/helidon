...
public class VirtualBufferTest {
    ...
    public void singleBufferSliceTest() {
        ...
        List<VirtualBuffer.BufferEntry> slices = buf.slice(3, 6);
    ...
    public void singleBufferWithOffsetSliceTest() {
        VirtualBuffer buf = new VirtualBuffer();
        buf.offer(ByteBuffer.wrap("xxxfoo".getBytes()), 3);
        List<VirtualBuffer.BufferEntry> slices = buf.slice(0, 3);
        assertThat(slices.size(), is(equalTo(1)));
        ByteBuffer bb = slices.get(0).buffer();
        assertThat(new String(Utils.toByteArray(bb)), is(equalTo("foo")));
    }
    ...
    public void multipleBuffersWithOffsetSliceTest() {
        ...
        List<VirtualBuffer.BufferEntry> slices1 = buf.slice(0, 3);
        ...
        List<VirtualBuffer.BufferEntry> slices2 = buf.slice(3, 6);
    ...
    public void accumulateBufferTest() {
        ...
        List<VirtualBuffer.BufferEntry> slices1 = buf.slice(30, 31);
        ...
        List<VirtualBuffer.BufferEntry> slices2 = buf.slice(0, 12);
        ...
        List<VirtualBuffer.BufferEntry> slices3 = buf.slice(0, 22);
        ...
        List<VirtualBuffer.BufferEntry> slices4 = buf.slice(53, 57);
        ...
        assertThat(buf.buffersCount(), is(equalTo(2)));
        List<VirtualBuffer.BufferEntry> slices5 = buf.slice(24, 41);
