...
public interface Retry extends FtHandler {
    ...
    /**
     * Fluent API builder for {@link Retry}.
     */
    @Configured
    class Builder implements io.helidon.common.Builder<Builder, Retry> {
         ...
         * Defaults to a {@link Retry.JitterRetryPolicy}
         ...
         * {@link FaultTolerance#scheduledExecutor(java.util.function.Supplier)}.
         *
    ...
    class FibonacciRetryPolicy implements RetryPolicy {
        ...
        /**
         * A new fluent API builder to configure instances of {@link io.helidon.reactive.faulttolerance.Retry}.
         *
         * @return a new builder
         */
        public static Builder builder() {
        ...
        /**
         * Fluent API builder for {@link io.helidon.reactive.faulttolerance.Retry.FibonacciRetryPolicy}.
         */
        @Configured(provides = RetryPolicy.class)
    ...
    class ExponentialRetryPolicy implements RetryPolicy {
        ...
        /**
         * Fluent API builder for {@link io.helidon.reactive.faulttolerance.Retry.ExponentialRetryPolicy}.
         */
        @Configured(provides = RetryPolicy.class)
