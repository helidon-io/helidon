 ...
 * <ul>
 *     <li>{@link Async} - invoke a blocking synchronous call asynchronously in an executor service</li>
 *     <li>{@link Bulkhead} - limit number of parallel requests to a resource</li>
 *     <li>{@link CircuitBreaker} - stop trying to request a failing resource until it becomes
 *     available</li>
 *     <li>{@link Fallback} - fall back to another supplier of result in case the usual one fails</li>
 *     <li>{@link Retry} - try to call a supplier again if invocation fails</li>
 *     <li>{@link Timeout} - time out a request if it takes too long</li>
 * </ul>
...
public final class FaultTolerance {
     ...
     *
     * @param executor executor service to use, such as for {@link Async}
     */
     ...
     *
     * @param executor scheduled executor service to use, such as for {@link Retry} scheduling
     */
     ...
     * {@link Fallback}.
     * An instance is returned from {@link FaultTolerance.Builder#addFallback(Fallback)}.
     *
