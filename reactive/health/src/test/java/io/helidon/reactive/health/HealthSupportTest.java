...
class HealthSupportTest {
    ...
    void testInclusionAndExclusion(List<String> includedHealthChecks,
        ...
        HealthSupport.HealthHttpResponse response = support.callHealthChecks(wrap(allChecks));
    ...
    void noHealthChecksResultsInSuccess() {
        ...
        HealthSupport.HealthHttpResponse response = support.callHealthChecks(List.of());
    ...
    void checksAreSortedByName() {
        ...
        HealthSupport.HealthHttpResponse response = support.callHealthChecks(wrap(checks));
    ...
    void passingHealthChecksResultInSuccess(List<HealthCheck> goodChecks) {
        ...
        HealthSupport.HealthHttpResponse response = support.callHealthChecks(wrap(goodChecks));
    ...
    void failingHealthChecksResultInFailure(List<HealthCheck> badChecks) {
        ...
        HealthSupport.HealthHttpResponse response = support.callHealthChecks(wrap(badChecks));
    ...
    void brokenHealthChecksResultInFailure(List<HealthCheck> brokenChecks) {
        ...
        HealthSupport.HealthHttpResponse response = support.callHealthChecks(wrap(brokenChecks));
    ...
    private static List<io.helidon.health.HealthCheck> wrap(List<HealthCheck> allChecks) {
        return allChecks.stream()
                .map(it -> MpCheckWrapper.create(HealthCheckType.LIVENESS, it))
                .toList();
    }
}
