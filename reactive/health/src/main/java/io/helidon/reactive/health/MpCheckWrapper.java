...
class MpCheckWrapper implements ReactiveHealthCheck {
    ...
    static HealthCheck create(HealthCheckType type, org.eclipse.microprofile.health.HealthCheck delegate) {
        String name;
        try {
