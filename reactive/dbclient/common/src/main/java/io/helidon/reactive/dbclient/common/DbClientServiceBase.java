...
public abstract class DbClientServiceBase implements DbClientService {
     ...
     * @see #statement(io.helidon.reactive.dbclient.DbClientServiceContext)
     */
    ...
    public abstract static class DbClientServiceBuilderBase<B extends DbClientServiceBuilderBase<B>> {
         ...
         *  would be executed for all statements.
         *  See {@link #statementTypes(io.helidon.reactive.dbclient.DbStatementType...)}.</td>
         * </tr>
         * <tr>
         *  <td>enabled</td>
         *  <td>{@code true}</td>
         ...
         * and {@link #statementTypes(io.helidon.reactive.dbclient.DbStatementType...)} is ignored.
         *
