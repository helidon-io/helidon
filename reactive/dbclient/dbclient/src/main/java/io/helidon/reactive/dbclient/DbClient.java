...
import io.helidon.reactive.dbclient.spi.DbClientProviderBuilder;
...
public interface DbClient {
    ...
    /**
     * Create Helidon database handler builder.
     * <p>Database driver is loaded as SPI provider which implements {@link io.helidon.reactive.dbclient.spi.DbClientProvider} interface.
    ...
    static Builder builder() {
        ...
        if (null == theSource) {
            throw new DbClientException(
                    "No DbSource defined on classpath/module path. An implementation of io.helidon.reactive.dbclient.spi.DbSource is "
                            + "required "
                            + "to access a DB");
        }
     ...
     *                 and is used to load appropriate {@link io.helidon.reactive.dbclient.spi.DbClientProvider} from Java Service loader
    ...
    final class Builder implements io.helidon.common.Builder<Builder, DbClient> {
         ...
         *
         * @param dbClientProvider provider specific {@link io.helidon.reactive.dbclient.spi.DbClientProvider} instance
         */
         ...
         * as {@link io.helidon.reactive.dbclient.spi.DbMapperProvider} Java services.
         *
