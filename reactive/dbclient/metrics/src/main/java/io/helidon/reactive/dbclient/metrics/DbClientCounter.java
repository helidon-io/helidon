...
/**
 * Counter metric for Helidon DB. This class implements the {@link io.helidon.reactive.dbclient.DbClientService} and
 * can be configured either through a {@link io.helidon.reactive.dbclient.DbClient.Builder} or through configuration.
 */
final class DbClientCounter extends DbClientMetric<Counter> {
    ...
    @Override
    protected Class<? extends Metric> metricType() {
