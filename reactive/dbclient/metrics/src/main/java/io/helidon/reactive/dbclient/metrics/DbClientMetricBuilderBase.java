...
import io.helidon.reactive.dbclient.common.DbClientServiceBase;
...
abstract class DbClientMetricBuilderBase<T extends DbClientMetricBuilderBase<T>>
     ...
     * <p>The format can use up to two parameters - first is the {@link io.helidon.reactive.dbclient.DbStatementType}
