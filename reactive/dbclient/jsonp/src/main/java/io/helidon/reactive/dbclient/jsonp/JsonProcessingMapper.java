 ...
 */
package io.helidon.reactive.dbclient.jsonp;
...
public final class JsonProcessingMapper implements DbMapper<JsonObject> {
    ...
    /**
     * Create a new mapper that can map {@link jakarta.json.JsonObject} to DB parameters and {@link io.helidon.reactive.dbclient.DbRow}
