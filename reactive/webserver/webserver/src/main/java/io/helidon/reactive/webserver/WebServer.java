...
public interface WebServer {
     ...
     * @throws IllegalStateException if {@link WebServerTls#enabled()} returns {@code false}
     */
    ...
    /**
     * Creates a fluent API builder of the {@link WebServer}.
     * Before calling the {@link WebServer.Builder#build()} method, you should
    ...
    final class Builder implements io.helidon.common.Builder<Builder, WebServer>,
         ...
         * through {@link WebServer.Builder#addNamedRouting(String, Routing)}.
         *
         ...
         *
         * @param socketName name of the socket, using {@link WebServer#DEFAULT_SOCKET_NAME}
