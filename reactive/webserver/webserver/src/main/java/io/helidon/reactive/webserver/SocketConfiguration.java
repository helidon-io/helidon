...
public interface SocketConfiguration {
    ...
    /**
     * Name of this socket.
     * Default to {@link WebServer#DEFAULT_SOCKET_NAME} for the main and
    ...
    /**
     * Socket configuration builder API, used by {@link SocketConfiguration.Builder}
     * to configure additional sockets, and by {@link io.helidon.reactive.webserver.WebServer.Builder} to
    ...
    /**
     * The {@link SocketConfiguration} builder class.
     */
    @Configured
