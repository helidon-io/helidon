...
public class CompareOriginsTest {
    ...
    void compareOriginSimpleTest() {
        ...
        MatcherAssert.assertThat(CorsSupportHelper.compareOrigins("http://localhost:8080/", "http://localhost:8080/"), is(true));
        MatcherAssert.assertThat(CorsSupportHelper.compareOrigins("http://localhost:8080/foo", "http://localhost:8080/foo"), is(true));
        MatcherAssert.assertThat(CorsSupportHelper.compareOrigins("http://localhost:8080/foo", "http://localhost:8080/bar"), is(true));
    }
    ...
    void compareOriginComplexTest() {
        ...
        MatcherAssert.assertThat(CorsSupportHelper.compareOrigins("https://localhost", "https://localhost:443/foo/bar/baz"), is(true));
        MatcherAssert.assertThat(CorsSupportHelper.compareOrigins("http://localhost/", "http://localhost:80/foo/bar/baz"), is(true));
        ...
        MatcherAssert.assertThat(CorsSupportHelper.compareOrigins("https://localhost:443/foo/bar/baz", "https://localhost"), is(true));
        MatcherAssert.assertThat(CorsSupportHelper.compareOrigins("http://localhost:80/foo/bar/baz", "http://localhost/"), is(true));
    }
