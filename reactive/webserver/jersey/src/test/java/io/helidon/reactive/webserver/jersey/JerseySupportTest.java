...
import static io.helidon.reactive.webserver.jersey.JerseySupport.IGNORE_EXCEPTION_RESPONSE;
...
public class JerseySupportTest {
    ...
    public void injection() {
        ...
        doAssert(response,
                 "request=io.helidon.reactive.webserver.RequestRouting$RoutedRequest\n"
                         + "response=io.helidon.reactive.webserver.RequestRouting$RoutedResponse\n"
                         + "spanContext=null");
    }
