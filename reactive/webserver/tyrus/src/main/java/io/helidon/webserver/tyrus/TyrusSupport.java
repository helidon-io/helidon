...
public class TyrusSupport implements Service {
    ...
    private class TyrusHandler implements Handler {
        private static final Http.HeaderName SEC_WEBSOCKET_KEY = Http.Header.create(HandshakeRequest.SEC_WEBSOCKET_KEY);
        ...
        public void accept(ServerRequest req, ServerResponse res) {
            ...
            upgradeResponse.getHeaders().forEach((key, value) -> res.headers().set(Http.Header.create(key), value));
