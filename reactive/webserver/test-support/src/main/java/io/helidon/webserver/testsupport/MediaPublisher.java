...
public interface MediaPublisher extends Flow.Publisher<DataChunk> {
     ...
     * @return new instance.
     */
    static MediaPublisher create(HttpMediaType publishedType, Flow.Publisher<DataChunk> publisher) {
     ...
     */
    static MediaPublisher create(HttpMediaType publishedType, CharSequence charSequence) {
