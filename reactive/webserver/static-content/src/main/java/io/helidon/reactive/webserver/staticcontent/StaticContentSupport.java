...
/**
 * Serves 'static content' (files) from filesystem or using a classloader to the {@link io.helidon.reactive.webserver.WebServer WebServer}
 * {@link io.helidon.reactive.webserver.Routing}. It is possible to
 * {@link io.helidon.reactive.webserver.Routing.Builder#register(io.helidon.reactive.webserver.Service...) register} it on the routing.
 * <pre>{@code
