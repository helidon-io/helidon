 ...
 * If you want to use {@link io.helidon.service.core.ConfigDriven.ConfigBean} annotation, at least
 ...
 *     Config)</li>
 *     <li>The generated config bean acts as a {@link io.helidon.service.core.ServicesProvider} for the service type</li>
 ...
 *     {@link io.helidon.service.core.Injection.DrivenBy}</li>
 * </ol>
 */
public final class ConfigDriven {
     ...
     *     {@link io.helidon.service.core.ConfigDriven.WantDefault}</li>
     * </ul>
     */
    @Documented
    ...
    public @interface ConfigBean {
         ...
         * with either of {@link io.helidon.service.core.ConfigDriven.AtLeastOne} or
         * {@link io.helidon.service.core.ConfigDriven.WantDefault}, an additional factory method must exist:
     ...
     * If {@link io.helidon.service.core.ConfigDriven.WantDefault} is not configured,
     ...
     * <p>
     * If combined with {@link io.helidon.service.core.ConfigDriven.AtLeastOne}:
     * <ul>
     ...
     *          in case this is not {@link io.helidon.service.core.ConfigDriven.Repeatable}, default instance
