 ...
 * <p>
 * To publish an event, inject an instance of {@link io.helidon.service.registry.Event.Emitter}.
 * <p>
...
public final class Event {
    ...
    public interface Emitter<T> {
         ...
         * @throws io.helidon.service.registry.EventDispatchException if any exception is encountered, the first one is the
         *                                                              cause, and all others are added as a
         ...
         * {@link io.helidon.service.registry.EventDispatchException} is created, all exceptions are added as suppressed to it,
