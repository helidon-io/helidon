...
class ServiceProvider<T> {
    ...
    ServiceProvider(CoreServiceRegistry serviceRegistry,
    ...
    private Map<Dependency, IpPlan<?>> createInjectionPlan() {
        // for core services, we must use Dependency, for inject services, we must use Dependency
        ...
        DependencyPlanBinder.Binder binder = ServicePlanBinder.create(registry,
                                                                      descriptor,
                                                                      injectionPlan::set);
    ...
    private void planForIp(DependencyPlanBinder.Binder injectionPlan,
