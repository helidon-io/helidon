 ...
 * {@link
 * ServiceDescriptor#inject(io.helidon.service.registry.DependencyContext,
 * InterceptionMetadata, java.util.Set, Object)}, and
 * {@link
 * ServiceDescriptor#instantiate(io.helidon.service.registry.DependencyContext,
...
public interface InterceptionMetadata {
     ...
     */
    <T> InterceptionInvoker<T> createInvoker(ServiceInfo descriptor,
