...
interface LookupBlueprint {
     ...
     * {@link Service.QualifiedFactory} services that can handle any type.
    ...
    /**
     * The optional {@link Service.RunLevel} ascribed to the service.
     *
     ...
     * {@link Service.InjectionPointFactory}) that
     ...
     *     {@link Service.QualifiedFactory} of the contract</li>
     *     <li>{@link FactoryType#SERVICES} - services that are
     *     {@link Service.ServicesFactory} of the contract</li>
     *     <li>{@link FactoryType#INJECTION_POINT} - services that are
     *     {@link Service.InjectionPointFactory} of the contract</li>
