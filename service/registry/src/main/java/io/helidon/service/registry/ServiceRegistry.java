 ...
 *     {@link io.helidon.service.registry.Service} are discovered and available for lookup</li>
 *     <li>{@code inject} - also all services that support injection are available (requires an additional runtime module),
 *     services can use annotations from {@code io.helidon.service.inject.Injection}</li>
 * </ul>
 */
@Service.Contract
