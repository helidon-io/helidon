 ...
 */
public interface ServiceCodegenContext extends CodegenContext {
    /**
     * Class name of the module component class generated for each module.
     */
    String MODULE_NAME = "Injection__Module";
    /**
     * Class name of the application class generated by Maven plugin (for end user application).
     */
    String APPLICATION_NAME = "Injection__Application";
     ...
     */
    static ServiceCodegenContext create(CodegenContext context) {
    ...
    default boolean isProvider(TypeName typeName) {
        ...
        return generic.equals(TypeNames.SUPPLIER)
                || generic.equals(ServiceCodegenTypes.INJECTION_POINT_PROVIDER);
    }
