 ...
 * {@link io.helidon.service.codegen.spi.RegistryCodegenExtensionProvider} that adds support for checking annotations that are
 * recognized, yet not supported.
 * <p>
 * The default behavior is to fail code generation session if such an annotation is encountered.
 */
public class UnsupportedTypesExtensionProvider implements RegistryCodegenExtensionProvider {
    private static final Set<TypeName> TYPES = Set.of(
            JakartaTypes.ANNOT_MANAGED_BEAN,
            JakartaTypes.ANNOT_RESOURCE,
            JakartaTypes.ANNOT_RESOURCES,
