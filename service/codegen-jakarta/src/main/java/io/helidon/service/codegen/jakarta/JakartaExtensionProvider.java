 ...
 * {@link io.helidon.service.codegen.spi.InjectCodegenExtensionProvider} adding support for Jakarta types in
 * {@code jakarta} packages.
 * <p>
...
public class JakartaExtensionProvider implements InjectCodegenExtensionProvider {
     ...
     */
    @Deprecated
    public JakartaExtensionProvider() {
    }
    ...
    private static class JakartaExtension implements InjectCodegenExtension {
        ...
        JakartaExtension(ServiceCodegenContext codegenContext) {
