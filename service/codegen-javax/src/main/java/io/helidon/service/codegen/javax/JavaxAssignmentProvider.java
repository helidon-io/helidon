...
import io.helidon.service.codegen.RegistryCodegenContext.Assignment;
import io.helidon.service.codegen.spi.InjectAssignment;
import io.helidon.service.codegen.spi.InjectAssignmentProvider;

import static io.helidon.service.codegen.javax.JavaxTypes.INJECT_PROVIDER;

/**
 * {@link io.helidon.service.codegen.spi.InjectAssignmentProvider} provider implementation for Jakarta based projects
...
public class JavaxAssignmentProvider implements InjectAssignmentProvider {
    ...
    private static class JavaxProviderMapper implements InjectAssignment {
