...
/**
 * Prometheus text formatter for the Helidon metrics provider.
 */
@Api.Internal
public class HelidonPrometheusFormatterProvider implements MeterRegistryFormatterProvider {

    /**
     * Required public constructor for {@link java.util.ServiceLoader}.
     */
    public HelidonPrometheusFormatterProvider() {
    }

    /**
     * Returns a formatter, ignoring the scope-specific arguments.
     *
    ...
    public Optional<MeterRegistryFormatter> formatter(FormatterContext context, MeterRegistry meterRegistry) {
        ...
        if (meterRegistry instanceof HelidonMeterRegistry helidonMeterRegistry && (matches(mediaType, MediaTypes.TEXT_PLAIN)
                || matches(mediaType, MediaTypes.APPLICATION_OPENMETRICS_TEXT))) {
            return Optional.of(new HelidonPrometheusFormatter(mediaType,
                                                              context.metricsConfig(),
                                                              helidonMeterRegistry,
                                                              context.tagSelections(),
                                                              context.nameSelection(),
                                                              context.includeHistogramQuantiles()));
        }
