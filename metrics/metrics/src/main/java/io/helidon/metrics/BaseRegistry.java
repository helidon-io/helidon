...
final class BaseRegistry extends Registry {
    ...
    private static final Metadata MEMORY_USED_HEAP = new HelidonMetadata("memory.usedHeap",
                                                                  "Used Heap Memory",
                                                                  "Displays the amount of used heap memory in bytes.",
                                                                  MetricType.GAUGE,
                                                                  MetricUnits.BYTES);

    private static final Metadata MEMORY_COMMITTED_HEAP = new HelidonMetadata("memory.committedHeap",
    ...
    private static final Metadata MEMORY_MAX_HEAP = new HelidonMetadata("memory.maxHeap",
                                                                 "Max Heap Memory",
    ...
    private static final Metadata JVM_UPTIME = new HelidonMetadata("jvm.uptime",
                                                            "JVM Uptime",
    ...
    private static final Metadata THREAD_COUNT = new HelidonMetadata("thread.count",
                                                              "Thread Count",
    ...
    private static final Metadata OS_AVAILABLE_CPU = new HelidonMetadata("cpu.availableProcessors",
    ...
    private static final Metadata OS_LOAD_AVERAGE = new HelidonMetadata("cpu.systemLoadAverage",
                                                                 "System Load Average",
