...
public final class MessageBodyWriterContext extends MessageBodyContext implements MessageBodyWriters, MessageBodyFilters {
     ...
     */
    @Deprecated
    public <T> MessageBodyWriterContext registerWriter(Class<T> type, HttpMediaType contentType,
     ...
     */
    @Deprecated
    public <T> MessageBodyWriterContext registerWriter(Predicate<?> accept, HttpMediaType contentType,
