...
/**
 * Database executor.
 * <p>The database executor provides methods to create {@link io.helidon.dbclient.DbStatement} instances for different types
 ...
 * <p>There are five methods for each {@link io.helidon.dbclient.DbStatementType}, example for query (the implementation
...
public interface DbTransaction {
     ...
     * @return database statement that can process query returning a single row
     */
    DbStatement<?, DbTxResult<CompletionStage<Optional<DbRow>>>> createNamedGet(String statementName);
