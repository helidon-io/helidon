 ...
 */
public class JdbcConnectionPoolMetricsListener implements MetricRegistryListener {

    /** Local logger instance. */
    private static final Logger LOGGER = Logger.getLogger(JdbcConnectionPoolMetricsListener.class.getName());

    private final MetricRegistry registry;

    JdbcConnectionPoolMetricsListener() {
        registry = RegistryFactory.getInstance().getRegistry(MetricRegistry.Type.VENDOR);
    }

    @Override
    public void onGaugeAdded(String name, Gauge<?> gauge) {
        LOGGER.finest(() -> String.format("Gauge added: %s", name));
        registry.register(name, new JdbcMetricsGauge<>(gauge));
    }
    ...
    public void onCounterAdded(String name, Counter counter) {
        ...
        registry.register(name, new JdbcMetricsCounter(counter));
    }
    ...
    public void onHistogramAdded(String name, Histogram histogram) {
        ...
        registry.register(name, new JdbcMetricsHistogram(histogram));
    }
    ...
    public void onMeterAdded(String name, Meter meter) {
        ...
        registry.register(name, new JdbcMetricsMeter(meter));
    }
    ...
    public void onTimerAdded(String name, Timer timer) {
        ...
        registry.register(name, new JdbcMetricsTimer(timer));
    }
