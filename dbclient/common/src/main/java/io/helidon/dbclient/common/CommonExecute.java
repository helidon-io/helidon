...
/**
 * Common database executor.
 */
public abstract class CommonExecute implements DbExecute {
     ...
     */
    protected CommonExecute(CommonClientContext context) {
     ...
     * @return database client context
     */
    protected CommonClientContext context() {
        return context;
    }
