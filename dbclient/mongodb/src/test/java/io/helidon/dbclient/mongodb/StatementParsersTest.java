...
public class StatementParsersTest {
    ...
    @Test
    void testJakartaJsonValueNumberTextIsValidated() {
        Number number = new JakartaJsonNumber(STRUCTURAL_VALUE);
    ...
    private static final class JakartaJsonNumber extends Number implements JsonValue {
        private final String value;

        private JakartaJsonNumber(String value) {
            this.value = value;
        }
