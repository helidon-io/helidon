...
import io.helidon.dbclient.tests.common.model.Critter.CritterMapper;
...
public class MapperProvider implements DbMapperProvider {
        ...
        public <T> Optional<DbMapper<T>> mapper(Class<T> type) {
            ...
            } else if (type.equals(Critter.class)) {
                return Optional.of((DbMapper<T>) CritterMapper.INSTANCE);
            }
