...
public final class MpConfigSources {
     ...
     * @return a new config source
     */
    public static ConfigSource createWithProfile(URL url, URL profileUrl) {
    ...
    private static ConfigSource composite(ConfigSource main, ConfigSource fallback) {
        ...
        return new ConfigSource() {
            ...
            public Set<String> getPropertyNames() {
                Set<String> result = new HashSet<>(main.getPropertyNames());
                result.addAll(fallback.getPropertyNames());
                        ...
                        .forEachRemaining(it -> {
                            ...
                            for (URL url : profileResourceList) {
                                ...
                                if (pathBase.equals(profilePathBase)) {
                                    sources.add(createWithProfile(it, url));
                                } else {
