...
package io.helidon.config.tests.config.metadata.processor;
...
class GeneratedMetadataTest {
    ...
    void testMetadata() {
        ...
        assertThat(actual.value(), is(hasItem(allOf(
                hasString("module", is("io.helidon.config.tests.config.metadata.processor")),
                hasArray("types", allOf(
                        hasItem(allOf(
                                hasString("type", is("io.helidon.config.tests.config.metadata.processor.AbstractBuilder")),
                        ...
                        hasItem(allOf(
                                hasString("type", is("io.helidon.config.tests.config.metadata.processor.MyTarget")),
                                hasString("description", is("builder")),
                                hasStrings("inherits", hasItems(
                                        "io.helidon.config.tests.config.metadata.processor.AbstractBuilder")),
                                hasArray("options", allOf(List.of(
                                        hasItem(allOf(
