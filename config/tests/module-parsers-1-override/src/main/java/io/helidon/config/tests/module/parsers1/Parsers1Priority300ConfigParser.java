...
/**
 * Testing implementation of {@value io.helidon.common.media.type.MediaTypes#TEXT_PROPERTIES_VALUE} media type
 * with Weight {@code 10}.
 */
@Weight(10)
public class Parsers1Priority300ConfigParser extends AbstractParsers1ConfigParser {
