...
import static io.helidon.config.metadata.codegen.ConfigMetadataTypes.DEPRECATED;
import static io.helidon.config.metadata.codegen.ConfigMetadataTypes.DESCRIPTION;
import static io.helidon.config.metadata.codegen.ConfigMetadataTypes.OPTION_ALLOWED_VALUE;
import static io.helidon.config.metadata.codegen.ConfigMetadataTypes.OPTION_ALLOWED_VALUES;
import static io.helidon.config.metadata.codegen.ConfigMetadataTypes.OPTION_CONFIGURED;
import static io.helidon.config.metadata.codegen.ConfigMetadataTypes.OPTION_DEFAULT;
import static io.helidon.config.metadata.codegen.ConfigMetadataTypes.OPTION_DEFAULT_BOOLEAN;
import static io.helidon.config.metadata.codegen.ConfigMetadataTypes.OPTION_DEFAULT_CODE;
import static io.helidon.config.metadata.codegen.ConfigMetadataTypes.OPTION_DEFAULT_DOUBLE;
