...
final class ConfiguredType {
    ...
    void write(List<JObject> typeArray) {
        var typeObject = JObject.builder();
        ...
        List<JObject> options = new ArrayList<>();
    ...
    private void writeProperty(List<JObject> optionsBuilder,
                               String prefix,
                               ConfiguredProperty property) {

        var optionBuilder = JObject.builder();
        ...
        if (!property.allowedValues.isEmpty()) {
            ...
            for (ConfiguredOptionData.AllowedValue allowedValue : property.allowedValues) {
                allowedValues.add(JObject.builder()
