...
@AddBean(CrossOriginDeprecatedTest.CorsResource0.class)
@AddBean(CrossOriginDeprecatedTest.CorsResource1.class)
@AddBean(CrossOriginDeprecatedTest.CorsResource2.class)
@AddBean(CrossOriginDeprecatedTest.CorsResource3.class)
@AddBean(CrossOriginDeprecatedTest.CorsResource4.class)
...
class CrossOriginDeprecatedTest extends BaseCrossOriginTest {
    @Inject
