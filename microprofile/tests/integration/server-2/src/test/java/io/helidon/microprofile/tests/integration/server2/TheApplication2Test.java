...
/**
 * Unit test for {@link io.helidon.microprofile.tests.integration.server2.TheApplication2}.
 */
class TheApplication2Test {
    ...
    void testApplicationEndpoints() {
        ...
        testEndpoint(appTarget, "first", 404);
        testEndpoint(appTarget, "second", 404);
    }
    ...
    void testResourceEndpoints() {
        testEndpoint(rootTarget, "first", 200);
        testEndpoint(rootTarget, "second", 200);
    }
    ...
    static void destroyClass() {
        ...
        assertThat(TheProvider2.count(), is(INVOCATIONS.get()));
    }
}