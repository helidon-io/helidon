...
/**
 * Build {@link org.reactivestreams.Publisher},
 * {@link org.eclipse.microprofile.reactive.streams.operators.spi.SubscriberWithCompletionStage},
 * {@link org.reactivestreams.Processor} or
 * {@link java.util.concurrent.CompletionStage} from {@link org.eclipse.microprofile.reactive.streams.operators.spi.Stage}s provided by
 * {@link org.eclipse.microprofile.reactive.streams.operators.spi.Graph}.
 */
final class GraphBuilder extends HashMap<Class<? extends Stage>, Consumer<Stage>> {
    ...
    private GraphBuilder() {
        ...
        registerStage(Stage.Concat.class, stage -> {
            ...
            multi = ConcatPublisher.create(firstPublisher, secondPublisher);
        });
    ...
    /**
     * Create new {@link GraphBuilder}.
     *
     * @return new {@link GraphBuilder}
     */
    static GraphBuilder create() {
        return new GraphBuilder();
    }

    /**
     * Register all {@link org.eclipse.microprofile.reactive.streams.operators.spi.Stage}s from provided
     * {@link org.eclipse.microprofile.reactive.streams.operators.spi.Graph}.
     *
     * @param graph {@link org.eclipse.microprofile.reactive.streams.operators.spi.Graph} to construct stream from
     * @return this {@link GraphBuilder}
     */
    GraphBuilder from(Graph graph) {
        graph.getStages().forEach(this::add);
        return this;
    }

    private GraphBuilder add(Stage stage) {
        this.keySet()
                .stream()
