...
public class BufferedProcessorTest extends AbstractProcessorTest {
    @Override
    @SuppressWarnings("unchecked")
    protected Processor<Long, Long> getProcessor() {
        Flow.Processor processor = BufferedProcessor.create();
    ...
    protected Processor<Long, Long> getFailedProcessor(RuntimeException t) {
        Flow.Processor processor = BufferedProcessor.create().onNext(o -> {
            throw t;
        });
        return HybridProcessor.from(processor);
    }
