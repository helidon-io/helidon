...
/**
 * Binds an {@link jakarta.ws.rs.core.Application} or {@link io.helidon.reactive.webserver.Service} to a specific (named) routing
 *  on {@link io.helidon.reactive.webserver.WebServer}. The routing should have a corresponding named socket configured on the
