...
public class TestServerWithConfig {
    ...
    public static void startServer() throws Exception {
        ConfigSource configSource = new ClasspathConfigSource.ClasspathBuilder(("/serverConfig.yaml")).build();
        Config helidonConfig = Config.builder().sources(configSource).build();
