 ...
 * the OpenAPI model.
 */
// TODO This test was transplanted from SE and needs to be adapted to MP.
public class ServerModelReaderTest {

    private static final String SIMPLE_PROPS_PATH = "/openapi";

    private static final MpOpenApiFeature.Builder<?, ?> OPENAPI_SUPPORT_BUILDER =
        MpOpenApiFeature.builder()
