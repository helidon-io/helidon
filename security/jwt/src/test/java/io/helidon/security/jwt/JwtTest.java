...
public class JwtTest {
    ...
    @Test
    public void testHelidonJsonApisRemainCompatible() {
        Jwt jwt = Jwt.builder()
                .algorithm(JwkRSA.ALG_RS256)
        ...
        assertThat(jwt.headerJson().getString("custom-header"), is("header-value"));
        assertThat(jwt.payloadJson().getString("custom-claim"), is("payload-value"));
        assertThrows(UnsupportedOperationException.class,
                     () -> jwt.headers().headerClaims().put("another-header", Json.createValue("another-value")));
        assertThrows(UnsupportedOperationException.class,
                     () -> jwt.payloadClaims().put("another-claim", Json.createValue("another-value")));
        ...
        assertThat(nullClaimJwt.payloadJson().getString("nullable"), is("null"));
    }

    @Test
    public void testCollectionClaimsRemainJsonpCompatible() {
