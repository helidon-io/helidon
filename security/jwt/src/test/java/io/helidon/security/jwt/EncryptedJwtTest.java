...
import static io.helidon.security.jwt.EncryptedJwt.*;
...
public class EncryptedJwtTest {
    ...
    public void testDefaultHeaderCreation() {
        ...
        JsonObject headers = encryptedJwt.headers();
        assertThat(headers.getString("alg"), is(SupportedAlgorithm.RSA_OAEP.toString()));
        assertThat(headers.getString("enc"), is(SupportedEncryption.A256GCM.toString()));
