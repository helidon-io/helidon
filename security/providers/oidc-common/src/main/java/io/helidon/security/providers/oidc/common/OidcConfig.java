 ...
 * }
 * Filesystem/URI resources, well-known metadata, and metadata-discovered signing JWKs load lazily. Each attempt has a
 * timeout, retry governs the complete load batch, and a circuit breaker prevents every request from repeating a failed
 * batch. Fixed sources validate eagerly, and successful loads are cached without periodic refresh.
 * <p>
 ...
 *     <td>Standard fault tolerance circuit breaker around each complete retry batch.</td></tr>
 * <tr>
...
public final class OidcConfig extends TenantConfigImpl {
    ...
    public enum ClientAuthentication {
         ...
         * The Client needs to have MTLS enabled for the OIDC.
         */
        CLIENT_CERTIFICATE,
        /**
    ...
    public static class Builder extends BaseBuilder<Builder, OidcConfig> {
         ...
         *
         * @param builderConsumer webclient config builder consumer
         * @return updated builder instance
         */
        public Builder webclient(Consumer<WebClientConfig.Builder> builderConsumer) {
            builderConsumer.accept(webClientConfigBuilder);
            return this;
        }
