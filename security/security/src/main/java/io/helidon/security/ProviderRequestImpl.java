...
class ProviderRequestImpl implements ProviderRequest {
    ...
    ProviderRequestImpl(SecurityContext context,
     ...
     * If object implements {@link io.helidon.security.util.AbacSupport} the value is obtained through {@link io.helidon.security.util.AbacSupport#abacAttribute(String)}, if not,
    ...
    private static final class ObjectWrapper implements AbacSupport {
        ...
        public Object abacAttributeRaw(String key) {
            ...
            return ProviderRequestImpl.getValue(value, key);
        }
