...
public interface Security {
     ...
     * @return new instance.
     */
    static Security create(io.helidon.config.Config config) {
    ...
    @Configured(root = true, prefix = "security", description = "Configuration of security providers, integration and other"
     ...
     final class Builder implements io.helidon.common.Builder<Builder, Security> {
        ...
        private void fromConfig(io.helidon.config.Config config) {
            ...
            // now policy
            io.helidon.config.Config providerPolicyConfig = config.get("provider-policy");
