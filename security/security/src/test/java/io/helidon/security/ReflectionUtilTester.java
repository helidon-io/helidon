...
class ReflectionUtilTester {
    ...
    public ReflectionUtilTester() {
    }

    ReflectionUtilTester(String packageConstructor) {
    }

    protected ReflectionUtilTester(int protectedConstructor) {
    }

    private ReflectionUtilTester(boolean privateConstructor) {
    }
