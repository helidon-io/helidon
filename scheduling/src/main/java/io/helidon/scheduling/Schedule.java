...
/**
 * Types to use with Helidon Declarative programming model.
 */
public final class Schedule {
    ...
    public @interface FixedRate {
         ...
         * Defaults to fully qualified class name + {@code .schedule}.
         ...
         * @return delay type
         */
        DelayType delayType() default SINCE_PREVIOUS_START;
    }
