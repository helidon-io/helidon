...
//   todo             LRALogger.i18NLogger.warn_participantReturnsImmediateStateFromCompletionStage(
...
//   todo         LRALogger.logger.debug("Compensate participant method threw an unexpected exception", throwable);
            return ParticipantStatus.FailedToCompensate.name();
        } else if (type.equals(COMPLETE)) {
//   todo         LRALogger.logger.debug("Complete participant method threw an unexpected exception", throwable);
