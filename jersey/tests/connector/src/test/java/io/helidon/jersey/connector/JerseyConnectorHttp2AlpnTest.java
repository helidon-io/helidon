 ...
 */
@ServerTest
class JerseyConnectorHttp2AlpnTest extends JerseyConnectorBase {
    ...
    static void setUpServer(WebServerConfig.Builder serverBuilder) {
        ...
        serverBuilder.addProtocol(Http2Config.create());        // h2 support ALPN
    }

    JerseyConnectorHttp2AlpnTest(WebServer server) {
