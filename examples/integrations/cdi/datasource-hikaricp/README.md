...
```bash
docker container run --name oracle --detach -it -p 1521:1521 -p 5500:5500 --shm-size=3g \
...
example, you can https://container-registry.oracle.com/[visit the relevant
 section of the Oracle Container Registry website].
