...
import io.helidon.examples.integrations.neo4j.se.api.MovieService;
...
public final class Main {
    ...
    private static Routing createRouting(Config config) {
        ...
        HealthSupport health = HealthSupport.builder()
                ...
                .addLiveness(neo4jHealthChecks.livenessChecks())
                .addReadiness(neo4jHealthChecks.readinessChecks())
                .build();
