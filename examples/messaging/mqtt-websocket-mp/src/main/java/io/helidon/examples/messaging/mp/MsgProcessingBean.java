...
public class MsgProcessingBean {
    ...
    @Outgoing("toMqtt")
    public ProcessorBuilder<String, Message<MqttMessage>> multiply() {
        ...
        return ReactiveStreams.<String>builder()
                ...
                .map(s -> new MqttMessage(s.getBytes(StandardCharsets.UTF_8)))
                .map(Message::of);
    }
     ...
     */
    @Incoming("fromMqtt")
    public void broadcast(MqttMessage msg) {
        // Broadcast to all subscribers
        broadCaster.submit(new String(msg.getPayload()));
    }
