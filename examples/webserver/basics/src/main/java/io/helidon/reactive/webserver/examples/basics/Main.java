...
public class Main {
     ...
     * <p>
     * The (route) {@link Handler} is a functional interface which process HTTP {@link io.helidon.reactive.webserver.ServerRequest request} and
     * writes to the {@link io.helidon.reactive.webserver.ServerResponse response}.
     */
     ...
     * <ul>
     *     <li>Respond using one of {@link io.helidon.reactive.webserver.ServerResponse#send() ServerResponse.send(...)} method.</li>
     *     <li>Continue to next valid route using {@link io.helidon.reactive.webserver.ServerRequest#next() ServerRequest.next()} method.
    ...
    /**
     * {@link io.helidon.reactive.webserver.ServerRequest ServerRequest} provides access to three types of "parameters":
     * <ul>
     *     <li>Headers</li>
     ...
     * defined in a single fluent code. It is possible to register {@link io.helidon.reactive.webserver.Service Service} and organise
    ...
    /**
     * Combination of filtering {@link Handler} pattern with {@link io.helidon.reactive.webserver.Service Service} registration capabilities
     ...
     * {@link io.helidon.reactive.webserver.ErrorHandler ErrorHandlers} for specific processing.
     * <p>
     * If error is not processed by a custom {@link io.helidon.reactive.webserver.ErrorHandler ErrorHandler} than default one is used.
