...
:pom: ../../pom.xml
:helidon-version: 0.10.2 // can be overridden from the CLI or API
:helidon.version: {helidon-version}
...
----
You can add Helidon dependencies to your project without having to specify the version.
...
<2> Pulls in support for YAML as a config source.
