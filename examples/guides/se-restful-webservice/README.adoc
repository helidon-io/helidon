...
= The RESTful Web Service Tutorial
:description: Helidon tutorial restful web service
:keywords: helidon, tutorial, example
:toc: preamble
:toclevels: 2
...
As you develop the app, this tutorial helps you understand what each part of the
...
Later steps in this tutorial show how to add your own, app-specific health check and
metric.
--
...
// tag::downloading[]
Instead of generating and then enhancing the application as described in this tutorial,
you can download it.
