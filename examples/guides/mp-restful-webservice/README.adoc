...
= The MicroProfile RESTful Web Service Tutorial
:description: Helidon MicroProfile tutorial restful web service
:keywords: helidon, tutorial, example, mp, microprofile
:toc: preamble
:toclevels: 2
...
As you develop the app, this tutorial helps you understand what each part of the code
