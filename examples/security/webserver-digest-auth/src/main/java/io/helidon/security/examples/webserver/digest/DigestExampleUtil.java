...
final class DigestExampleUtil {
    ...
    static WebServer startServer(Consumer<HttpRouting.Builder> routing) {
        ...
        System.out.printf("  http://localhost:%1$d/public%n", server.port());
        System.out.println("No roles required, authenticated:");
        System.out.printf("  http://localhost:%1$d/noRoles%n", server.port());
        System.out.println("User role required:");
        System.out.printf("  http://localhost:%1$d/user%n", server.port());
        System.out.println("Admin role required:");
        System.out.printf("  http://localhost:%1$d/admin%n", server.port());
        System.out.println("Always forbidden (uses role nobody is in), audited:");
        System.out.printf("  http://localhost:%1$d/deny%n", server.port());
        System.out.println(
        ...
        System.out.printf("  http://localhost:%1$d/noAuthn%n", server.port());
        System.out.println();
        return server;
    }
}
