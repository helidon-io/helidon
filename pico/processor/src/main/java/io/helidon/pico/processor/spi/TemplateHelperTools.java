...
/**
 * Tools to assist with {@link io.helidon.pico.processor.spi.CustomAnnotationTemplateProducer}'s.
 */
public interface TemplateHelperTools {
     ...
     *
     * @return the response, or null if the template was not resolvable
     */
    CustomAnnotationTemplateProducerResponse produceStandardCodeGenResponse(CustomAnnotationTemplateProducerRequest request,
     ...
     *     }
     * </pre>
     * If the {@link io.helidon.pico.processor.spi.CustomAnnotationTemplateProducer} responds as follows:
     * <pre>
     ...
     * </pre>
     *
     * @param request           the request, as populated as indicated in {@link #produceStandardCodeGenResponse(CustomAnnotationTemplateProducerRequest, io.helidon.pico.types.TypeName, java.util.function.Supplier, java.util.function.Function, java.io.PrintStream)}
     * @param generatedType     the type that should be code generated
     ...
     *
     * @see io.helidon.pico.spi.ext.TypeInterceptor
     */
    CustomAnnotationTemplateProducerResponse produceNamedBasicInterceptorDelegationCodeGenResponse(
            CustomAnnotationTemplateProducerRequest request,
            TypeName generatedType,
     ...
     */
    Supplier<CharSequence> supplyFromResources(String templateProfile, String templateName);
