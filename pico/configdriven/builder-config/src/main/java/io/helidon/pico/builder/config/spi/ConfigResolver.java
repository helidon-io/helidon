...
public interface ConfigResolver {
    ...
    /**
     * Resolves a {@link io.helidon.pico.builder.config.ConfigBean} singular element value from the
    ...
    /**
     * Resolves a {@link io.helidon.pico.builder.config.ConfigBean} collection-like element value from the
     * backing {@link io.helidon.common.config.Config}.
     *
     * @param ctx       the resolution context
     * @param meta      the meta attributes for this config bean
    ...
    /**
     * Resolves a {@link io.helidon.pico.builder.config.ConfigBean} map-like element value from the
     * backing {@link io.helidon.common.config.Config}.
     *
     * @param ctx       the resolution context
     * @param meta      the meta attributes for this config bean
