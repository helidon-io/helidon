...
import io.helidon.pico.builder.config.spi.ConfigBeanRegistryProvider;

/**
 * Service-loaded provider for {@link io.helidon.pico.config.services.ConfigBeanRegistry}.
 *
 * @deprecated
 */
