...
public interface InternalConfigBeanRegistry extends ConfigBeanRegistry, Resetable {
     ...
     * {@link io.helidon.pico.builder.config.spi.ConfigBeanInfo} annotation it is configured by.
     *
     * @param configuredServiceProvider the configured service provider
     * @param configuredByQualifier the qualifier associated with the {@link ConfigBeanInfo}
