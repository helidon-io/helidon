...
/**
 * Service-loaded provider for {@link io.helidon.pico.builder.config.spi.ConfigResolverProvider}.
 *
 * @deprecated
 */
...
public class DefaultConfigBeanBuilderValidatorProvider implements ConfigBeanBuilderValidatorProvider {
    ...
    @Override
    public ConfigBeanBuilderValidator<?> configBeanBuilderValidator() {
        return INSTANCE.get();
    }
}
