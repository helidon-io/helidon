...
import io.helidon.pico.testsubjects.ext.tbox.impl.CoarseBlade;
import io.helidon.pico.testsubjects.ext.tbox.impl.DullBlade;
...
/**
 * Intentionally in the same package as {@link io.helidon.pico.testsubjects.ext.tbox.AbstractSaw}
 */
@Singleton
...
public class TableSaw extends AbstractSaw {
    ...
    public void verifyState() {
        verifyInjected(ctorInjectedLubricantInSubClass, getClass() + "." + InjectionPointInfo.CTOR, null, false, null);
