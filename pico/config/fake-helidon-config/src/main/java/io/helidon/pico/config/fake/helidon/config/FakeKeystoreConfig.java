 ...
 *
 * @see io.helidon.pico.config.fake.helidon.config.FakeKeyConfig
 */
@ConfigBean
...
//    private final StreamHolder keystoreStream = new StreamHolder("keystore");
    ...
    // TODO: this would stay a default function
...
//    }
    ...
    /**
     * TODO: how does this map to/from a String in backing Config??
     */
