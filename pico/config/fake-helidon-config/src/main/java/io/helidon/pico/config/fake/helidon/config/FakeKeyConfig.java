...
//    private static final Logger LOGGER = Logger.getLogger(FakeKeyConfigBean.class.getName());
//
...
//
//    private FakeKeyConfigBean(PrivateKey privateKey,
//                              PublicKey publicKey,
...
//     */
//    public static FakeKeyConfigBean create(Config config) throws PkiException {
//        try {
...
//     * If you need to add additional information to {@link FakeKeyConfigBean}, use {@link PemBuilder#toFullBuilder()}.
//     *
...
//    }
    ...
    /**
     * TODO: Note that this is what the builder's implementation code "should" look like in the end
     * @see FakeKeystoreConfig
     */
//    public DefaultFakeConfigBean.Builder config(Config config) {
...
//    /**
//     * Fluent API builder for {@link FakeKeyConfigBean}.
//     * Call {@link #build()} to create an instance.
//     *
//     * The keys may be loaded from multiple possible sources.
//     *
//     * @see FakeKeyConfigBean#keystoreBuilder()
//     * @see FakeKeyConfigBean#pemBuilder()
//     * @see FakeKeyConfigBean#fullBuilder()
//     */
//    @Configured
//    public static class Builder implements io.helidon.common.Builder<Builder, FakeKeyConfigBean> {
...
//         */
//        @Override
//        public FakeKeyConfigBean build() throws PkiException {
...
//            }
//
//            return new FakeKeyConfigBean(privateKey, publicKey, publicCert, certChain, certificates);
//        }
//
//        /**
...
//         *
//         * @param builder builder obtained from {@link FakeKeyConfigBean#pemBuilder()}
//         * @return updated builder instance
//         */
...
//         *
//         * @param builder builder obtained from {@link FakeKeyConfigBean#keystoreBuilder()} ()}
//         * @return updated builder instance
//         */
...
//     * FakeKeyConfigBean#keystoreBuilder()}.
//     */
//    @Configured(ignoreBuildMethod = true)
//    public static final class KeystoreBuilder implements io.helidon.common.Builder<Builder, FakeKeyConfigBean> {
...
//
//        /**
//         * Create an instance of {@link FakeKeyConfigBean} based on this builder.
//         *
//         * @return new key config based on a keystore
//         */
//        @Override
//        public FakeKeyConfigBean build() {
//            return toFullBuilder().build();
//        }
//
//        /**
//         * Create a builder for {@link FakeKeyConfigBean} from this keystore builder. This allows you to enhance the config
//         * with additional (explicit) fields.
//         *
//         * @return builder of {@link FakeKeyConfigBean}
//         */
//        public Builder toFullBuilder() {
//            return updateBuilder(FakeKeyConfigBean.fullBuilder());
//        }
//

    // TODO: this one might be a challenge, and would need to either put this as a static / default function on the iface, or else relocate to a separate Utility class
...
//
    ...
    // TODO: figure out how to deal with marshaling/streaming Resources
    // TODO: We might need to just keep this kind of code as-is.

//    /**
//     * Builder for PEM files - accepts private key and certificate chain. Obtain an instance through {@link
//     * FakeKeyConfigBean#pemBuilder()}.
//     *
...
//     */
//    @Configured(ignoreBuildMethod = true)
//    public static final class PemBuilder implements io.helidon.common.Builder<Builder, FakeKeyConfigBean> {
...
//
//        /**
//         * Build {@link FakeKeyConfigBean} based on information from PEM files only.
//         *
...
//         *
//         * @return builder for {@link FakeKeyConfigBean}
//         */
//        public Builder toFullBuilder() {
//            return updateBuilder(FakeKeyConfigBean.fullBuilder());
//        }
