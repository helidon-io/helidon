...
import io.helidon.pico.config.fake.helidon.WebServer;
...
//     */
    // TODO: This will need to be a default function, or else use Resource <--> String marshaller
//    @Override
//    InetAddress bindAddress();
     ...
     */
    @Deprecated
    default FakeSocketConfig socket(String name) {
     ...
     */
//    TODO: @DefaultValue (Duration translation)
...
//     */
    // TODO: This will need to be a default method
//    Tracer tracer();
...
//     */
    // TODO: This will need to be a default method
    // we need an annotation to say this is not config-based, but allow it to be part of built configuration.
//    Context context();
//
//    /**
...
//     */
//    static FakeServerConfigBean create(Config config) {
...
//
//    /**
//     * A {@link FakeServerConfigBean} builder.
//     *
//     * @deprecated since 2.0.0 - use {@link io.helidon.webserver.WebServer.Builder} instead
//     */
//    @Deprecated
//    final class Builder implements FakeSocketConfigBean.SocketConfigurationBuilder<Builder>,
//                                   io.helidon.common.Builder<Builder, FakeServerConfigBean> {
//
//        private static final AtomicInteger WEBSERVER_COUNTER = new AtomicInteger(1);
//        private final Map<String, FakeSocketConfigBean.Builder> socketBuilders = new HashMap<>();
//        private final Map<String, FakeSocketConfigBean> socketsConfigs = new HashMap<>();
//        private int workers;
...
//         * @return an updated builder
//         *
//         * @deprecated since 2.0.0, please use {@link #addSocket(String, FakeSocketConfigBean)} instead
//         */
//        @Deprecated
//        public Builder addSocket(String name, int port, InetAddress bindAddress) {
//            Objects.requireNonNull(name, "Parameter 'name' must not be null!");
//            return addSocket(name, FakeSocketConfigBean.builder()
//                    .port(port)
...
//         * @return an updated builder
//         */
//        public Builder addSocket(String name, FakeSocketConfigBean socketConfiguration) {
//            Objects.requireNonNull(name, "Parameter 'name' must not be null!");
...
//         * @return an updated builder
//         */
//        public Builder addSocket(String name, FakeSocketConfigBean.Builder socketConfiguration) {
//            Objects.requireNonNull(name, "Parameter 'name' must not be null!");
...
//         * @return an updated builder
//         */
//        public Builder addSocket(String name, Supplier<FakeSocketConfigBean> socketConfigurationBuilder) {
//            Objects.requireNonNull(name, "Parameter 'name' must not be null!");
//
...
//                    }
//
//                    FakeSocketConfigBean.Builder socket = FakeSocketConfigBean.builder()
//                            .name(socketName)
//                            .config(socketConfig);
//
...
//         */
//        @Override
//        public FakeServerConfigBean build() {
//            if (null == context) {
...
//        }
//
//        FakeSocketConfigBean.Builder defaultSocketBuilder() {
//            return socketBuilder(WebServer.DEFAULT_SOCKET_NAME);
//        }
//
//        FakeSocketConfigBean.Builder socketBuilder(String socketName) {
//            return socketBuilders.computeIfAbsent(socketName, k -> FakeSocketConfigBean.builder().name(socketName));
//        }
//
//        Map<String, FakeSocketConfigBean> sockets() {
//            Set<String> builtSocketConfigsKeys = socketsConfigs.keySet();
//            Map<String, FakeSocketConfigBean> result =
//                    new HashMap<>(this.socketBuilders.size() + this.socketsConfigs.size());
//            for (Map.Entry<String, FakeSocketConfigBean.Builder> e : this.socketBuilders.entrySet()) {
//                String key = e.getKey();
