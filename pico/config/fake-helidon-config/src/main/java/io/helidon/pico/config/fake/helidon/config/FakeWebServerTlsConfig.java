...
//
//    private FakeWebServerTlsConfigBean(Builder builder) {
...
//
//    /**
//     * A fluent API builder for {@link FakeWebServerTlsConfigBean}.
//     *
...
//     */
//    public static FakeWebServerTlsConfigBean create(Config config) {
//        return builder().config(config).build();
//    }
//
    // TODO: this will be a list instead.
...
//
    ...
    // TODO: this will be a challenge, we might need to make this a default function, or externalize to a Utility class.
...
//
//    /**
//     * Fluent API builder for {@link FakeWebServerTlsConfigBean}.
//     */
//    @Configured
//    public static class Builder implements io.helidon.common.Builder<Builder, FakeWebServerTlsConfigBean> {
...
//
//        @Override
//        public FakeWebServerTlsConfigBean build() {
//            boolean enabled;
//
...
//                // ssl is disabled
//                return new FakeWebServerTlsConfigBean(this);
//            }
//
//            if (null == sslContext) {
...
//                    .ifExists(it -> privateKey(FakeKeyConfig.create(it)));
//
//            config.get("trust")
//                    .ifExists(it -> trust(FakeKeyConfig.create(it)));
//
...
//        public Builder privateKey(FakeKeyConfig privateKeyConfig) {
...
//         * @return this builder
//         */
//        public Builder privateKey(Supplier<FakeKeyConfig> privateKeyConfigBuilder) {
...
//         */
//        @ConfiguredOption
//        public Builder trust(FakeKeyConfig trustConfig) {
...
//         * @return this builder
//         */
//        public Builder trust(Supplier<FakeKeyConfig> trustConfigBuilder) {
