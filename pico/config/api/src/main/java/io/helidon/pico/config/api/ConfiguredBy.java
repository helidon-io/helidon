...
package io.helidon.pico.config.api;
 ...
 * <p>
 * The companion to this annotation is {@link io.helidon.pico.config.api.ConfigBean} - this annotation encapsulates the
 * configuration a {@link io.helidon.pico.config.api.ConfiguredBy} service needs, and will also trigger code-generation to occur.
 *
 * @see ConfigBean
 */
@Documented
