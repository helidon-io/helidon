...
/**
 * Basic implementation of {@link io.helidon.pico.config.spi.ConfigResolver} that just resolves against
 * {@link io.helidon.config.Config} directly.
 */
@Singleton
@Weight(Weighted.DEFAULT_WEIGHT - 50)
public class BasicConfigResolver implements ConfigResolver {
