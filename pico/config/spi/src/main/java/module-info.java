...
module io.helidon.pico.config.spi {
    ...
    // TODO: switch this to common/config
    requires transitive io.helidon.config;
    requires transitive io.helidon.pico.types;

    exports io.helidon.pico.config.spi;

    provides io.helidon.pico.config.spi.ConfigResolver
            with io.helidon.pico.config.spi.BasicConfigResolver;
}
