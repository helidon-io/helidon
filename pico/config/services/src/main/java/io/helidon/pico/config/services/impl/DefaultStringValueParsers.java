...
/**
 * Default implementation of {@link io.helidon.pico.config.services.StringValueParser}.
 */
...
public class DefaultStringValueParsers implements StringValueParser {
    ...
    @Override
    public Optional parse(String val, Class type) {
        ...
        if (Objects.isNull(parser)) {
            throw new UnsupportedOperationException("Don't know how to parse String -> "
                                                            + DefaultTypeName.create(type).declaredName());
        }
