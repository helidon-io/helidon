...
public interface FakeComponentTracingConfig extends FakeTraceableConfig {
    // TODO: Note we can do these, but only after we code gen the impl classes
...
//
    ...
    // TODO: Note: the builder will be able to merge and clone like this, but it will be on those impl classes, not here
