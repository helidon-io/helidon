...
//     */
//    static FakePathTracingConfigBean create(Config config) {
...
//     TODO: or Optional style??  if required is set to true then no Optional iface will be used?
//    Optional<FakeTracingConfig> tracedConfig();


//    /**
//     * Fluent API builder for {@link FakePathTracingConfigBean}.
//     */
//    final class Builder implements io.helidon.common.Builder<Builder, FakePathTracingConfigBean> {
