...
import io.helidon.pico.config.fake.helidon.config.FakeServerConfig;
import io.helidon.pico.config.fake.helidon.config.FakeSocketConfig;
...
//    }
     ...
     */
    // based on runtime
//    default int port(String socketName) {
//        if (!isRunning()) {
//            return -1;
//        }
//
//        FakeSocketConfig cfg = configuration().sockets().get(socketName);
//        return (Objects.isNull(cfg)) ? -1 : cfg.port();
//    }
     ...
     */
    // TODO: notice the default impl (bsed on cfg)
...
//    }
    ...
    // TODO: Note: we would leave this builder below as-is for the programmatic approach
...
//                                   FakeSocketConfigBean.SocketConfigurationBuilder<Builder>,
...
//        private final FakeServerConfigBean.Builder configurationBuilder = FakeServerConfigBean.builder();
//        // for backward compatibility
//        @SuppressWarnings("deprecation")
//        private FakeServerConfigBean explicitConfig;
...
//         */
//        public Builder defaultSocket(Consumer<FakeSocketConfigBean.Builder> socket){
...
//         * {@link io.helidon.pico.config.fake.helidon.config.FakeServerConfigBean.Builder#addSocket(String, io.helidon.pico.config.fake.helidon.config.FakeSocketConfigBean)}. If there is no such
...
//        public Builder addSocket(FakeSocketConfigBean config) {
...
//         * @return an updated builder
//         */
//        public Builder socket(String name, Consumer<FakeSocketConfigBean.Builder> socket) {
...
//         * @return an updated builder
//         */
//        public Builder socket(String socketName, BiConsumer<FakeSocketConfigBean.Builder, Router.Builder> builders) {
//            builders.accept(
...
//         * @return an updated builder
//         */
//        public Builder addSocket(Supplier<FakeSocketConfigBean> socketConfigurationBuilder) {
//            FakeSocketConfigBean socketConfiguration = socketConfigurationBuilder.get();
//
...
//         * @return an updated builder
//         */
//        public Builder addSocket(FakeSocketConfigBean socketConfiguration, Routing routing) {
