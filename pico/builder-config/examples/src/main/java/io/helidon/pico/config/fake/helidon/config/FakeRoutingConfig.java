 ...
 * aka Routing.
 *
 * TODO: Note: Since this deals with delegates, it is suggested that this remain as-is. Not a "real" config bean.
 * TODO: Question? Do we need to be able to find & map these types of beans? If so, then we might still need to add
 * an annotation to get something discovered (i.e., @CustomConfigBean?)
 *
