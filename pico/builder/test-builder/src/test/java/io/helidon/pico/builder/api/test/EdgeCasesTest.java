...
public class EdgeCasesTest {
    ...
    public void testIt() {
        ...
        Assertions.assertEquals(-1, val.optionalIntegerWithDefault().get());
        Assertions.assertEquals("test", val.optionalStringWithDefault().get());

        val = DefaultEdgeCases.toBuilder(val).optionalIntegerWithDefault(-2).build();
        Assertions.assertEquals(-2, val.optionalIntegerWithDefault().get());
        Assertions.assertEquals("test", val.optionalStringWithDefault().get());
    }
