...
import io.helidon.pico.builder.test.testsubjects.DefaultPickle;
import io.helidon.pico.builder.test.testsubjects.DefaultPickleBarrel;
import io.helidon.pico.builder.test.testsubjects.Pickle;
import io.helidon.pico.builder.test.testsubjects.PickleBarrel;
...
class PickleBarrelTest {
    ...
    void testIt() {
        ...
        PickleBarrel pickleBarrel = (PickleBarrel) pickleBarrelBuilder.addPickle(pickle).id("123").build();
