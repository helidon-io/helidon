 ...
 *     a fluent builder.</li>
 *     <li>{@link io.helidon.pico.builder.processor.spi.TypeInfoCreator} - responsible for code generating the model object for
 *     the target interface.</li>
 *     <li>{@link io.helidon.pico.builder.processor.spi.TypeAndBody} - the dom-like description of the target type of the
 *     builder.</li>
 * </ol>
 */
