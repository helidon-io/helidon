...
/**
 * Used to create a {@link io.helidon.pico.builder.processor.spi.TypeInfo} from the provided arguments.
 */
public interface TypeInfoCreator {

    /**
     * Creates a {@link io.helidon.pico.builder.processor.spi.TypeInfo}.
     *
