...
/**
 * Implementors of this contract will be called to process {@link io.helidon.pico.builder.BuilderTrigger}-annotated
...
public interface BuilderCreator {
    ...
    /**
     * The set of {@link io.helidon.pico.builder.Builder}-like annotations that this creator knows how to handle. Note that
     * this annotation must also be annotated with {@link io.helidon.pico.builder.BuilderTrigger} to qualify for inclusion.
