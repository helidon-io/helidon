...
public class BeanUtils {
    ...
    public static boolean isValidMethodType(String typeName) {
        return Objects.nonNull(typeName) && !typeName.isBlank()
                && !typeName.equals(void.class.getName()) && !typeName.equals(Void.class.getName());
    }
    ...
    public static boolean validateAndParseMethodName(String methodName,
                                                     ...
                                                     AtomicReference<List<String>> attributeNameRef) {
        if (Objects.nonNull(attributeNameRef)) {
            attributeNameRef.set(null);
        }
    ...
    private static boolean validMethod(String name,
        ...
        if (Objects.nonNull(attributeNameRef)) {
            ...
            attributeNameRef.set(Collections.singletonList("" + c + name.substring(1)));
        }
    ...
    private static boolean validBooleanIsMethod(String name,
        ...
        if (Objects.nonNull(attributeNameRef)) {
            c = Character.toLowerCase(c);
            attributeNameRef.set(List.of("" + c + name.substring(3), name));
        }
