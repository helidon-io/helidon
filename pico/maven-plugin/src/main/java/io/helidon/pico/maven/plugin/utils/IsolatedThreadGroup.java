...
package io.helidon.pico.maven.plugin.utils;
 ...
 */
public class IsolatedThreadGroup extends ThreadGroup implements Closeable {
    ...
    IsolatedThreadGroup(String name, long timeOutInMillis) {
        super(name);
     ...
     */
    public static IsolatedThreadGroup create(String name) {
     ...
     * @return the instance of the isolated thread group created
     */
    public static IsolatedThreadGroup create(String name, long timeOutInMillis) {
     ...
     */
    public void setUncaughtThrowable(Throwable t) {
     ...
     */
    public void preStart(Thread thread, ClassLoader loader) {
    ...
    private void joinThread(Thread thread, long timeoutInMillis) {
        try {
