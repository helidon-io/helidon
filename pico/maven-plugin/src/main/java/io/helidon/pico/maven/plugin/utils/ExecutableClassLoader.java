 ...
 */
 public class ExecutableClassLoader {

     private ExecutableClassLoader() {
     }

    /**
     * Creates the loader appropriate for {@link io.helidon.pico.maven.plugin.utils.ExecHandler}.
     *
     * @param classPath the classpath to use
     * @param parent the parent loader
     * @return the loader
     */
    public static URLClassLoader create(Collection<Path> classPath, ClassLoader parent) {
