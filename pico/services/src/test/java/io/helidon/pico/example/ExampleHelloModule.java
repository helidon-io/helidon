...
@Singleton
@Named(ExampleHelloModule.NAME)
public class ExampleHelloModule implements Module {

    public static final String NAME = "example";

    public ExampleHelloModule() {
        int dummy = 1;
    }
    ...
    public void configure(ServiceBinder binder) {
        binder.bind(HelloImpl$$picodiActivator.INSTANCE);
        binder.bind(WorldImpl$$picodiActivator.INSTANCE);
    }
