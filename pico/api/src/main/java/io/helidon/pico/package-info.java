 ...
 * <ul>
 * <li>{@link io.helidon.pico.Contract} - signifies that the type can be used for lookup in the service registry.</li>
 * <li>{@link io.helidon.pico.ExternalContracts} - same as Contract, but applied to the implementation class instead.</li>
 * <li>{@link io.helidon.pico.RunLevel} - ascribes meaning for when the service should start.</li>
 * </ul>
 ...
 * <ul>
 * <li>{@link io.helidon.pico.PicoServices} - suite of services that are typically delivered by the Pico provider.</li>
 * <li>{@link io.helidon.pico.Services} - the services registry, which is one such service from this suite.</li>
 * </ul>
 */
