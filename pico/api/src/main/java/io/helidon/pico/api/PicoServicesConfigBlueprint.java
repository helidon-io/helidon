 ...
 * will be used, and tunable configuration must be located under the key {@code pico} within the provided configuration
 * element.
 */
@Prototype.Blueprint
@Configured(root = true, prefix = "pico")
interface PicoServicesConfigBlueprint {
    /**
     ...
     *
     * @return the flag indicating whether the services registry supports dynamic updates of the service registry post Pico
     * startup
     */
    ...
    /**
     * Flag indicating whether reflection is permitted. The default implementation of Pico
    ...
    /**
     * Flag indicating whether compile-time generated {@link Application}'s should be used at Pico's startup initialization.
     * Setting
    ...
    /**
     * Flag indicating whether compile-time generated {@link io.helidon.pico.api.ModuleComponent}'s should be used at Pico's
     * startup
     ...
     * Defaults to false, can be overridden using system property {@link io.helidon.pico.api.PicoServices#TAG_DEBUG}.
     *
    ...
    default boolean shouldDebug() {
        return debug().orElseGet(() -> Boolean.getBoolean(PicoServices.TAG_DEBUG));
    }
}
