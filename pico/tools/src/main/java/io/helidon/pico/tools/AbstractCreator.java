...
abstract class AbstractCreator {
    ...
    String toGeneratedSticker(
        ...
        String generator = (null == req) ? null : req.generator();
    ...
    static String toActivatorCodeGen(
        ...
        return DefaultServiceBinder.toRootProvider(sp).activator().getClass().getName() + ".INSTANCE";
    }
    ...
    ModuleInfoDescriptor createModuleInfo(
        ...
        if (moduleInfoPath != null) {
            descriptorBuilder = DefaultModuleInfoDescriptor
                    .toBuilder(ModuleInfoDescriptor.create(new File(moduleInfoPath).toPath()));
    ...
    static CodeGenPaths createCodeGenPaths(
        ...
        File moduleInfoFile = servicesToProcess.lastGeneratedModuleInfoFile();
        if (moduleInfoFile == null) {
            moduleInfoFile = servicesToProcess.lastKnownModuleInfoFile();
        }
