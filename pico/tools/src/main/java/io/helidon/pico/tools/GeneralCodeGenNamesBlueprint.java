...
interface GeneralCodeGenNamesBlueprint {
    ...
    /**
     * The module name.
     * This name is used primarily to serve as the codegen name for the {@link io.helidon.pico.api.ModuleComponent} that is
     * generated.
     *
     * @return module name
     */
    ...
    /**
     * The package name to use for the generated {@link io.helidon.pico.api.ModuleComponent},
     * {@link io.helidon.pico.api.Application}, etc.
