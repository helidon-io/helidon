 ...
 * {@link io.helidon.pico.api.ModuleComponent} being generated. Note that this provider will only be called if there is some
...
public interface ModuleComponentNamer {
    ...
    /**
     * Implementors should return the suggested {@link io.helidon.pico.api.ModuleComponent} package name, or {@code empty}
