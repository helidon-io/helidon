...
/**
 * Responsible for creating an {@link io.helidon.pico.tools.creator.ActivatorCreatorRequest} that can be used to
 * pass to {@link io.helidon.pico.tools.creator.ActivatorCreator} based upon the scanning and reflective introspection
 * of a set of classes found in an external jar module.
 *
 ...
 * to call {@link io.helidon.pico.tools.creator.ActivatorCreator#createModuleActivators(ActivatorCreatorRequest)}.
 */
@Contract
