 ...
 * {@link io.helidon.pico.api.PicoServicesConfig}. These are used to fine tune the type of code generated.
 *
...
interface ActivatorCreatorConfigOptionsBlueprint {
     ...
     * This feature can opt'ed in by using {@code pico.application.pre.create}.  Pre-req requires that this can
