...
import static io.helidon.metadata.codegen.config.ConfigMetadataTypes.BLUEPRINT;
import static io.helidon.metadata.codegen.config.ConfigMetadataTypes.COMMON_CONFIG;
...
import static io.helidon.metadata.codegen.config.ConfigMetadataTypes.PROTOTYPE_FACTORY;

/*
 * Takes care of blueprints annotated with builder API only.
 */
class TypeHandlerBuilderApi extends TypeHandlerBase
