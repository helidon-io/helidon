 ...
 * (such as {@link io.helidon.validation.Check.NotNull}), or the {@link io.helidon.validation.Check.Valid} annotation to
 * validate a type.
 * <p>
 ...
 * one of the constraints in {@link io.helidon.validation.Check} class, or the {@link io.helidon.validation.Check.Valid}
 ...
 * Some constraints are for convenience - such as {@link io.helidon.validation.Check.Integer.Max} and
 * {@link io.helidon.validation.Check.Long.Max} - this allows usage of properly typed constants, as the general number
 * constraint {@link io.helidon.validation.Check.Number.Max} must use a String value (as it can be used for any number,
 ...
 * <ul>
 *     <li>{@link io.helidon.validation.Check.Valid} - as long as the class/interface is
 *     {@link io.helidon.validation.Validation.Validated}, will validate the instance (deep validation)</li>
 *     <li>{@link io.helidon.validation.Check.NotNull} - will check that the value is not null</li>
 *     <li>{@link io.helidon.validation.Check.Null} - will check that the value is null</li>
 * </ul>
 *
 * <h2>String constraints</h2>
 * The following constraints can be used on {@link java.lang.String} and {@link java.lang.CharSequence}:
 * <ul>
 *     <li>{@link io.helidon.validation.Check.String.Length} - minimal and/or maximal length</li>
 *     <li>{@link io.helidon.validation.Check.String.NotBlank} - will check that the value is not blank</li>
 *     <li>{@link io.helidon.validation.Check.String.NotEmpty} - will check that the value is not empty</li>
 *     <li>{@link io.helidon.validation.Check.String.Pattern} - will check that the value matches the regular expression</li>
 *     <li>{@link io.helidon.validation.Check.String.Email} - will check that the value matches e-mail structure</li>
 * </ul>
 *
 ...
 * <ul>
 *     <li>{@link io.helidon.validation.Check.Integer.Max} - maximal value</li>
 *     <li>{@link io.helidon.validation.Check.Integer.Min} - minimal value</li>
 * </ul>
 ...
 * <ul>
 *     <li>{@link io.helidon.validation.Check.Long.Max} - maximal value</li>
 *     <li>{@link io.helidon.validation.Check.Long.Min} - minimal value</li>
 * </ul>
 *
 * <h2>Number constraints</h2>
 * The following constraints can be used on {@link java.lang.Number} and its implementations:
 * <ul>
 *     <li>{@link io.helidon.validation.Check.Number.Digits} - max number of integer and fractional digits</li>
 *     <li>{@link io.helidon.validation.Check.Number.Max} - maximal value</li>
 *     <li>{@link io.helidon.validation.Check.Number.Min} - minimal value</li>
 *     <li>{@link io.helidon.validation.Check.Number.Negative} - number must be negative (negative zero for longs is a zero)</li>
 *     <li>{@link io.helidon.validation.Check.Number.NegativeOrZero} - number must not be positive</li>
 *     <li>{@link io.helidon.validation.Check.Number.Positive} - number must be positive (zero is not positive)</li>
 *     <li>{@link io.helidon.validation.Check.Number.PositiveOrZero} - number must be positive or zero (negative zero is OK)</li>
 * </ul>
 * Note that byte is always considered to be unsigned (i.e. values are from 0 to 255 inclusive).
 */
