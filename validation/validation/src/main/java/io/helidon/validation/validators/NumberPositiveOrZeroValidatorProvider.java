...
@Service.NamedByType(Validation.Number.PositiveOrZero.class)
@Service.Singleton
@Weight(Weighted.DEFAULT_WEIGHT - 30)
class NumberPositiveOrZeroValidatorProvider implements ConstraintValidatorProvider {
    @Override
