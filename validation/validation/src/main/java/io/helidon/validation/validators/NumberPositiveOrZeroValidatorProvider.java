...
@Service.NamedByType(Constraints.Number.PositiveOrZero.class)
@Service.Singleton
@Weight(Weighted.DEFAULT_WEIGHT - 30)
class NumberPositiveOrZeroValidatorProvider implements Validation.ConstraintValidatorProvider {
    @Override
    ...
    private static final class ValidatorFromString extends BaseValidator {
        ...
        private ValidatorFromString(Annotation annotation) {
            super(annotation,
                  "%s is not a positive number or zero",
