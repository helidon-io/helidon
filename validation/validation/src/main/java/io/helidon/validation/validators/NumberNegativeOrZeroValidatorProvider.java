...
@Service.NamedByType(Validation.Number.NegativeOrZero.class)
@Service.Singleton
@Weight(Weighted.DEFAULT_WEIGHT - 30)
class NumberNegativeOrZeroValidatorProvider implements ConstraintValidatorProvider {
    @Override
