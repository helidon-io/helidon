...
@Service.NamedByType(Constraints.Number.NegativeOrZero.class)
@Service.Singleton
@Weight(Weighted.DEFAULT_WEIGHT - 30)
class NumberNegativeOrZeroValidatorProvider implements Validation.ConstraintValidatorProvider {
    @Override
    ...
    private static final class ValidatorFromString extends BaseValidator {
        ...
        private ValidatorFromString(Annotation annotation) {
            super(annotation,
                  "%s is not a negative number or zero",
