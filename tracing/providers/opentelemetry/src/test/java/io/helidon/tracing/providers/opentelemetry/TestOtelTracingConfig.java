...
class TestOtelTracingConfig {
    ...
    void testVariousSettings() {
        ...
        assertThat("OpenTelemetry",
                   ...
                   allOf(containsString("sampler=AlwaysOnSampler"),
                         containsString("spanProcessor=BatchSpanProcessor"),
                         containsString("spanExporter=OtlpGrpcSpanExporter"),
                         containsString("exporterName=otlp, type=span, endpoint=https://myhost:1234/mypath"),
        ...
        String exampleOtelToString = """
            OpenTelemetrySdk{tracerProvider=SdkTracerProvider{clock=SystemClock{}, 
            idGenerator=RandomIdGenerator{}, 
            resource=Resource{schemaUrl=null,
                attributes={service.name="tracing-test",
                            telemetry.sdk.language="java",
                            telemetry.sdk.name="opentelemetry",
                            telemetry.sdk.version="1.29.0"}},
                             
            spanLimitsSupplier=SpanLimitsValue{maxNumberOfAttributes=128,
                                               maxNumberOfEvents=128,
                                               maxNumberOfLinks=128,
                                               maxNumberOfAttributesPerEvent=128,
                                               maxNumberOfAttributesPerLink=128,
                                               maxAttributeValueLength=2147483647},
            sampler=AlwaysOnSampler, 
            spanProcessor=BatchSpanProcessor{spanExporter=OtlpGrpcSpanExporter{exporterName=otlp,
                                                                               type=span,
                                                                               ...
                                                                               exporterTimeoutNanos=10000000000}},
            meterProvider=SdkMeterProvider{clock=SystemClock{},
                                            resource=Resource{schemaUrl=null,
                                            attributes={service.name="unknown_service:java",
                                                        ...
                                                        telemetry.sdk.version="1.29.0"}},
            metricReaders=[], views=[]},
            loggerProvider=SdkLoggerProvider{clock=SystemClock{},
                                             resource=Resource{schemaUrl=null,
                                                               attributes={service.name="unknown_service:java",
                                                                           telemetry.sdk.language="java",
                                                                           telemetry.sdk.name="opentelemetry",
                                                                           telemetry.sdk.version="1.29.0"}},
            logLimits=LogLimits{maxNumberOfAttributes=128,
                                maxAttributeValueLength=2147483647},
                                logRecordProcessor=NoopLogRecordProcessor},
            propagators=DefaultContextPropagators{
                    textMapPropagator=MultiTextMapPropagator{textMapPropagators=[W3CTraceContextPropagator,
