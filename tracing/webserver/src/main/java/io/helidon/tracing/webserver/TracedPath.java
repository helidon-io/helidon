...
public interface TracedPath {
     ...
     */
    static TracedPath create(Config config) {
     ...
     * @see io.helidon.webserver.Routing.Builder#any(String, io.helidon.webserver.Handler...)
     */
    String path();
     ...
     */
    TracedConfig tracedConfig();

    /**
     * Fluent API builder for {@link io.helidon.tracing.webserver.TracedPath}.
     */
    final class Builder implements io.helidon.common.Builder<TracedPath> {
        private String path;
        private List<String> methods = new LinkedList<>();
        private TracedConfig tracedConfig;

        private Builder() {
        }

        @Override
        public TracedPath build() {
            // immutable
            final String finalPath = path;
            final List<String> finalMethods = new LinkedList<>(methods);
            final TracedConfig finalTracedConfig = tracedConfig;

            return new TracedPath() {
                @Override
                public String path() {
                    return finalPath;
                }
                ...
                @Override
                public TracedConfig tracedConfig() {
                    return finalTracedConfig;
                }

                @Override
                public String toString() {
                    return path + "(" + finalMethods + "): " + finalTracedConfig;
                }
            };
        }
         ...
         * @return updated builder instance
         */
        public Builder tracedConfig(TracedConfig tracedConfig) {
