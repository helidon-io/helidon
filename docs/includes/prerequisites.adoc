...
|A Helidon MP Application | You can use your own application or use the
 xref:{rootdir}/mp/guides/02_quickstart.adoc[Helidon MP Quickstart] to create a sample application.
...
xref:{rootdir}/about/05_kubernetes.adoc[install one on your desktop].
...
[role="flex, sm7"]
|=======
include::prerequisites.adoc[tag=common-prereqs-table-contents]
