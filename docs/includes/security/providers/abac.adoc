...
* <<ABAC-Provider-Overview, Overview>>
* <<ABAC-Provider-Maven, Maven Dependency>>
* <<ABAC-Provider-Examples, Examples>>
* <<ABAC-Provider-Configuration, Configuration Options>>
* <<ABAC-Provider-Usage, Usage>>
* <<ABAC-Provider-Validator, Role Validator>>
* <<ABAC-Provider-Scope, Scope Validator>>
* <<ABAC-Provider-Expression, Expression Language Policy Validator>>

Attribute-based Access Control (ABAC) authorization provider provides security and authorization service implementations. 

=== Overview [[ABAC-Provider-Overview]]

include::{rootdir}/config/io_helidon_security_providers_abac_AbacProvider.adoc[leveloffset=+2,tag=config]

=== Maven Dependency [[ABAC-Provider-Maven]]
...
=== Configuration Options [[ABAC-Provider-Configuration]]
...
=== Role Validator [[ABAC-Provider-Validator]]
...
=== Scope Validator [[ABAC-Provider-Scope]]
...
=== Expression Language Policy Validator [[ABAC-Provider-Expression]]
