...
:helidon-tree-url: https://github.com/oracle/helidon/tree/master
endif::[]

ifeval::["{helidon-version-is-release}" != "true"]
:helidon-tree-url: https://github.com/oracle/helidon/tree/{helidon-version}
endif::[]
...
:config-javadoc-base-url: {javadoc-base-url}/io.helidon.config/io/helidon/config
:configurable-javadoc-base-url: {javadoc-base-url}/apidocs/io.helidon.common.configurable/io/helidon/common/configurable
:faulttolerance-javadoc-base-url: {javadoc-base-url}/io.helidon.faulttolerance/io/helidon/faulttolerance/package-summary.html
:grpc-server-javadoc-base-url: {javadoc-base-url}/io.helidon.grpc.server/io/helidon/grpc/server
:health-javadoc-base-url: {javadoc-base-url}/io.helidon.health.checks/io/helidon/health/checks
:media-jsonb-javadoc-base-url: {javadoc-base-url}/io.helidon.media.jsonb/io/helidon/media/jsonb
:media-jackson-javadoc-base-url: {javadoc-base-url}/io.helidon.media.jackson/io/helidon/media/jackson
:metrics-javadoc-base-url: {javadoc-base-url}/io.helidon.metrics.api/io/helidon/metrics/api
:metrics-serviceapi-javadoc-base-url: {javadoc-base-url}/io.helidon.metrics.serviceapi/io/helidon/metrics/serviceapi
:micrometer-javadoc-base-url: {javadoc-base-url}/apidocs/io.helidon.integrations.micrometer/io/helidon/integrations/micrometer
:mp-cors-javadoc-base-url: {javadoc-base-url}/apidocs/io.helidon.microprofile.cors/io/helidon/microprofile/cors
:reactive-base-url: {javadoc-base-url}/io.helidon.common.reactive/io/helidon/common/reactive/package-summary.html
:webclient-javadoc-base-url: {javadoc-base-url}/apidocs/io.helidon.webclient/io/helidon/webclient
:webserver-javadoc-base-url: {javadoc-base-url}/apidocs/io.helidon.webserver/io/helidon/webserver
:webserver-cors-javadoc-base-url: {javadoc-base-url}/apidocs/io.helidon.webserver.cors/io/helidon/webserver/cors
