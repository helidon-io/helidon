...
:helidon-version: 3.0.3-SNAPSHOT
...
:openapi-ui-javadoc-base-url: {javadoc-base-url}/io.helidon.openapi.ui
...
// Maven plug-ins
:maven-build-helper-plugin-url: https://www.mojohaus.org/build-helper-maven-plugin/usage.html
