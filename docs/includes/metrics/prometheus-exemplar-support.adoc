...
Add Helidon {h1Prefix} support for  link:https://github.com/OpenObservability/OpenMetrics/blob/main/specification/OpenMetrics.md#exemplars[OpenMetrics (Prometheus) exemplars] for histograms, counters, and simple timers to your application simply by adding dependencies to your project's `pom.xml`.
...
Also, include either xref:{rootdir}/{flavor-lc}/tracing/02_zipkin.adoc[Helidon Zipkin] or
 xref:{rootdir}/{flavor-lc}/tracing/03_jaeger.adoc[Helidon Jaeger] support:
