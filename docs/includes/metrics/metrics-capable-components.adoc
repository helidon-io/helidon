...
+
The API allows your code to register, look-up, remove, and update metrics using
...
* The built-in Helidon metrics web service.
+
This service supports the `/metrics` endpoint by which clients can retrieve metadata and
