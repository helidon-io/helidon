...
include::{rootdir}/includes/prerequisites.adoc[tag=common-prereqs-graal]
...
xref:{guidesdir}/02_quickstart.adoc[Helidon {flavor-uc} Quickstart Guide].
...
xref:{guidesdir}/37_jlink_image.adoc[Custom Runtime Images with `jlink`].
