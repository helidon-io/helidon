...
The xref:{rootdir}/about/04_managing-dependencies.adoc[Managing Dependencies] page describes how you
...
The basic format corresponds to the link:{webserver-cors-javadoc-base-url}/CrossOriginConfig.html[`CrossOriginConfig`]
class, and the mapped format corresponds to the
link:{webserver-cors-javadoc-base-url}/MappedCrossOriginConfig.html[`MappedCrossOriginConfig`] class.
...
Path patterns can be any expression accepted by the link:{webserver-javadoc-base-url}/PathMatcher.html[`PathMatcher`] class.
...
Helidon lets you easily include xref:{rootdir}/{flavor-lc}/health/01_health.adoc[health],
 xref:{rootdir}/{flavor-lc}/metrics/01_metrics.adoc[metrics], and
 xref:{rootdir}/{flavor-lc}/openapi/01_openapi.adoc[OpenAPI] services in your Helidon application.
...
include::{rootdir}/includes/cors/cors-common.adoc[tag=add-cors-dependency]
include::{rootdir}/{flavor-lc}/cors/02_using-the-api.adoc[tag=actual-cors-dependency]
--
. Use
...
| xref:{rootdir}/{flavor-lc}/health/01_health.adoc[health] | `health`
| xref:{rootdir}/{flavor-lc}/metrics/01_metrics.adoc[metrics] | `metrics`
| xref:{rootdir}/{flavor-lc}/openapi/01_openapi.adoc[OpenAPI] | `openapi`
|====
...
as described in
ifdef::se-flavor[]
xref:{rootdir}/se/cors/03_using-configuration.adoc[Using Configuration for CORS].
ifndef::se-flavor[]
xref:{rootdir}/cors/03_configuration-with-cors-mp.adoc}[Using Configuration with CORS in Helidon MP].
endif[]
