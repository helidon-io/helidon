...
include::{rootdir}/se/cors/using-the-api.adoc[tag=actual-cors-dependency]
--
. Use
...
as described in
ifdef::se-flavor[]
xref:{rootdir}/se/cors/using-configuration.adoc[Using Configuration for CORS].
endif::[]
ifndef::se-flavor[]
