...
Helidon lets you easily include xref:{rootdir}/{flavor-lc}/health/01_health.adoc[health],
 ...
 xref:{rootdir}/{flavor-lc}/openapi.adoc[OpenAPI] services in your Helidon application.
...
| xref:{rootdir}/{flavor-lc}/openapi.adoc[OpenAPI] | `openapi`
|====
...
ifndef::se-flavor[]
xref:{rootdir}/mp/cors/03_configuration-with-cors-mp.adoc[Using Configuration with CORS in Helidon MP].
endif::[]
