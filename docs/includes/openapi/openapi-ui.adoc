...
[NOTE]
====
The Helidon team discourages including the OpenAPI UI in production applications. The OpenAPI UI _can_ be useful for demonstrating and "test driving" your service's endpoints prior to deployment.
====
