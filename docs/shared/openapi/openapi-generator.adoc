...
:openapi-page: {flavor-lc}/openapi/01_openapi.adoc
:webclient-page: se/webclient/01_introduction.adoc
:base-url: .
:javadoc-base-url: {base-url}
:webclient-javadoc-base-url: {javadoc-base-url}/io.helidon.webclient
:restclient-page: mp/restclient/09_rest-client.adoc
ifdef::mp-flavor[:helidon-client-xref: {restclient-page}]
ifdef::se-flavor[:helidon-client-xref: {webclient-page}]
:cli-page: about/05_cli.adoc
...
Generate code for your Helidon {flavor-uc} server and client from an OpenAPI document.
// end::preamble[]
...
The earlier links to the lists of configuration options for the Helidon generators groups options and additional properties in separate tables.
