...
:ui-images-dir: openapi-ui
:screen-capture-start: {ui-images-dir}/openapi-ui-screen-capture-greeting-{flavor-lc}-start.png
:screen-capture-expanded: {ui-images-dir}/openapi-ui-screen-capture-greeting-{flavor-lc}-expanded.png
:openapi-ui-javadoc-base-url: {javadoc-base-url}/io.helidon.integrations.openapi.ui
:version-lib-smallrye-open-api: 2.0.26
...
Easily enhance your Helidon {flavor-uc} application by adding an interactive user interface web page based on your service's OpenAPI document.
// end::preamble[]
...
// tag::dependencies[]
include::{rootdir}/shared/dependencies/common_shared.adoc[]
...
include::{incdir}/io_helidon_openapi_OpenApiUi.adoc[tag=config,leveloffset=+1]
