...
Jaeger tracks its own behavior using metrics. See <<{jaeger-metrics-page-ref}, Metrics Support for Jaeger>> to read how to integrate Jaeger metrics with Helidon.