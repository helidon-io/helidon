...
|A Helidon {upper-case-flavor} Application | You can use your own application or use the https://helidon.io/docs/v2/#/{lower-case-flavor}/guides/02_quickstart[Helidon {upper-case-flavor} Quickstart] to create a sample application.
