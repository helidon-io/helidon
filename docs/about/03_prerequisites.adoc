...
xref:05_kubernetes.adoc[install one on your desktop]).
...
1. xref:../mp/guides/02_quickstart.adoc[Helidon MP Quickstart Example]
2. xref:../se/guides/02_quickstart.adoc[Helidon SE Quickstart Example]

TIP: See xref:02_introduction.adoc[About Helidon]
for more information on the differences between Helidon MP and SE.

TIP: See xref:04_windows.adoc[Helidon on Windows]
