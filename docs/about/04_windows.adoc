...
For general pre-requisites like Java and Maven see xref:03_prerequisites.adoc[Getting Started].
If you want to use the xref:05_cli.adoc[Helidon CLI] you'll also need to install the
...
You can then follow the instructions in the xref:../se/guides/02_quickstart.adoc[Helidon SE Quickstart]. If
...
You can then follow the instructions in the xref:../mp/guides/02_quickstart.adoc[Helidon MP Quickstart]. If
you do not have `curl` installed you can use `Invoke-WebRequest`:
