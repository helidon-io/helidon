...
|Learn more about xref:../se/introduction.adoc[Helidon SE]. | Learn more about xref:../mp/introduction/01_introduction.adoc[Helidon MP].
|====================
...
Helidon SE already supports GraalVM, but in 2.0 GraalVM native image support will also be available in Helidon MP.
 xref:../mp/guides/36_graalnative.adoc[GraalVM Native Images Guide] +
...
MP Reactive Operators will be included in both frameworks, while MP Reactive Messaging will only be included in
 Helidon MP. xref:../mp/reactivemessaging/01_introduction.adoc[Learn more about Reactive Messaging] and
 xref:../mp/reactivestreams/01_overview.adoc[Reactive Streams].
...
Although it is possible for any Helidon application to implement its own support for CORS, there are common tasks
 ...
 xref:../se/cors/01_introduction.adoc[Learn more about CORS support].
