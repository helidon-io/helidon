...
If you created your application using the xref:05_cli.adoc[Helidon CLI] or
xref:03_prerequisites.adoc[archetypes] then your
...
-  Maven Build Guide for xref:../se/guides/25_maven_build.adoc[SE] and
 xref:../mp/guides/25_maven_build.adoc[MP]
-  Gradle Build Guide for xref:../se/guides/26_gradle_build.adoc[SE] and
 xref:../mp/guides/26_gradle_build.adoc[MP]
