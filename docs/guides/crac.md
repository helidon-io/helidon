...
This guide describes how to create a CRaC snapshot for a Helidon application.
...
| [Azul Zulu JDK CRaC 25+][azul-zulu-jdk-cr] | Zulu Warp CRaC engine allows snapshotting without elevated privileges                                                                 |
...
You should see in the output that Helidon has started with the CRaC feature
enabled.
...
[azul-zulu-jdk-cr]: https://www.azul.com/downloads/?package=jdk-crac#zulu
[bellsoft-liberic]: https://bell-sw.com/pages/downloads/?package=jdk-crac
