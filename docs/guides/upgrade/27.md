...
The extensions repository also provides Gson media support
(`io.helidon.extensions.gson:helidon-extensions-gson-media`), TOML support,
OpenAPI Generator, and Chaos. These are extension releases, but they are not
