...
|<<ABAC (Attribute based access control) Authorization Provider,ABAC Authorization>> |Authorization |🚫 |Attribute based access control authorization policies
|===
...
|<<Google Login,Google Login>> |Authentication |✅ |Authenticates a token from request against Google servers
|<<JWT Provider,JWT Provider>> |Authentication |✅ |JWT tokens passed from frontend
|===


include::providers/oidc.adoc[]

include::providers/http-basic-auth.adoc[]

include::providers/http-digest-auth.adoc[]
