...
[Jakarta Bean Validation specification][bv-spec] defines an API to validate Java
beans. Bean Validation is supported in REST resource classes as well as in
