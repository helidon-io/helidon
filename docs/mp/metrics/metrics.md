...
- The any-card count is two, since you invoked the endpoint twice. The other
...
- This class is now annotated with `@Counted`, which aggregates count data from
...
- The `totalCards.GreetingCards` count is a total of all the method-level
...
- Declares that your observer method responds to the `RuntimeStart` event. By
