...
Create a sample MicroProfile (MP) project that can be used to run some basic examples using both built-in and custom metrics with Helidon MP. xref:../guides/05_metrics.adoc[Helidon MP Metrics Guide].