...
include::{rootdir}/includes/metrics/metrics-capable-components.adoc[tags=preamble]
include::{rootdir}/includes/metrics/metrics-capable-components.adoc[tags=all-beginning-text]
include::{rootdir}/includes/metrics/metrics-capable-components.adoc[tags=writing-code-beginning]
