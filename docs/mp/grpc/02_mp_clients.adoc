...
As discussed in the section on xref:01_mp_server_side_services.adoc[Server-Side Services] there are four different types of gRPC method.
...
file but there are many other ways to use and override xref:../config/01_introduction.adoc[configuration in Helidon]
