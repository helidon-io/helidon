...
configure Helidon. See [Configuration in Helidon](../../mp/config/config.md) for
more information.
...
2. The `@Grpc.GrpcChannel` annotation supplies the channel name. This is the
   same name as used in the channel configuration in the examples provided in
