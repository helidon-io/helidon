...
:rest-client: ../restclient/09_rest-client.adoc
:jaxrs-spec: https://jakarta.ee/specifications/restful-ws/3.0/jakarta-restful-ws-spec-3.0.html
:jaxrs-spec-client: https://jakarta.ee/specifications/restful-ws/3.0/jakarta-restful-ws-spec-3.0.html#client_api
:jaxrs-javadocs: https://jakarta.ee/specifications/restful-ws/3.0/apidocs/
...
from the link:{rest-client}[Rest Client API] in that it does not support
...
Configutation can be specified at the `Client` or `WebTarget` level, both types implement
...
turn into either asynchronous or reactive calls by simply inserting the
...
link:{jaxrs-spec-client}[Jakarta REST Client Specification].

== Additional Information

For additional information, see the link:{jaxrs-javadocs}}[Jakarta REST Javadocs].
