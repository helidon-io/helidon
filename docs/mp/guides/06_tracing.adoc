...
----
<1> The `getMessage` method will be traced since it is externally invoked by `Neo4jResource`.
...
import io.helidon.examples.integrations.neo4j.mp.Neo4jDataProvider;import org.glassfish.jersey.server.Uri;
...
public class GreetResource {
  ...
  @Inject
  public GreetResource(Neo4jDataProvider greetingConfig) {
