...
See https://github.com/eclipse/microprofile-opentracing/releases/tag/2.0[MicroProfile OpenTracing] for more details.
...
- MicroProfile OpenTracing specification at https://github.com/eclipse/microprofile-opentracing/releases/tag/2.0
- MicroProfile OpenTracing Javadoc at https://javadoc.io/doc/org.eclipse.microprofile.opentracing/microprofile-opentracing-api/2.0
