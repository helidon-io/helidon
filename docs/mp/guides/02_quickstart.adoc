...
* xref:36_graalnative.adoc[GraalVM Native Images]
* xref:37_jlink_image.adoc[Custom Runtime Images using `jlink`]

== The Helidon CLI

With the Helidon CLI you can create additional types of Helidon applications and
use the "dev loop" to do fast, iterative development. xref:../../about/05_cli.adoc[Try it now].
