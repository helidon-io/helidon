...
= Helidon MP Porting Guide
:description: Helidon MP Porting Guide
:keywords: helidon, porting, incompatibilities
:helidon-uc-flavor: MP
:helidon-lc-flavor: mp

In Helidon 2 we have made some changes to APIs and runtime behavior. This guide
will help you port a Helidon MP 1.x application to 2.x.

include::../../common/guides/porting.adoc[]
