<!--@frontmatter
description: "Learn how to upgrade your Helidon MP application from 3.x to 4.x"
navigation:
...
MP 3.x application to Helidon 4.x.
...
the server implementation used by previous versions of Helidon.
...
Helidon 4.0.0 adds support for [MicroProfile 6.0][microprofile-6-0]. Key changes
include:

- Significant updates to the [MicroProfile Metrics
  specification][microprofile-met].
- Addition of the MicroProfile Telemetry specification which replaces the
  MicroProfile OpenTracing specification.
- Support for the [Jakarta EE 10 Core Profile][jakarta-ee-10-co] (instead of
  individual Jakarta EE specifications).
- Various minor updates to other MicroProfile specifications. Review the
  individual MicroProfile specifications for details.
...
The Jandex groupId changed from `org.jboss.jandex` to `io.smallrye`. You should
...
Additionally, the Java package changed from
...
If you use this handler in your `logging.properties` file, you must update it
...
[microprofile-met]: https://download.eclipse.org/microprofile/microprofile-metrics-5.0.0/microprofile-metrics-spec-5.0.0.html
[jakarta-ee-10-co]: https://jakarta.ee/specifications/coreprofile/10/jakarta-coreprofile-spec-10.0#introduction
