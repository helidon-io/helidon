...
include::{rootdir}/includes/prerequisites.adoc[tag=common-prereqs-curl]
...
TIP: You can learn more about options for configuring the Helidon Server on the
 xref:../jaxrs/02_server-configuration.adoc[Configuring the Server] page.
...
TIP: Learn much more about configuration in xref:../../se/config/06_advanced-configuration.adoc[Advanced Configuration Topics].
...
TIP: To learn more about Helidon MP configuration please see the
 xref:../config/01_introduction.adoc[Config] section of the documentation.
...
Learn more about using Helidon and MicroProfile metrics in the xref:05_metrics.adoc[Metrics Guide].
...
Learn more about health checks in the xref:04_health.adoc[Health Check Guide].
...
xref:../../about/05_kubernetes.adoc[install one on your desktop].
...
* xref:../jaxrs/02_server-configuration.adoc[Configuring the Server]
* xref:../config/01_introduction.adoc[Config]
* https://microprofile.io/project/eclipse/microprofile-metrics[MicroProfile Metrics Specification]
* xref:05_metrics.adoc[Metrics Guide]
* link:{microprofile-health-spec-url}##_protocol_and_wireformat[MicroProfile Health Protocol and Wireformat]
* xref:../../about/05_kubernetes.adoc[Install Kubernetes on your desktop]
