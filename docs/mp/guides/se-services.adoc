...
Helidon MP supports xref:../jaxrs/reactive-routing.adoc[Reactive routing] which brings possibility for reusing
...
* @RoutingName - select routing when xref:../jaxrs/server-configuration.adoc#conf-additional-ports[serving requests on multiple ports]
