...
Helidon MP supports xref:../server.adoc#_configuring_a_reactive_route[Reactive routing] which brings possibility for reusing
...
* @RoutingName - select routing when xref:../server.adoc#annotation-routing-name[serving requests on multiple ports]
