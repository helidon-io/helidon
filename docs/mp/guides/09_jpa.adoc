...
NOTE: This guide assumes that you have read the following:
 <<mp/guides/07_datasource.adoc,An understanding of named data source support in Helidon MP>> and 
...
<1> The
    https://wiki.eclipse.org/EclipseLink/UserGuide/JPA/Advanced_JPA_Development/Performance/Weaving/Static_Weaving#Use_the_Command_Line[Eclipselink-supplied
    `StaticWeave` class] is used to weave classes.
