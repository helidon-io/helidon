...
NOTE: This guide assumes that you have read the following:
 xref:07_datasource.adoc[An understanding of named data source support in Helidon MP] and
 xref:08_jta.adoc[An understanding of transaction support in Helidon MP].
