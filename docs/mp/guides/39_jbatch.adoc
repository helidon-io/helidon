...
public class MyInputRecord {
    private int id;    public MyInputRecord() {
...
public class MyOutputRecord {
    private int id;    public MyOutputRecord() {
...
public class MyItemProcessor implements ItemProcessor {
    ...
    public MyOutputRecord processItem(Object t) {
        System.out.println("processItem: " + t);        return (((MyInputRecord) t).getId() % 2 == 0) ? null 
...
The `MyItemWriter` should just print the result:
...
Put all of this into your job descriptor xml file as shown in this example:
   ...
   @GET
    ...
    public JsonObject executeBatch() throws Exception{
        ...
        return JSON.createObjectBuilder()
                .add("Steps executed",
 Arrays.toString(executedSteps.toArray()))
                .add("Status",
...
----
public class HelidonExecutorServiceProvider implements
...
For additional information, including additional examples, see <need link to Helidon repo>. 
