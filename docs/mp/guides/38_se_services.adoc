...
Helidon MP supports xref:../jaxrs/10_reactive-routing.adoc[Reactive routing] which brings possibility for reusing
...
* @RoutingName - select routing when xref:../jaxrs/02_server-configuration.adoc#conf-additional-ports[serving requests on multiple ports]
