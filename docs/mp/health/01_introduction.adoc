...
To enable MicroProfile Health add the <<mp/introduction/02_microprofile.adoc, helidon-microprofile bundle>>  dependency to your project's `pom.xml` (see <<about/04_managing-dependencies.adoc, Managing Dependencies>>).
...
Helidon MP Health implements MicroProfile Health Checks
link:http://download.eclipse.org/microprofile/microprofile-health-{health-release}/microprofile-health-spec.pdf[Specification].
...
include::../../shared/config/io.helidon.health.HealthSupport.adoc[]
...
Full example code is available link:https://github.com/oracle/helidon/tree/{helidon-version}/examples/microprofile[here].
...
Full example code is available
link:https://github.com/oracle/helidon/tree/{helidon-version}/examples/microprofile[here].


== Reference

* link:https://helidon.io/docs/v2/apidocs/io.helidon.microprofile.health/module-summary.html[Helidon MicroProfile Health JavaDoc]
* link:https://helidon.io/docs/v2/apidocs/io.helidon.health.checks/module-summary.html[Helidon Built-in Checks JavaDoc]
* link:http://download.eclipse.org/microprofile/microprofile-health-{health-release}/microprofile-health-spec.pdf[MicroProfile Health Specification]
