...
If `Helidon MicroProfile Core` is used, the following dependency should be included in your project's `pom.xml`:
...
The responsible for configuration class is:
...
Generate Helidon MP Quickstart project following these <<Instructions, Instruction>>
...
To find more information about MicroProfile follow this link:https://microprofile.io/[link].
