...
:fault-tolerance-spec-url: https://download.eclipse.org/microprofile/microprofile-fault-tolerance-4.0/microprofile-fault-tolerance-spec-4.0.html
...
:fault-tolerance-javadoc: https://javadoc.io/doc/org.eclipse.microprofile.fault-tolerance/microprofile-fault-tolerance-api/4.0/index.html
...
classes and methods in your application for the purpose of improving its robusteness.
...
|`@CircuitBreaker(failOn={Throwable.class},
skipOn={},
delay=5000,
delayUnit=ChronoUnit.MILLIS,
...
link:{fault-tolerance-javadoc}[MicroProfile Fault Tolerance Javadocs].

== Reference

* link:{fault-tolerance-spec-url}[MicroProfile Fault Tolerance]
