...
For example, if you wanted to run code when a CDI container starts, then you would have to write an  _observer method_ in an enabled CDI-managed bean that observes the initialization of the application scope. 
