...
** <<Customizing the MP Server at Startup, Customize Server at Startup>>
...
You can combine the the observer method with `ServerCdiExtension` customize the underlying WebServer without configuration.
