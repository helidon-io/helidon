...
| [HTTP Basic Authentication][http-basic-authentication] | Authentication | ✅ | HTTP Basic Authentication support |
| [HTTP Digest Authentication][http-digest-authentication] | Authentication | 🚫 | **Deprecated!** HTTP Digest Authentication support |
...
| [ABAC Authorization][abac-authorization] | Authorization | 🚫 | Attribute based access control authorization policies |
...
<tr>
<td class="tableblock halign-left valign-top"><p><span id="a7e9b5-client-credentials-config"></span> <a href="../../mp/security/../../config/io_helidon_security_providers_oidc_common_ClientCredentialsConfig.html"><code>client-credentials-config</code></a></p></td>
<td class="tableblock halign-left valign-top"><p><code>VALUE</code></p></td>
...
<tr>
<td class="tableblock halign-left valign-top"><p><span id="a0a656-cookie-same-site"></span> <a href="../../mp/security/../../config/io_helidon_http_SetCookie_SameSite.html"><code>cookie-same-site</code></a></p></td>
<td class="tableblock halign-left valign-top"><p><code>VALUE</code></p></td>
...
<tr>
<td class="tableblock halign-left valign-top"><p><span id="ad1309-cors"></span> <a href="../../mp/security/../../config/io_helidon_cors_CrossOriginConfig.html"><code>cors</code></a></p></td>
<td class="tableblock halign-left valign-top"><p><code>VALUE</code></p></td>
...
<tr>
<td class="tableblock halign-left valign-top"><p><span id="abf3fb-header-token"></span> <a href="../../mp/security/../../config/io_helidon_security_util_TokenHandler.html"><code>header-token</code></a></p></td>
<td class="tableblock halign-left valign-top"><p><code>VALUE</code></p></td>
...
<tr>
<td class="tableblock halign-left valign-top"><p><span id="acf040-outbound"></span> <a href="../../mp/security/../../config/io_helidon_security_providers_common_OutboundTarget.html"><code>outbound</code></a></p></td>
<td class="tableblock halign-left valign-top"><p><code>LIST</code></p></td>
...
<tr>
<td class="tableblock halign-left valign-top"><p><span id="aebe14-outbound-type"></span> <a href="../../mp/security/../../config/io_helidon_security_providers_oidc_common_OidcOutboundType.html"><code>outbound-type</code></a></p></td>
<td class="tableblock halign-left valign-top"><p><code>VALUE</code></p></td>
...
<tr>
<td class="tableblock halign-left valign-top"><p><span id="a6ccfb-pkce-challenge-method"></span> <a href="../../mp/security/../../config/io_helidon_security_providers_oidc_common_PkceChallengeMethod.html"><code>pkce-challenge-method</code></a></p></td>
<td class="tableblock halign-left valign-top"><p><code>VALUE</code></p></td>
...
<tr>
<td class="tableblock halign-left valign-top"><p><span id="aef163-tenants"></span> <a href="../../mp/security/../../config/io_helidon_security_providers_oidc_common_TenantConfig.html"><code>tenants</code></a></p></td>
<td class="tableblock halign-left valign-top"><p><code>VALUE</code></p></td>
...
<tr>
<td class="tableblock halign-left valign-top"><p><span id="a85467-webclient"></span> <a href="../../mp/security/../../config/io_helidon_webclient_api_WebClient.html"><code>webclient</code></a></p></td>
<td class="tableblock halign-left valign-top"><p><code>VALUE</code></p></td>
...
| <span id="a989a6-decryption-keys-resource"></span> [`decryption-keys.resource`][decryption-keys-resource] | `VALUE` | `i.h.c.c.Resource` |   | A resource pointing to JWK with private keys used for JWE content key decryption |
...
| <span id="a23e2c-oidc-metadata-resource"></span> [`oidc-metadata.resource`][decryption-keys-resource] | `VALUE` | `i.h.c.c.Resource` |   | Resource configuration for OIDC Metadata containing endpoints to various identity services, as well as information about the identity server |
...
| <span id="a8cb9d-sign-jwk-resource"></span> [`sign-jwk.resource`][decryption-keys-resource] | `VALUE` | `i.h.c.c.Resource` |   | A resource pointing to JWK with public keys of signing certificates used to validate JWT |
| <span id="aa5a6b-token-endpoint-auth"></span> [`token-endpoint-auth`][token-endpoint-auth] | `VALUE` | `i.h.s.p.o.c.O.ClientAuthentication` | `CLIENT_SECRET_BASIC` | Type of authentication to use when invoking the token endpoint |
...
Multi-tenant support requires to obtain tenant name from the incoming request. OIDC configuration is selected based on the received tenant name. The way this tenant name has to be provided is configured via `tenant-id-style` configuration. See [How to enable tenants][how-to-enable-tenants] for more information. After matching tenant configuration with the received name, the rest of the OIDC flow if exactly the same as in [How does OIDC work][how-does-oidc-work].
...
| <span id="ab9ed4-atn-token-jwk-resource"></span> [`atn-token.jwk.resource`][decryption-keys-resource] | `VALUE` | `i.h.c.c.Resource` |   | JWK resource used to verify JWTs created by other parties |
...
| <span id="adc22c-sign-token-jwk-resource"></span> [`sign-token.jwk.resource`][decryption-keys-resource] | `VALUE` | `i.h.c.c.Resource` |   | JWK resource used to sign JWTs created by us |
...
[http-basic-authentication]: #http-basic-authentication-provider
[http-digest-authentication]: #http-digest-authentication-provider
[header-assertion]: #header-authentication-provider
[http-signatures]: #http-signatures-provider
[idcs-roles]: #idcs-role-mapper
[abac-authorization]: #abac-provider
...
[decryption-keys-resource]: ../../config/io_helidon_common_configurable_Resource.md
[token-endpoint-auth]: ../../config/io_helidon_security_providers_oidc_common_OidcConfig_ClientAuthentication.md
[how-to-enable-tenants]: #multiple-tenants
[how-does-oidc-work]: #how-does-it-work
