...
For more information please follow the official link:https://docs.jboss.org/hibernate/stable/validator/reference/en-US/html_single/?v=7.0#chapter-xml-configuration[Hibernate Validator Documentation]
...
Examples are available in link:https://github.com/oracle/helidon/tree/master/examples/microprofile/bean-validation[our official GitHub repository].
...
* link:https://beanvalidation.org/2.0/spec/[Bean Validation Specification]
