...
It follows the standard {jakarta-bean-validation-spec-url}[Jakarta Bean Validation specification] which defines an
API to validate Java beans.
...
For more information about the supported validations, see {jakarta-bean-validation-spec-url}[Jakarta Bean Validation specification].
