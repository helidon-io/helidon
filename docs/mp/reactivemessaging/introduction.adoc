...
.Terms definition
|===
|link:{microprofile-reactive-messaging-spec-url}#_supported_method_signatures[messaging method]| bean method invoked by messaging Specification
|link:{microprofile-reactive-messaging-spec-url}#_connector[connector]| Reactive Messaging connector
|link:{microprofile-reactive-messaging-spec-url}#_channel[channel]| named pair of producer and consumer, both sides can be either messaging method or connector
|===

The bean can have methods annotated by
link:{microprofile-reactive-messaging-spec-url}#_message_consumption_with_incoming[`@Incoming`],
link:{microprofile-reactive-messaging-spec-url}#_message_production_with_outgoing[`@Outgoing`] or both.
