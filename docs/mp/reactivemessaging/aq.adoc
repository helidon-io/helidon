...
Its also possible and preferable to refer to xref:../guides/datasource.adoc[configured datasource],
in our example xref:../extensions/cdi-datasource-ucp.adoc[Oracle UCP datasource]:
