...
Its also possible and preferable to refer to xref:../guides/07_datasource.adoc[configured datasource],
in our example xref:../extensions/02_cdi_datasource-ucp.adoc[Oracle UCP datasource]:
