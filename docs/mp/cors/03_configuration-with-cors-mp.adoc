...
= Using Configuration with CORS MP
:toc:
...
CORS for Helidon MP lets you and your users override the CORS behavior you establish for your endpoints
using the `@CrossOrigin` annotation in your application as well as the default CORS behavior of the built-in
Helidon services.

You need to understand how to specify the overriding values for the CORS attributes in configuration
