...
This link:{jakarta-cdi-spec-url}#spi[CDI portable extension] provides support for injecting
...
You can configure the object using xref:../jaxrs/02_server-configuration.adoc[MicroProfile config].
 For example, the data source created above can be configured as follows:
