...
Regardless of which connection pool you use, ultimately at the lowest
level a JDBC database driver is responsible for making any connections
to a relational database.  Drivers are database-product-specific.
