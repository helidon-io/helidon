...
Jakarta Persistence may be used in a fully container-managed manner,
which requires that a container, like Helidon MP, handle error
...
1. <<DS, Set up named data sources as appropriate>>

2. <<JTA, Set up Helidon MP's Jakarta Transactions support>>
...
* <<DS, Ensure you have set up named data sources as appropriate>>

* <<JTA, Ensure you have set up Helidon MP's Jakarta Transactions
  support>>
