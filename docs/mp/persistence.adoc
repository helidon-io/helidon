...
https://docs.oracle.com/en/java/javase/17/docs/api/java.sql/java/sql/Connection.html[`java.sql.Connection`s]
acquired from these data sources will be pooled by one of two possible
