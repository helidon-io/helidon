...
=== Project Setup [[DS-Project-Setup]]
...
**This documentation does not cover application-managed mode JPA.**

Jakarta Persistence may be used in a fully managed manner, which
requires that a container, like Helidon MP, handle error management,
thread safety and transaction management on behalf of the user.
**This documentation covers this container-managed mode of JPA
exclusively.**

Helidon MP's Jakarta Persistence integration comes with support for two JPA implementations, known as _JPA providers_:
...
around usage, it leaves many setup and configuration aspects up to the
JPA provider.

To set up Helidon MP's Jakarta Persistence integration in your
application to work with your chosen JPA provider, you must:

1. Include the proper Helidon dependencies

2. Set up your project for _static weaving_
