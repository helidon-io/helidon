...
Here are some general examples illustrating general configuration
patterns in various common MicroProfile Config-compatible locations.
...
(assuming the resource is registered as a MicroProfile Config
configuration source):
