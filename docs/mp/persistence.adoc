...
===== Environment Variables Set By the `env` Command
...
===== `application.yaml` Classpath Resource
...
====== Configuring the Oracle Universal Connection Pool and Oracle JDBC [[DS-Configuration-UCP-Oracle-Example]]
