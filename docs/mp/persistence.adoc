...
Helidon MP's Jakarta Persistence integration allows you to interact
with Jakarta Persistence objects as if your code were running in an
...
Jakarta Persistence is a Jakarta EE specification that describes how its implementations:
