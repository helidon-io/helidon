...
**** <<DS-HikariCP-Project-Setup, Setting Up the HikariCP Connection Pool>>
***** <<DS-HikariCP-Maven-Coordinates, Maven Coordinates (HikariCP)>>
**** <<DS-UCP-Project-Setup, Setting Up the Oracle Universal Connection Pool>>
***** <<DS-UCP-Maven-Coordinates, Maven Coordinates (Oracle Universal Connection Pool)>>
*** <<DS-Driver-Project-Setup, Setting Up a Database Driver>>
**** <<DS-H2-Driver-Project-Setup, Setting Up H2>>
***** <<DS-H2-Driver-Maven-Coordinates, Maven Coordinates (H2)>>
**** <<DS-Oracle-Driver-Project-Setup, Setting Up Oracle JDBC>>
***** <<DS-Oracle-Driver-Maven-Coordinates, Maven Coordinates (Oracle JDBC)>>
...
*** <<JPA-Maven-Coordinates, Common Maven Coordinates>>
*** <<JPA-MetaModel, Setting Up Static Metamodel Generation>>
*** <<JPA-Hibernate-Maven-Coordinates, Maven Coordinates (Hibernate ORM)>>
*** <<JPA-Hibernate-Weaving, Setting Up Static Weaving (Hibernate ORM)>>
*** <<JPA-Eclipselink-Maven-Coordinates, Maven Coordinates (Eclipselink)>>
*** <<JPA-Eclipselink-Weaving, Setting Up Static Weaving (Eclipselink)>>
...
To include the
https://docs.oracle.com/en/database/oracle/oracle-database/21/jjucp/index.html[Oracle
...
http://www.h2database.com/html/features.html#database_url[connect to
...
To include the
https://docs.oracle.com/en/database/oracle/oracle-database/21/jajdb/index.html[Oracle
JDBC driver classes] in your Helidon MP application so your
application can
https://docs.oracle.com/en/database/oracle/oracle-database/21/jjdbc/data-sources-and-URLs.html#GUID-EF07727C-50AB-4DCE-8EDC-57F0927FF61A[connect
...
<dependency>
    ...
    <!--
         Why ojdbc11? What does 11 mean? This is because:
         (a) Helidon 3.x targets Java 17
         ...
         for more details.
    -->
    <artifactId>ojdbc11</artifactId> <!--1-->
    <scope>runtime</scope> <!--2-->
</dependency>
----
<1> The `ojdbc11` artifact
...
<2> The `scope` is `runtime`, indicating that the Oracle
    JDBC driver classes will be available on the runtime classpath.
...
xref:config/config-sources.adoc[common MicroProfile Config-compatible
locations].
...
relying on
https://github.com/eclipse/microprofile-config/blob/master/spec/src/main/asciidoc/configsources.asciidoc#environment-variables-mapping-rules[MicroProfile
...
https://docs.oracle.com/en/database/oracle/oracle-database/21/jjdbc/data-sources-and-URLs.html#GUID-C4F2CA86-0F68-400C-95DA-30171C9FB8F0[connect
...
https://docs.oracle.com/en/database/oracle/oracle-database/21/jajdb/oracle/jdbc/pool/OracleDataSource.html[`oracle.jdbc.pool.OracleDataSource`]
...
NOTE: https://github.com/brettwooldridge/HikariCP/blob/HikariCP-5.0.1/src/main/java/com/zaxxer/hikari/util/PropertyElf.java#L46-L53[Unlike
...
https://docs.oracle.com/en/database/oracle/oracle-database/21/jjuar/oracle/ucp/jdbc/PoolDataSourceImpl.html#setConnectionFactoryClassName_java_lang_String_[`connectionFactoryClassName`
is a property of the Oracle Universal Connection Pool], and
https://docs.oracle.com/en/database/oracle/oracle-database/21/jajdb/oracle/jdbc/datasource/impl/OracleDataSource.html#setUser_java_lang_String_[`user`
...
will
https://docs.oracle.com/en/database/oracle/oracle-database/21/jjuar/oracle/ucp/jdbc/PoolDataSource.html#setUser_java_lang_String_[set
...
vendor-supplied `DataSource`
https://github.com/brettwooldridge/HikariCP/blob/HikariCP-5.0.1/src/main/java/com/zaxxer/hikari/util/PropertyElf.java#L46-L53[are
prefixed with `dataSource.`] as seen in the example above.

In general, the properties that can be set on the
http://www.h2database.com/javadoc/org/h2/jdbcx/JdbcDataSource.html[`org.h2.jdbcx.JdbcDataSource`]
...
<1> The `scope` is `provided`, which ensures that the
    https://jakarta.ee/specifications/transactions/2.0/apidocs/jakarta/transaction/transactional[JTA
...
<1> The
    ...
    (https://jakarta.ee/specifications/cdi/3.0/jakarta-cdi-spec-3.0.html#implementation[CDI
    beans are managed], as are
    https://jakarta.ee/specifications/restful-ws/3.1/jakarta-restful-ws-spec-3.1.html#resource-classes[Jakarta
...
<2> For
    ...
    https://jakarta.ee/specifications/persistence/3.0/apidocs/jakarta.persistence/jakarta/persistence/entitymanager[`EntityManager`]).
...
https://jakarta.ee/specifications/persistence/3.0/apidocs/jakarta.persistence/jakarta/persistence/entitymanager[`EntityManager`]
instances using the
https://jakarta.ee/specifications/persistence/3.0/apidocs/jakarta.persistence/jakarta/persistence/persistencecontext[`@PersistenceContext`]
annotation.
...
----
<1> The `scope` is `provided`, which ensures that the
    https://jakarta.ee/specifications/persistence/3.0/apidocs/jakarta.persistence/jakarta/persistence/package-summary.html[JPA
    classes required for compilation] are available at compile time.
...
<1> This adds the `hibernate-jpamodelgen` jar, which contains a
    https://github.com/hibernate/hibernate-orm/blob/6.1.1/tooling/metamodel-generator/src/main/java/org/hibernate/jpamodelgen/JPAMetaModelEntityProcessor.java#L59[Java
...
----
<1> This instructs Hibernate ORM to
    https://github.com/hibernate/hibernate-orm/blob/6.1.1/hibernate-core/src/main/java/org/hibernate/cfg/Environment.java#L236[not
...
https://docs.jboss.org/hibernate/orm/6.1/userguide/html_single/Hibernate_User_Guide.html#configurations-bytecode-enhancement[Bytecode
...
a
https://jakarta.ee/specifications/persistence/3.0/jakarta-persistence-spec-3.0.html#persistence-xml-file[`src/main/resources/META-INF/persistence.xml`
...
https://jakarta.ee/specifications/persistence/3.0/jakarta-persistence-spec-3.0.html#persistence-xml-file[persistence.xml
...
<persistence-unit name="prod" transaction-type="JTA"> <!--1-->
    ...
    <!--2-->
    <!--
        Other characteristics of the persistence unit are enclosed
        here.  Order matters.  See
...
<1> Because Helidon MP's JPA integration is for container-managed JPA,
    the
    https://jakarta.ee/specifications/persistence/3.0/jakarta-persistence-spec-3.0.html#a12296[`transaction-type`
    attribute] must in practice always be set to `JTA`.
<2> The order of child elements is significant and governed by the
    https://jakarta.ee/specifications/persistence/3.0/jakarta-persistence-spec-3.0.html#persistence-xml-schema[XML
    schema].
...
an instance of the
https://jakarta.ee/specifications/persistence/3.0/apidocs/jakarta.persistence/jakarta/persistence/spi/persistenceunitinfo[`PersistenceUnitInfo`]
class.
...
1. https://jakarta.ee/specifications/persistence/3.0/jakarta-persistence-spec-3.0.html#a18[Entity
   classes]

2. https://jakarta.ee/specifications/persistence/3.0/jakarta-persistence-spec-3.0.html#a487[Embeddable
   classes]

3. https://jakarta.ee/specifications/persistence/3.0/jakarta-persistence-spec-3.0.html#mapped-superclasses[Mapped
   superclasses]

4. https://jakarta.ee/specifications/persistence/3.0/jakarta-persistence-spec-3.0.html#a2999[Converter
   classes]

You use a
https://jakarta.ee/specifications/persistence/3.0/jakarta-persistence-spec-3.0.html#list-of-managed-classes[sequence
...
NOTE: There are
https://jakarta.ee/specifications/persistence/3.0/jakarta-persistence-spec-3.0.html#a12305[other
...
https://jakarta.ee/specifications/persistence/3.0/jakarta-persistence-spec-3.0.html#a12384[`<properties>`
...
https://jakarta.ee/specifications/persistence/3.0/jakarta-persistence-spec-3.0.html#a12384[described
...
<2> This is a Hibernate ORM-specific property and will be properly
    ...
    Eclipselink.  See
    https://docs.jboss.org/hibernate/orm/6.1/userguide/html_single/Hibernate_User_Guide.html#configurations-logging[Statement
...
<3> This is an Eclipselink-specific property (and (a) is required and
    ...
    https://www.eclipse.org/eclipselink/documentation/3.0/jpa/extensions/persistenceproperties_ref.htm#weaving[weaving]
...
https://docs.jboss.org/hibernate/orm/6.1/userguide/html_single/Hibernate_User_Guide.html#configurations[Configurations]
in the Hibernate ORM documentation.

TIP: For an exhaustive list of Eclipselink-specific properties, see
https://www.eclipse.org/eclipselink/documentation/3.0/jpa/extensions/persistenceproperties_ref.htm#sthref733[Persistence
...
1. Annotate your managed classes (entities, mapped superclasses, etc.)
   appropriately (using
   https://jakarta.ee/specifications/persistence/3.0/apidocs/jakarta.persistence/jakarta/persistence/entity[`@Entity`]
...
https://jakarta.ee/specifications/persistence/3.0/jakarta-persistence-spec-3.0.html#entities[the
...
* https://github.com/oracle/helidon/tree/master/examples/integrations/cdi/pokemons[JPA
  Pokemons Example]
...
* https://github.com/brettwooldridge/HikariCP/tree/HikariCP-5.0.1#readme[HikariCP
  5.0.1 documentation]
...
* https://docs.oracle.com/en/database/oracle/oracle-database/21/jjucp/index.html[Oracle®
  Universal Connection Pool Developer's Guide, Release 21c]

* https://docs.oracle.com/en/database/oracle/oracle-database/21/jjuar/index.html#[Oracle®
  Universal Connection Pool Java API Reference, Release 21c]

* https://docs.oracle.com/en/database/oracle/oracle-database/21/jjdbc/index.html[Oracle®
  Database JDBC Developer's Guide and Reference, Release 21c]

* https://docs.oracle.com/en/database/oracle/oracle-database/21/jajdb/index.html[Oracle®
  Database JDBC Java API Reference, Release 21c]

* http://www.h2database.com/html/main.html[H2 Database Engine documentation]

* https://jakarta.ee/specifications/transactions/2.0/jakarta-transactions-spec-2.0.html[Jakarta
  Transactions 2.0 Specification]

* https://jakarta.ee/specifications/transactions/2.0/apidocs/[Jakarta
  Transactions 2.0 API Reference]
...
* https://jakarta.ee/specifications/persistence/3.0/jakarta-persistence-spec-3.0.html[Jakarta
  Persistence 3.0 Specification]

* https://jakarta.ee/specifications/persistence/3.0/apidocs/[Jakarta
  Persistence 3.0 API Reference]

* https://docs.jboss.org/hibernate/orm/6.1/userguide/html_single/Hibernate_User_Guide.html[Hibernate
  ORM 6.1.1 User Guide]
