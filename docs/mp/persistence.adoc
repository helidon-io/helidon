...
Here is an example of a persistence unit named `prod`:
...
<persistence-unit name="prod">
  ...
  <!-- Characteristics of the persistence unit are enclosed here.  Order matters. -->
...
helpful description, linked with a JTA data source named `main`, and
