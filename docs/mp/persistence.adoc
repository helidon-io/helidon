...
_vendor-supplied `DataSource`_ present in the JDBC driver classes you
...
<persistence-unit name="prod" transaction-type="JTA">
    ...
    <properties>
        ...
        <property name="eclipselink.weaving" value="false"/> <!--2-->
    </properties>
</persistence-unit>

<!-- ... -->
----
<1> This is a Hibernate ORM-specific property and will be properly
...
<2> This is an Eclipselink-specific property (and (a) is required and
