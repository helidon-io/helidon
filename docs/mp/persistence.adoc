...
<1> The name identifies a name present in the
    <<DS-Configuration_Prefixes, _datasourcename_ portion of a named datasource configuration>>.
    There is no need for any kind of reserved prefix (like `java:comp/env`).
