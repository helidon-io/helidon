...
The Microprofile GraphQL APIs are an extension to xref:../introduction/01_introduction.adoc[Helidon MP]
...
As per the instructions xref:../introduction/02_microprofile.adoc[here] ensure you have added a
...
link:{helidon-tree-url}/master/examples/microprofile/graphql[example].
...
include::{rootdir}/includes/graphql/configuration.adoc[]
