...
[icon=save,link=../aot/01_introduction.adoc]
--
...
[CARD]
.Fault Tolerance
[icon=warning,link=../faulttolerance/01_overview.adoc]
--
...
[CARD]
.GraphQL
[icon=graphic_eq,link=../graphql/01_mp_graphql.adoc]
--
...
[CARD]
.Health Checks
[icon=favorite_outline,link=../health/01_introduction.adoc]
--
...
[CARD]
.JPA
[icon=dns,link=../jpa/01_introduction.adoc]
--
...
[CARD]
.JWT Authentication
[icon=verified_user,link=../jwtauth/01_introduction.adoc]
--
...
[CARD]
.Rest Client
[icon=airplay,link=../restclient/09_rest-client.adoc]
--
...
[CARD]
.WebSocket
[icon=sync_alt,link=../websocket/01_overview.adoc]
--
