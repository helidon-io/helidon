...
as is done in the xref:../guides/02_quickstart.adoc[Helidon MP Quickstart example]
or use its built-in `main` as shown below.

=== Maven Coordinates

The xref:../../about/04_managing-dependencies.adoc[Managing Dependencies] page describes
