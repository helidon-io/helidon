...
[CARD]
.JAX-RS/Jersey
[icon=settings_ethernet,link=../server.adoc]
--
...
[CARD]
.Persistence
[icon=dns,link=../persistence.adoc]
--
Work with named data sources, JTA and JPA in Helidon MP in all the
ways that you’re familiar with.
--
