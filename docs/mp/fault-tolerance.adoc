...
Fault Tolerance is part of the MicroProfile set of {microprofile-fault-tolerance-spec-url}[specifications]. This API defines mostly
...
link:{configurable-javadoc-base-url}/ThreadPoolSupplier.Builder.html#config(io.helidon.config.Config)[ServerThreadPoolSupplier] and
link:{configurable-javadoc-base-url}/ScheduledThreadPoolSupplier.Builder.html#config(io.helidon.config.Config)[ScheduledThreadPoolSupplier].
