...
These dependencies define the MicroProfile OpenAPI annotations so you can use them in your code
and add the Helidon MP OpenAPI runtime support, respectively.
