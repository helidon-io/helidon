...
JSON Web Tokens are an open, industry standard https://datatracker.ietf.org/doc/html/rfc7519[RFC 7519] method for representing claims securely between two parties.
...
* https://download.eclipse.org/microprofile/microprofile-jwt-auth-{spec-version}/microprofile-jwt-auth-spec-{spec-version}.html[MicroProfile JWT Auth Spec]
