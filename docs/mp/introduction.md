...
<!-- @icon-list -->
- MicroProfile APIs for common microservice concerns. <!-- @icon
  i-lucide-layers-3 -->
- Jakarta EE annotations for REST services and data access. <!-- @icon
  i-lucide-braces -->
- Dependency injection for composing application components. <!-- @icon
  i-lucide-git-branch -->
- Standalone JVM applications with no application server dependency. <!-- @icon
  i-lucide-box -->
- High-concurrency services that benefit from virtual threads. <!-- @icon
  i-lucide-gauge -->
- Helidon WebServer runtime with cloud-native observability. <!-- @icon
  i-lucide-activity -->
