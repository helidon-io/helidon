...
For complete code, about how to setup datasource using wallet info, please see link:{helidon-github-tree-url}/examples/integrations/oci/atp-cdi[ATP MP Example]