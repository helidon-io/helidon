...
consists of initializing an OCI Authentication Details Provider. By default
the extension will examine your environment and select the best Authentication
Details Provider and configure it for you.
...
Authentication Details Provider will be used.
