...
For complete code, about how to set up datasource using wallet info, please see https://github.com/oracle/helidon/tree/master/examples/integrations/oci/atp-cdi[ATP MP Example]