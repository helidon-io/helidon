...
When added to your application this link:{jakarta-cdi-spec-url}#spi[CDI portable extension] provides support for
...
- xref:object-storage.adoc[OCI Object Storage]
- xref:vault.adoc[OCI Vault]
- xref:atp.adoc[OCI ATP]
