...
| [Fault Tolerance](fault-tolerance.md) <!--@icon i-lucide-triangle-alert -->            | MicroProfile Fault Tolerance             |
| [GraphQL](graphql.md) <!--@icon i-simple-icons-graphql -->                             | Helidon GraphQL Support                  |
| [gRPC](grpc/README.md) <!--@icon i-lucide-arrow-left-right -->                         | Index of gRPC documentation              |
| [Health](health.md) <!--@icon i-lucide-heart -->                                       | MicroProfile Health                      |
| [JAX-RS](jaxrs/README.md) <!--@icon i-lucide-ethernet-port -->                         | Index of JAX-RS documentation            |
| [JWT Authentication](jwt.md) <!--@icon i-lucide-shield-check -->                       | MicroProfile JWT                         |
| [LangChain4j](langchain4j.md) <!--@icon i-lucide-sparkles -->                          | Helidon LangChain4j Support              |
| [Long Running Actions (LRA)](lra.md) <!--@icon i-lucide-file-clock -->                 | Helidon Long Running Actions             |
...
| [Persistence](persistence.md) <!--@icon i-lucide-server -->                            | Helidon MP JPA                           |
...
| [Scheduling](scheduling.md) <!--@icon i-lucide-alarm-clock -->                         | Helidon MP Scheduling                    |
| [Security](security/README.md) <!--@icon i-lucide-shield -->                           | Index of Security documentation          |
| [Server](server.md) <!--@icon i-lucide-ethernet-port -->                               | Helidon MP Server                        |
