...
For more information, see xref:../security/configuration-secrets.adoc[Configuration Secrets].
...
This is a Helidon specific feature available since version 2.3.0. See xref:../config/MP-config-sources.adoc[Microprofile Config Sources] for detailed information.
