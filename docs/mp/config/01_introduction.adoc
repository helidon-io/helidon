...
Helidon MicroProfile provides an implementation of Eclipse MicroProfile Config. It allows you to configure your applications using MicroProfile configuration sources and APIs.
...
For more information, see xref:../security/03_configuration-secrets.adoc[Configuration Secrets].
...
This is a Helidon specific feature available since version 2.3.0. See xref:../config/02_MP_config_sources.adoc[Microprofile Config Sources] for detailed information.
...
- link:{javadoc-base-url}/io.helidon.config/io/helidon/config/spi/package-summary.html[Helidon Config SPI]
- link:{javadoc-base-url}/io.helidon.config/io/helidon/config/package-summary.html[Helidon Config API]
- link:{microprofile-config-spec-url}[MicroProfile Config API]
