...
See the link:{microprofile-rest-client-spec-url}[specification] for full details.

== Quickstart Example
To be able to run and test this example, use the xref:../guides/02_quickstart.adoc[Helidon MP quickstart]
