...
== Creating a New Nlient Uusing a Builder
...
https://download.eclipse.org/microprofile/microprofile-rest-client-2.0/microprofile-rest-client-spec-2.0.html#_hostname_verification
