...
Scheduling with fixed rate using `FixedRate.builder()`:
...
Scheduling is configurable with [Helidon Config](config/config.md).
...
For simple fixed-rate invocation use `FixedRate.builder()`.
...
[helidon-scheduli]: https://helidon.io/docs/core/v28/apidocs/io.helidon.scheduling/io/helidon/scheduling/package-summary.html
