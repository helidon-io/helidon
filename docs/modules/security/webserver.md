<!--@frontmatter
description: "Helidon WebServer Security"
-->
# WebServer
...
WebServer.builder()
        ...
        .build();
```
1. Helper method to load both security and web server security from
   configuration
...
[helidon-webserve]: https://helidon.io/docs/core/v28/apidocs/io.helidon.webserver.security/module-summary.html
