...
Java EE developers. MicroProfile includes existing APIs like JAX-RS, JSON-P and
CDI, and adds additional APIs in areas such as configuration, metrics, fault
tolerance and more.

== Getting Started with Helidon MicroProfile

MicroProfile is implemented by Helidon MP. The 1.0 release of Helidon supports
MicroProfile 1.2. You can find the exact version of APIs supported on the
