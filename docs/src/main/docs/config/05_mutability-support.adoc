...
link:07_extensions.html#Config-SPI-PollingStrategy[polling strategies] in the
...
[IMPORTANT]
=========
Supplier support requires that you build the `Config` object from sources that
