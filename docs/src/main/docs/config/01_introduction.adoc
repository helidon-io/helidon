...
+
or
* creating a link:06_advanced-configuration.html#metaconfig[meta-configuration]
...
| Where config comes from |link:02_config-sources.html[Config sources],
link:06_advanced-configuration.html#metaconfig[meta-configuration]
| What format config data is expressed in |link:02_config-sources.html#parsers[Config parsers], 
link:08_supported-formats.html[supported formats]
| How to filter, override, and dereference values |link:06_advanced-configuration.html#[Filters and overrides]
| What happens when config data changes |link:05_mutability-support.html[Config polling]
| How to deal with loading errors |link:06_advanced-configuration.html#retry[Config retry policies]
|===
...
| How config data is translated into Java types |link:04_property-mapping.html[Config mappers]
| How to navigate config trees |link:03_hierarchical-features.html[Navigation]
|===
...
| Writing extensions |link:07_extensions.html[Extensions]
|===
...
The advanced feature of loading the configuration from an externalized list of sources
 ...
 link:06_advanced-configuration.html#Config-Advanced-Config-MetaConfig[Create Config from meta-configuration].
=========
...
For more options, see 
 link:04_property-mapping.html[Property Mapping].
