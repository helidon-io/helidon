...
link:06_advanced-configuration.html#Config-Advanced-Config-MetaConfig[meta-configuration]
...
the link:-5_mutability-support.html[mutability support] and
link:07_extensions.html#Config-SPI-PollingStrategy[polling strategy] discussions.
