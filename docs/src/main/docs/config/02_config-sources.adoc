...
link:01_introduction.html#config-sources-default-config[config introduction]. 
...
the link:07_extensions.html[extensions] documentation for complete information.

See the link:06_advanced-configuration.html[advanced topics] page for further
...
The config system includes several built-in parsers, such as for the Java properties, YAML, JSON, and HOCON formats. See link:01_introduction.html#build-in-formats[this section in
...
link:{javadoc-base-url-api}/Config.Builder.html#addParser[config builder's `addParser`] method
