...
defined within the link:{java-base-url-api}/spi/ConfigNode.html[`ConfigNode`] interface.
...
link:08_supported-formats.html#Config-ModuleHocon[extension module].
...
link:{javadoc-base-url-api}/Config.Name.html[`name`], 
 link:{javadoc-base-url-api}/Config.Key.html[`key`], and 
 link:{javadoc-base-url-api}/Config.Type.html[`type`] of the
 node.
...
For example, the link:01_introduction.html#create-simple-config-props[`application.properties`]
...
link:{javadoc-base-url-api}/Config.htlm#detach[`Config.detach`] method it gets back
