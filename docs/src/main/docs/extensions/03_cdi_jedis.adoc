...
:mp-config-javadoc-base-url: https://static.javadoc.io/org.eclipse.microprofile.config/microprofile-config-api/1.3
:mp-config-api-url: {mp-config-javadoc-base-url}?overview-summary.html
:mp-config-propnames-url: {mp-config-javadoc-base-url}/org/eclipse/microprofile/config/Config.html#getPropertyNames--
