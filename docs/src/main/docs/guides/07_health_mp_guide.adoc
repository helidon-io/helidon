...
[source,bash]
.Build and restart the application, then verify the health endpoint using the new 'myhealth' root
----
...
[source,bash]
.Build and restart the application, then verify the health endpoint using port 8081 and 'myhealth'
----
