...
----
<1> This class is annotated with `@Counted` which aggregates data from all the method-level method counts.
...
* Heldidon Javadoc at https://helidon.io/docs/latest/apidocs/index.html?overview-summary.html
