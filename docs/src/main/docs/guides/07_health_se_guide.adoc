...
[source,bash]
.Build and run the application, then verify the health endpoint.  Verify the custom health endpoint is at the new URL path
----
...
.Build and run the application, then verify the live and ready health endpoints
