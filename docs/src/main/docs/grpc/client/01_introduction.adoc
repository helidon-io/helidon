...
https://github.com/aseovic/helidon/blob/master/docs/src/main/docs/grpc/01_introduction.adoc[gRPC Server] documentation.
...
public static void main(String[] args) throws Exception {
    ...
    CompletableFuture<String> future = client.unary("SayHello", "Helidon gRPC!!");                                // (5)
