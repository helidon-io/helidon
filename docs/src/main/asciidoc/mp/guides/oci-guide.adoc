...
injecting link:{oci-javasdk-url}[Oracle Cloud Infrastructure SDK Clients] in your Helidon application.

The Helidon Quick Start for OCI is currently only available with Helidon MP. However, you can write Helidon SE applications directly with the link:{oci-doc-url}/Content/API/SDKDocs/javasdk.htm[OCI SDK for Java APIs] and use this guide as a guideline for setting up your OCI environment.
...
The Helidon MP OCI project is pre-configured to integrate with several common OCI services but you must update its configuration with values specific to your application and OCI environment. 

Refer to the starter project's ``README.md`` for a high-level description of the components and features of the Helidon MP OCI project, then see xref:../integrations/oci.adoc[OCI Integration] for more information on how to configure your Helidon application to integrate with OCI services.
...
See xref:../integrations/oci.adoc[OCI Integration] for more information on how to configure your Helidon application to integrate with OCI services.
