...
----
include::{sourcedir}/mp/guides/SecurityOidcSnippets.java[tag=snippet_1, indent=0]
----
...
----
include::{sourcedir}/mp/guides/SecurityOidcSnippets.java[tag=snippet_2, indent=0]
----
...
----
include::{sourcedir}/mp/guides/SecurityOidcSnippets.java[tag=snippet_3, indent=0]
----

This piece of code uses the JAX-RS client to access the application on `/greet` path with a `GET` method. The http basic
...
----
include::{sourcedir}/mp/guides/SecurityOidcSnippets.java[tag=snippet_4, indent=0]
----
...
----
include::{sourcedir}/mp/guides/SecurityOidcSnippets.java[tag=snippet_6, indent=0]
----
