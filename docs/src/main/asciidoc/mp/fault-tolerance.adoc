...
[source,java]
----
include::{sourcedir}/mp/FaultToleranceSnippets.java[tag=snippet_1, indent=0]
----
...
[source,java]
----
include::{sourcedir}/mp/FaultToleranceSnippets.java[tag=snippet_2, indent=0]
----
...
[source,java]
----
include::{sourcedir}/mp/FaultToleranceSnippets.java[tag=snippet_3, indent=0]
----
