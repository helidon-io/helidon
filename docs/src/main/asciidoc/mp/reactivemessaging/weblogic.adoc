...
:jakarta-version: Jakarta EE {version-lib-jakarta-core}
...
----
include::{sourcedir}/mp/reactivemessaging/WeblogicSnippets.java[tag=snippet_1, indent=0]
----

[source,java]
.Consuming one by one, manual ack:
----
include::{sourcedir}/mp/reactivemessaging/WeblogicSnippets.java[tag=snippet_2, indent=0]
----
...
----
include::{sourcedir}/mp/reactivemessaging/WeblogicSnippets.java[tag=snippet_3, indent=0]
----

[source,java]
.Example of more advanced producing to WebLogic JMS:
----
include::{sourcedir}/mp/reactivemessaging/WeblogicSnippets.java[tag=snippet_4, indent=0]
----
[source,java]
.Example of even more advanced producing to WebLogic JMS with custom mapper:
----
include::{sourcedir}/mp/reactivemessaging/WeblogicSnippets.java[tag=snippet_5, indent=0]
----
