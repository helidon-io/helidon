...
Also add a Java services file so Helidon will discover your helper.

.`META-INF/services/io.helidon.microprofile.telemetry.spi.HelidonTelemetryContainerHelper`
[source,properties]
----
io.helidon.example.telemetry.CustomRestRequestFilterHelper
----
...
.`META-INF/services/io.helidon.microprofile.telemetry.spi.HelidonTelemetryClientFilterHelper`
[source,properties]
----
io.helidon.example.telemetry.CustomRestClientRequestFilterHelper
----
== Configuration
