...
2+|The following code examples illustrate the differences in how you would implement a simple RESTful service using either Helidon SE or Helidon MP.
...
TIP: If you're still unsure, start with Helidon MP.
