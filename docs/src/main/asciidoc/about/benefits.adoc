...
* <<A Programming Model Focused on Clarity, A Programming Model Focused on Clarity>>
...
== A Programming Model Focused on Clarity
Helidon SE offers a direct, explicit programming model that gives you fine-grained
control over application behavior without sacrificing productivity.


== Feature Richness
Helidon provides a rich set of features, including configuration, metrics,
security, data access, messaging, and integrations. The available feature set is
broad enough to cover the needs of modern microservices applications.
...
* Messaging Connectors for JMS and Oracle AQ, to allow Helidon
