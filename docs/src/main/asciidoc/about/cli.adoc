...
The Helidon CLI is a standalone executable (compiled using GraalVM) for Linux, macOS, and Windows systems. Download the executable and install it in a location that is accessible from your PATH.
