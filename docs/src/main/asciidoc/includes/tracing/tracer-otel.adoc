...
or application code initializes `GlobalOpenTelemetry`. If an OpenTelemetry global already exists, set `tracing.global`
to `false` and configure Helidon to use the existing instance instead.
