...
Helidon Data Repository is built on top of Jakarta Persistence supporting major providers such as EclipseLink and Hibernate.
...
Entity model as well as data repository interfaces require specific annotation processor configuration:
