...
----
include::{sourcedir}/includes/reactivestreams/EngineSnippets.java[tag=snippet_1, indent=0]
----

[source,java]
.Example of Single usage:
----
include::{sourcedir}/includes/reactivestreams/EngineSnippets.java[tag=snippet_2, indent=0]
----
...
|collectList|Collect the items of this `Multi` instance into a `Single` of `Collection`.
...
----
include::{sourcedir}/includes/reactivestreams/EngineSnippets.java[tag=snippet_3, indent=0]
----
