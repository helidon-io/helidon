...
|=======
include::prerequisites.adoc[tag=prerequisites-table-contents]
| https://www.graalvm.org/release-notes/JDK_21/[GraalVM 21.0.2+13 for JDK 21]| Helidon support
GraalVM for JDK 21 and higher except for `native-image`, Helidon requires GraalVM 21.0.2+13
specific version.
|=======
