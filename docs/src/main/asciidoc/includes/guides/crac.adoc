...
- https://www.azul.com/downloads/?package=jdk-crac#zulu[Azul Zulu]
- https://bell-sw.com/pages/downloads/?package=jdk-crac[BellSoft Liberica JDK]
...
In another shell trigger the snapshot creation with https://docs.oracle.com/en/java/javase/26/docs/specs/man/jcmd.html[jcmd] command `JDK.checkpoint`:
