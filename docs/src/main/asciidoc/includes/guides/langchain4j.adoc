...
[source,java]
----
include::{sourcedir}/includes/guides/lc4j/base/PirateService.java[tag=snippet_1, indent=0]
----
...
[source,java]
----
include::{sourcedir}/se/guides/lc4j/base/Resource.java[tag=imports, indent=0]

include::{sourcedir}/se/guides/lc4j/base/Resource.java[tag=method, indent=0]
----
...
[source,java]
----
include::{sourcedir}/mp/guides/lc4j/base/PirateResource.java[tag=snippet_1, indent=0]
----
...
[source,java]
----
include::{sourcedir}/includes/guides/lc4j/template/PirateService.java[tag=snippet_1, indent=0]
----
...
[source,java]
----
include::{sourcedir}/se/guides/lc4j/template/Resource.java[tag=imports, indent=0]

include::{sourcedir}/se/guides/lc4j/template/Resource.java[tag=method, indent=0]
----
endif::se-flavor[]
ifdef::mp-flavor[]
[source,java]
----
include::{sourcedir}/mp/guides/lc4j/template/PirateResource.java[tag=snippet_1, indent=0]
----
endif::mp-flavor[]
...
[source,java]
----
include::{sourcedir}/includes/guides/lc4j/memory/PirateMemoryProvider.java[tag=snippet_1, indent=0]
----
...
[source,java]
----
include::{sourcedir}/includes/guides/lc4j/memory/PirateService.java[tag=snippet_1, indent=0]
----
...
[source,java]
----
include::{sourcedir}/se/guides/lc4j/memory/Resource.java[tag=imports, indent=0]

include::{sourcedir}/se/guides/lc4j/memory/Resource.java[tag=method, indent=0]
----
endif::se-flavor[]
ifdef::mp-flavor[]
[source,java]
----
include::{sourcedir}/mp/guides/lc4j/memory/PirateResource.java[tag=snippet_1, indent=0]
----
endif::mp-flavor[]
