...
[source,java]
----
include::{sourcedir}/includes/integrations/lc4j/guide/base/PirateService.java[tag=snippet_1, indent=0]
----
...
[source,java]
----
include::{sourcedir}/se/integrations/lc4j/guide/base/Resource.java[tag=imports, indent=0]

include::{sourcedir}/se/integrations/lc4j/guide/base/Resource.java[tag=method, indent=0]
----
...
[source,java]
----
include::{sourcedir}/mp/integrations/lc4j/guide/base/PirateResource.java[tag=snippet_1, indent=0]
----
...
[source,java]
----
include::{sourcedir}/includes/integrations/lc4j/guide/template/PirateService.java[tag=snippet_1, indent=0]
----
...
[source,java]
----
include::{sourcedir}/se/integrations/lc4j/guide/template/Resource.java[tag=imports, indent=0]

include::{sourcedir}/se/integrations/lc4j/guide/template/Resource.java[tag=method, indent=0]
----
endif::se-flavor[]
ifdef::mp-flavor[]
[source,java]
----
include::{sourcedir}/mp/integrations/lc4j/guide/template/PirateResource.java[tag=snippet_1, indent=0]
----
endif::mp-flavor[]
...
[source,java]
----
include::{sourcedir}/includes/integrations/lc4j/guide/memory/PirateMemoryProvider.java[tag=snippet_1, indent=0]
----
...
[source,java]
----
include::{sourcedir}/includes/integrations/lc4j/guide/memory/PirateService.java[tag=snippet_1, indent=0]
----
...
[source,java]
----
include::{sourcedir}/se/integrations/lc4j/guide/memory/Resource.java[tag=imports, indent=0]

include::{sourcedir}/se/integrations/lc4j/guide/memory/Resource.java[tag=method, indent=0]
----
endif::se-flavor[]
ifdef::mp-flavor[]
[source,java]
----
include::{sourcedir}/mp/integrations/lc4j/guide/memory/PirateResource.java[tag=snippet_1, indent=0]
----
endif::mp-flavor[]
