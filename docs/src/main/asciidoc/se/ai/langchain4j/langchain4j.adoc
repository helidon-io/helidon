...
* xref:oci-genai.adoc[*OCI GenAI*]
    ** xref:oci-genai.adoc#_ocigenaichatmodel[`OciGenAiChatModel`]
    ** xref:oci-genai.adoc#_ocigenaistreamingchatmodel[`OciGenAiStreamingChatModel`]
    ** xref:oci-genai.adoc#_ocigenaicoherechatmodel[`OciGenAiCohereChatModel`]
    ** xref:oci-genai.adoc#_ocigenaicoherestreamingchatmodel[`OciGenAiCohereStreamingChatModel`]
...
* xref:gemini.adoc[*Google Gemini*]
    ** xref:gemini.adoc#_googleaigeminichatmodel[`GoogleAiGeminiChatModel`]
    ** xref:jlama.adoc#_googleaigeministreamingchatmodel[`GoogleAiGeminiStreamingChatModel`]
* xref:codegen-provider.adoc[*LangChain4j Model Provider Generator*]
* xref:mock.adoc[*LangChain4j Mock ChatModel*]
