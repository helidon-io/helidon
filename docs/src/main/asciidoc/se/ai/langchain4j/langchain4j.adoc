...
| LangChain4j in-process models                    | `langchain4j`                     | Local https://docs.langchain4j.dev/integrations/embedding-models/in-process[in-process models]
...
Both AI Services and Agens can be configured with following Helidon annotations:
