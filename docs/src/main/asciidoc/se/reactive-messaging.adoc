...
----
include::{sourcedir}/se/MessagingSnippets.java[tag=snippet_1, indent=0]
----
...
----
include::{sourcedir}/se/MessagingSnippets.java[tag=snippet_2, indent=0]
----
...
----
include::{sourcedir}/se/MessagingSnippets.java[tag=snippet_3, indent=0]
----
...
----
include::{sourcedir}/se/MessagingSnippets.java[tag=snippet_4, indent=0]
----

[source,java]
.Example consuming from connector:
----
include::{sourcedir}/se/MessagingSnippets.java[tag=snippet_5, indent=0]
----
...
----
include::{sourcedir}/se/MessagingSnippets.java[tag=snippet_6, indent=0]
----
...
----
include::{sourcedir}/se/MessagingSnippets.java[tag=snippet_7, indent=0]
----
...
.Example consuming from connector:
----
include::{sourcedir}/se/MessagingSnippets.java[tag=snippet_8, indent=0]
----
...
----
include::{sourcedir}/se/MessagingSnippets.java[tag=snippet_9, indent=0]
----
...
----
include::{sourcedir}/se/MessagingSnippets.java[tag=snippet_10, indent=0]
----
<1> Prepare a channel for connecting kafka connector with specific publisher configuration -> listener
<2> Channel -> connector mapping is automatic when using KafkaConnector.configBuilder()
<3> Prepare Kafka connector, can be used by any channel
...
.Example of consuming from Kafka:
----
include::{sourcedir}/se/MessagingSnippets.java[tag=snippet_11, indent=0]
----
...
.Example of producing to Kafka:
----
include::{sourcedir}/se/MessagingSnippets.java[tag=snippet_12, indent=0]
----
<1> Prepare Kafka connector, can be used by any channel
...
----
include::{sourcedir}/se/MessagingSnippets.java[tag=snippet_13, indent=0]
----
...
----
include::{sourcedir}/se/MessagingSnippets.java[tag=snippet_14, indent=0]
----
<1> Prepare a channel for connecting jms connector with specific publisher configuration -> listener
<2> Channel -> connector mapping is automatic when using JmsConnector.configBuilder()
<3> Prepare JMS connector, can be used by any channel
...
.Example of consuming from JMS:
----
include::{sourcedir}/se/MessagingSnippets.java[tag=snippet_15, indent=0]
----
...
.Example of producing to JMS:
----
include::{sourcedir}/se/MessagingSnippets.java[tag=snippet_16, indent=0]
----
<1> Prepare JMS connector, can be used by any channel
...
----
include::{sourcedir}/se/MessagingSnippets.java[tag=snippet_17, indent=0]
----
