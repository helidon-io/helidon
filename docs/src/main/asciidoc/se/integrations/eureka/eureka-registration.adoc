...
Please consult the xref:{rootdir}/config/io_helidon_integrations_eureka_EurekaRegistrationServerFeature.adoc[Helidon Config
...
Users of this feature may also be interested in the (related) xref:{rootdir}/se/discovery.adoc[Discovery feature],
particularly its xref:{rootdir}/se/discovery.adoc#_eureka[Eureka provider].