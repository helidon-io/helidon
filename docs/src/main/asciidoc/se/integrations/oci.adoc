...
NOTE: If you are interested in our MP based support of OCI than this xref:{rootdir}/mp/guides/oci-guide.adoc[Guide for Helidon MP application on OCI], describes the basics of developing and deploying a Helidon MP application based on our link:https://helidon.io/starter/{helidon-version}[Project Starter].
