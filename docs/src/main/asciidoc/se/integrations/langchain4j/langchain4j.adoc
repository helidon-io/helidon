...
Helidon provides `MetricsChatModelListener` which generates metrics that follow the https://opentelemetr.io/docs/specs/semconv/gen-ai/gen-ai-metrics[Semantic Conventions for GenAI Metrics]. This is done out-of-box for Chat API calls.
