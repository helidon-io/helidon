...
[source,java]
----
include::{sourcedir}/se/MetricsSnippets.java[tag=snippet_1, indent=0]
----
...
The example code in the <<_examples,Examples>> section below illustrates how to register, retrieve, and update meters.
...
[source,java]
----
include::{sourcedir}/se/MetricsSnippets.java[tag=snippet_2, indent=0]

include::{sourcedir}/se/MetricsSnippets.java[tag=snippet_3, indent=0]
----
...
[source,java]
----
include::{sourcedir}/se/MetricsSnippets.java[tag=snippet_4, indent=0]

include::{sourcedir}/se/MetricsSnippets.java[tag=snippet_5, indent=0]
----
