...
- link:{javadoc-base-url}/io.helidon.graphql/io/helidon/graphql/GraphQl.Argument.html[`io.helidon.graphql.GraphQl.Argument`] - GraphQL argument name
...
- link:{javadoc-base-url}/io.helidon.graphql/io/helidon/graphql/GraphQl.Ignore.html[`io.helidon.graphql.GraphQl.Ignore`] - exclude a Java member from SDL
