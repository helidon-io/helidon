...
- link:{validation-javadoc-base-url}/io/helidon/validation/Check.NotNull.html[`io.helidon.validation.Check.NotNull`] - must not be null
- link:{validation-javadoc-base-url}/io/helidon/validation/Check.Null.html[`io.helidon.validation.Check.Null`] - must be null

Constraints for `String` and `CharSequence`:

- link:{validation-javadoc-base-url}/io/helidon/validation/Check.String.Email.html[`io.helidon.validation.Check.Email`] - matches an e-mail structure (basic check only)
- link:{validation-javadoc-base-url}/io/helidon/validation/Check.String.NotBlank.html[`io.helidon.validation.Check.String.NotBlank`] - must not be blank (empty or only white-space characters)
- link:{validation-javadoc-base-url}/io/helidon/validation/Check.String.NotEmpty.html[`io.helidon.validation.Check.String.NotEmpty`] - must not be empty (i.e. length is `0`)
- link:{validation-javadoc-base-url}/io/helidon/validation/Check.String.Length.html[`io.helidon.validation.Check.String.Length`] - check for maximal (and optionally minimal) length
- link:{validation-javadoc-base-url}/io/helidon/validation/Check.String.Pattern.html[`io.helidon.validation.Check.String.Pattern`] - check against a regular expression
...
- link:{validation-javadoc-base-url}/io/helidon/validation/Check.Number.Negative.html[`io.helidon.validation.Check.Number.Negative`] - the value must be negative (`< 0`)
- link:{validation-javadoc-base-url}/io/helidon/validation/Check.Number.NegativeOrZero.html[`io.helidon.validation.Check.Number.NegativeOrZero`] - the value must be negative or zero (`&lt;= 0`)
- link:{validation-javadoc-base-url}/io/helidon/validation/Check.Number.Positive.html[`io.helidon.validation.Check.Number.Positive`] - the value must be positive (`> 0`)
- link:{validation-javadoc-base-url}/io/helidon/validation/Check.Number.PositiveOrZero.html[`io.helidon.validation.Check.Number.PositiveOrZero`] - the value must be positive or zero (`>= 0`)
- link:{validation-javadoc-base-url}/io/helidon/validation/Check.Number.Min.html[`io.helidon.validation.Check.Number.Min`] - the value must be at least the specified minimal value (`>= min`), value is defined as a `String`
- link:{validation-javadoc-base-url}/io/helidon/validation/Check.Number.Max.html[`io.helidon.validation.Check.Number.Max`] - the value must be at most the specified maximal value (`&lt;= max`), value is defined as a `String`
- link:{validation-javadoc-base-url}/io/helidon/validation/Check.Number.Digits.html[`io.helidon.validation.Check.Number.Digits`] - the number must have at most the specified number of integer and fractional digits
...
- link:{validation-javadoc-base-url}/io/helidon/validation/Check.Integer.Min.html[`io.helidon.validation.Check.Integer.Min`] - the value must be at least the specified minimal value (`>= min`)
- link:{validation-javadoc-base-url}/io/helidon/validation/Check.Integer.Max.html[`io.helidon.validation.Check.Integer.Max`] - the value must be at most the specified maximal value (`&lt;= max`)

Constraints for `Long` and `long` data types. No other type is supported:

- link:{validation-javadoc-base-url}/io/helidon/validation/Check.Long.Min.html[`io.helidon.validation.Check.Long.Min`] - the value must be at least the specified minimal value (`>= min`)
- link:{validation-javadoc-base-url}/io/helidon/validation/Check.Long.Max.html[`io.helidon.validation.Check.Long.Max`] - the value must be at most the specified maximal value (`&lt;= max`)

Constraints for `Boolean` and `boolean` data type. No other type is supported:

- link:{validation-javadoc-base-url}/io/helidon/validation/Check.Boolean.True.html[`io.helidon.validation.Check.Boolean.True`] - the value must be `true`
- link:{validation-javadoc-base-url}/io/helidon/validation/Check.Boolean.False.html[`io.helidon.validation.Check.Boolean.False`] - the value must be `false`

Constraints for collection and map data types:

- link:{validation-javadoc-base-url}/io/helidon/validation/Check.Collection.Size.html[`io.helidon.validation.Check.Collection.Size`] - the size of the collection or map must be between the minimal and maximal sizes
...
- link:{validation-javadoc-base-url}/io/helidon/validation/Check.Calendar.Future.html[`io.helidon.validation.Check.Calendar.Future`] - the value must be in the future
- link:{validation-javadoc-base-url}/io/helidon/validation/Check.Calendar.FutureOrPresent.html[`io.helidon.validation.Check.Calendar.FutureOrPresent`] - the value must be in the future or now
- link:{validation-javadoc-base-url}/io/helidon/validation/Check.Calendar.Past.html[`io.helidon.validation.Check.Calendar.Past`] - the value must be in the past
- link:{validation-javadoc-base-url}/io/helidon/validation/Check.Calendar.PastOrPresent.html[`io.helidon.validation.Check.Calendar.PastOrPresent`] - the value must be in the past or now
...
`@Check.Valid` - if such an annotation is present, and it is on a field of another validated type, or it is a parameter,
...
----
include::{sourcedir}/se/inject/DeclarativeExample.java[tag=snippet_6, indent=0]
----
