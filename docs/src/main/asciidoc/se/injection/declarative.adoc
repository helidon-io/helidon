...
- link:{metrics-javadoc-base-url}/io/helidon/metrics/api/Metric.Counted.html[`io.helidon.metrics.api.Metric.Counted`] - adds a counter metric to the metric registry for method executions
- link:{metrics-javadoc-base-url}/io/helidon/metrics/api/Metric.Timed.html[`io.helidon.metrics.api.Metric.Timed`] - adds a timer metric to the metric registry for method executions
- link:{metrics-javadoc-base-url}/io/helidon/metrics/api/Metric.Gauge.html[`io.helidon.metrics.api.Metric.Gauge`] - marks a method that returns a number as a gauge

[source,java]
.Example of a counted method
----
