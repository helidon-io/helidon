...
express parts of the config tree as complex types (`Collection`, `Map`, and
...
to a Java `Collection` or `Map`. The link:{config-javadoc-base-url}/io/helidon/config/Config.html[JavaDoc]
