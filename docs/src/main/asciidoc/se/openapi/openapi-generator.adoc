...
[source,java]
----
include::{addPetOpCustom}[tag=classDecl]
----
...
----
include::{petServiceImpl}[tag=createAddPetOp]
----
...
----
include::{exampleClient}[tags=classDecl;initDecl;defaultApiClient;initEnd;classEnd]
----
...
----
include::{exampleClient}[tags=classDecl;initDecl;apiClientWithObjMapper;initEnd;classEnd]
----
...
----
include::{exampleClient}[tags=classDecl;initDecl;apiClientWithAdjustedBuilder;initEnd;classEnd]
----
...
----
include::{exampleClient}[tags=classDecl;initDecl;apiClientWithCustomWebClientBuilder;initEnd;classEnd]
----
<1> Stores a reusable `AppClient`.
...
----
include::{exampleClient}[tags=classDeclFull;prepPetApi;classEnd]
----
<1> Stores a reusable `AppClient`.
...
----
include::{exampleClient}[tags=findAvailableDecl;findAvailableSimple;findAvailableUseResult;findAvailableEnd]
----
