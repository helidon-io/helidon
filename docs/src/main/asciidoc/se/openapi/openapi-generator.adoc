...
:petServiceImpl: {sourcedir}/se/openapi/gen/server/api/PetServiceImplCustom.java
:addPetOpCustom: {sourcedir}/se/openapi/gen/server/api/AddPetOpCustom.java
:exampleClient: {sourcedir}/se/openapi/gen/client/ExampleClient.java
...
----
include::{petServiceImpl}/[tags=class-header;handleAddPetDecl;handleAddPetGenerated;handleAddPetEnd, indent=0]
}
----
...
----
include::{petServiceImpl}/[tags=class-header;handleAddPetDecl;addedFields;handleAddPetCustom;handleAddPetEnd, indent=0]
}
----
...
----
include::{petServiceImpl}/[tags=class-header;addedFields;handleFindPetsByTagsDecl;handleFindPetsByTagsCustom;handleFindPetsByTagsEnd, indent=0]
}
----
...
[source,java]
----
include::{addPetOpCustom}[tag=classDecl, indent=0]
----
...
[source,java]
----
include::{addPetOpCustom}[tag=petMethod, indent=0]
----
...
----
include::{petServiceImpl}[tag=createAddPetOp, indent=0]
----
...
----
include::{exampleClient}[tags=classDecl;initDecl;defaultApiClient;initEnd;classEnd, indent=0]
----
...
----
include::{exampleClient}[tags=classDecl;initDecl;apiClientWithObjMapper;initEnd;classEnd, indent=0]
----
...
----
include::{exampleClient}[tags=classDecl;initDecl;apiClientWithAdjustedBuilder;initEnd;classEnd, indent=0]
----
...
----
include::{exampleClient}[tags=classDecl;initDecl;apiClientWithCustomWebClientBuilder;initEnd;classEnd, indent=0]
----
<1> Stores a reusable `AppClient`.
...
----
include::{exampleClient}[tags=classDeclFull;prepPetApi;classEnd, indent=0]
----
<1> Stores a reusable `AppClient`.
...
----
include::{exampleClient}[tags=findAvailableDecl;findAvailableSimple;findAvailableUseResult;findAvailableEnd, indent=0]
----
...
.Access with status checking
----
include::{exampleClient}[tags=findAvailableDecl;findAvailableSimple;findAvailableResponseCheck;findAvailableEnd, indent=0]
----
