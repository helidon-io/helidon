...
----
include::{snippets}/[tags=PetServiceImplCustomclass-header;PetServiceImplCustomhandleAddPetDecl;PetServiceImplCustomhandleAddPetGenerated;PetServiceImplCustomhandleAddPetEnd;PetServiceImplCustomclass-end, indent=0]
...
----
include::{snippets}/[tags=PetServiceImplCustomclass-header;PetServiceImplCustomhandleAddPetDecl;PetServiceImplCustomaddedFields;PetServiceImplCustomhandleAddPetCustom;PetServiceImplCustomhandleAddPetEnd;PetServiceImplCustomclass-end, indent=0]
----
