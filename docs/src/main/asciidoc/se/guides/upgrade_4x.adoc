...
In prior versions, the `RequestPredicate` class was used to specify more routing criteria. This class has been removed from Helidon 4. The following example shows the `RoutingHandlerResource`:


[source, java]
.Helidon SE 4.x - RequestPredicate removed
----
