...
For Helidon MP, use `io.helidon.integrations.oci:helidon-integrations-oci` only for OCI authentication, region,
and configuration support, and treat the legacy `io.helidon.integrations.oci.sdk:helidon-integrations-oci-sdk-cdi`
