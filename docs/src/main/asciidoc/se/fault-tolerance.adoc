...
Helidon Fault Tolerance support is inspired by well-established fault-tolerance patterns for retries, timeouts, circuit breakers, fallbacks, and bulkheads.
