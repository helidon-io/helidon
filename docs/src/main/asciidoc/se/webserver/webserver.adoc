...
|*<<JSON-P Support, JSON-P>>*|JsonpSupport|`io.helidon.http.media:helidon-http-media-jsonp`|`JsonObject, JsonArray`
|*<<JSON-B Support, JSON-B>>*|JsonbSupport|`io.helidon.http.media:helidon-http-media-jsonb`|Any *
|*<<Jackson Support, Jackson>>*|JacksonSupport|`io.helidon.http.media:helidon-http-media-jackson`|Any *
|*<<Gson Support, Gson>>*|GsonSupport|`io.helidon.http.media:helidon-http-media-gson`|Any *
|===
...
==== Configuration
It is possible to configure the Jsonb instance via programmatic or configuration-based approach.
When configured over the configuration, all the configured value types need to be selected correctly according
to the JSON-B spec and placed to the right section.

include::{rootdir}/config/io_helidon_http_media_jsonb_JsonbSupport.adoc[leveloffset=+3,tag=config]
...
=== Gson Support
The WebServer supports
https://github.com/google/gson#gson[Gson].
When this support is enabled, Java objects will be serialized to and
...
include::{rootdir}/config/io_helidon_http_media_gson_GsonSupport.adoc[leveloffset=+3,tag=config]
...
objects instead of raw JSON.  Deserialization from and serialization
to JSON will be handled by
link:++https://github.com/google/gson#gson[Gson].
