...
----
include::{sourcedir}/se/SecuritySnippets.java[tag=snippet_2, indent=0]
----
...
----
include::{sourcedir}/se/SecuritySnippets.java[tag=snippet_3, indent=0]
----
...
----
include::{sourcedir}/se/SecuritySnippets.java[tag=snippet_4, indent=0]
----
...
----
include::{sourcedir}/se/SecuritySnippets.java[tag=snippet_5, indent=0]
----
<1> Uses io.helidon.Config
<2> Or reverse order
