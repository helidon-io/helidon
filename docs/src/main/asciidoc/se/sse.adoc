...
[source,java]
----
include::{sourcedir}/se/SseSnippets.java[tag=snippet_1, indent=0]
----
...
API supports integration with media type providers, so the event data may actually be of any
...
[source,java]
----
include::{sourcedir}/se/SseSnippets.java[tag=snippet_2, indent=0]
----
...
[source,java]
----
include::{sourcedir}/se/SseSnippets.java[tag=snippet_3, indent=0]
----
...
[source,java]
----
include::{sourcedir}/se/SseSnippets.java[tag=snippet_4, indent=0]
----
...
[source,java]
----
include::{sourcedir}/se/SseSnippets.java[tag=snippet_5, indent=0]
----

=== Integration with Media Types

The Client API is also integrated with media type support. The data received as part of an
...
[source,java]
----
include::{sourcedir}/se/SseSnippets.java[tag=snippet_6, indent=0]
----
