...
:description: Configuration of io.helidon.integrations.oci.ConfigStrategyConfig
...
= ConfigStrategyConfig (integrations.oci) Configuration

// tag::config[]


Type: link:{javadoc-base-url}/io.helidon.integrations.oci/io/helidon/integrations/oci/ConfigStrategyConfig.html[io.helidon.integrations.oci.ConfigStrategyConfig]
