...
Helidon SE offers robust built-in and automatic support of OpenTelemetry that is
...
those two options: obtain the global `OpenTelemetry` instance and then use it to
create and update spans and metrics. In this option your code must use the
`GlobalOpenTelemetry` type; Helidon cannot provide the global instance via
injection or Helidon services look-up.
...
If you use a parent POM other than the Helidon SE application parent, include
