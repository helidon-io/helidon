...
xref:introduction.adoc#introducing-the-config-system[config introduction].
...
See the xref:advanced-configuration.adoc[advanced topics] page for further
...
The config system includes several built-in parsers, such as for the Java properties, YAML, JSON, and HOCON formats. See xref:introduction.adoc#built-in-formats[this section in the introduction] for
