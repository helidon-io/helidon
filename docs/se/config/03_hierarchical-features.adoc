...
defined within the link:{config-javadoc-base-url}/spi/ConfigNode.html[`ConfigNode`] interface.
...
xref:08_supported-formats.adoc#Config-ModuleHocon[extension module].
...
link:{config-javadoc-base-url}/Config.html#name--[`name`],
 link:{config-javadoc-base-url}/Config.html#key--[`key`], and
 link:{config-javadoc-base-url}/Config.html#type--[`type`] of the
 node.
...
| `as` | Returns the `ConfigValue` with the correct type that has all methods of `Optional`
    and a few additional ones - see link:{config-javadoc-base-url}/ConfigValue.html[`ConfigValue`] interface.
|===
...
For example, the xref:01_introduction.adoc#create-simple-config-props[`application.properties`]
...
link:{config-javadoc-base-url}/Config.html#detach--[`Config.detach`] method it gets back
