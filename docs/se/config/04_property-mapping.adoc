...
xref:01_introduction.adoc#built-in-formats[`application.properties`] configuration
...
xref:01_introduction.adoc#built-in-formats[`application.properties`]
...
Use the link:{config-javadoc-base-url}/Value.html[`Value`] annotation to control some of the JavaBean processing for a
given property.
