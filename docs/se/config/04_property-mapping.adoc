...
The link:{config-javadoc-base-url}/Config.html[`Config`] class itself provides many
...
many of your application's needs. The link:{config-javadoc-base-url}/ConfigMappers.html[`ConfigMappers`] class
...
xref:01_introduction.adoc#app-properties[`application.properties`] configuration
...
The xref:03_hierarchical-features.adoc[hierarchical features] section describes
...
to a Java `List` or `Map`. The link:{config-javadoc-base-url}/Config.html[JavaDoc]
...
the link:{config-javadoc-base-url}/package-summary.html#conversions[`io.helidon.config`
package JavaDoc].
...
xref:01_introduction.adoc#create-simple-config-props[`application.properties`]
...
Use the link:{config-javadoc-base-url}/Value.html[`Value`] annnotation to control some of the JavaBean processing for a
given property.
...
link:{config-javadoc-base-url}/Config.Transient.html[`Config.Transient`].
