...
as configuration. See the xref:config-sources.adoc[config sources] section
...
As the link:config-sources.adoc[config sources and parsers] section describes,
...
This section is now available in xref:config-profiles.adoc[config profiles],
...
The xref:introduction.adoc[introduction] section shows how to use
...
only if the classpath includes the corresponding parsers. The introduction section on xref:introduction.adoc#built-in-formats[built-in formats]
...
This section is now available in xref:config-profiles.adoc#Config-Profile-Format[config profile format]
