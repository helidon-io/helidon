...
link:{config-javadoc-base-url}/internal/FileConfigSource.FileBuilder.html[`FileConfigSource.FileBuilder`].)
...
|`regular`
| Periodic polling - See link:{config-javadoc-base-url}/PollingStrategies.html#regular-java.time.Duration-[`PollingStrategies.regular`] method
...
|`file`
| Filesystem monitoring - See link:{config-javadoc-base-url}/PollingStrategies.html#watch-java.nio.file.Path-[`PollingStrategies.watch`] method
...
|`repeat`
|Regularly-scheduled - see link:{config-javadoc-base-url}RetryPolicies.html#repeat-int-[`RetryPolicies.repeat`].
...
See link:{config-javadoc-base-url}/spi/RetryPolicy.html[`RetryPolicy`],
link:{config-javadoc-base-url}/spi/RetryPolicy.html[`ChangeWatcher`], and
link:{config-javadoc-base-url}/spi/PollingStrategy.html[`PollingStrategy`] JavaDoc
sections.