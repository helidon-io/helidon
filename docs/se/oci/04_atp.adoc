...
For complete code, about how to create DBClient using wallet info, please see link:{helidon-tree-url}/examples/integrations/oci/atp-reactive[ATP Reactive Example]