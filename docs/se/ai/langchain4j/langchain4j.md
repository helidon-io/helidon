...
1. The qualifier value must match the agent name from `@Ai.Agent("cli-expert")`.
   This is the declarative style: `CliCoordinator` is a Helidon declarative bean
   and the named agent is injected by the service registry.
<!--@mdc :: -->
<!--@mdc ::code-callout -->
```java
...
[jlama]: jlama.md
[jlama-2]: https://github.com/tjake/Jlama
