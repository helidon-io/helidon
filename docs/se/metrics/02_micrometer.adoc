...
. Register an instance of link:{micrometer-javadoc-base-url}/MicrometerSupport.html[`MicrometerSupport`] with the web server.
...
* Using the link:{micrometer-javadoc-base-url}/MicrometerSupport.Builder.html[`MicrometerSupport.Builder`] class
* Using configuration
...
<2> Provide the function that checks if the link:{webserver-javadoc-base-url}/ServerRequest.html[`ServerRequest`]
...
and returns the appropriate `Optional<link:{webserver-javadoc-base-url}/Handler.html[``Handler``]>`.
