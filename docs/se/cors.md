...
shared across origins. Helidon SE includes an implementation of CORS that you
...
You can use configuration instead of or in combination with the Helidon CORS SE
...
For a complete example, see [Helidon SE CORS Example][helidon-se-cors].
