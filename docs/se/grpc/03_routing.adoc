...
xref:06_health_checks.adoc[health checks] and xref:07_metrics.adoc[metrics] to them:
...
`GrpcRouting` also allows you to specify xref:05_interceptors.adoc[custom interceptors]
