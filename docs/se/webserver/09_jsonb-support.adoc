...
link:{media-jsonb-javadoc-base-url}/JsonbSupport.html[`JsonbSupport`] instance with a
link:{webserver-javadoc-base-url}/WebServer.Builder.html[`WebServer.Builder`].
...
to JSON will be handled according to the link:{jakarta-jsonb-spec-url}[JSON-B specification].
...
link:{webserver-javadoc-base-url}/Routing.Builder.html#post-java.lang.String-io.helidon.webserver.Handler...-[`Routing.Builder#post(String, Handler...)` method]
<2> Use the
link:{webserver-javadoc-base-url}/Handler.html#create-java.lang.Class-io.helidon.webserver.Handler.EntityHandler-[`Handler#create(Class, Handler.EntityHandler)` method]
