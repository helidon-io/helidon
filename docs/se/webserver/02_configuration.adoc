...
|`requested-uri-discovery.trusted-proxies` |link:{javadoc-base-url-api}/AllowList.html[`AllowList`] |{nbsp} |Assigns the settings governing the acceptance and rejection of forwarded headers from incoming requests to this socket.
