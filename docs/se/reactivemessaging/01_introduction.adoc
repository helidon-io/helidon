...
xref:../../mp/reactivemessaging/01_introduction.adoc[MicroProfile Reactive Messaging].
...
by Messaging API, or configured implicitly for using registered xref:03_connector.adoc[connector]
...
xref:../../mp/reactivemessaging/02_message.adoc[message wrapping] as MicroProfile messaging.
...
To make xref:03_connector.adoc[creation and usage of connectors]
as easy and versatile as possible, Helidon SE Messaging uses same API for connectors
like xref:../../mp/reactivemessaging/01_introduction.adoc[MicroProfile Reactive Messaging] does.
 ...
 * xref:04_kafka.adoc[Kafka connector]
 * xref:05_jms.adoc[JMS connector]
