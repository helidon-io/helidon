...
by config following notation of link:{microprofile-reactive-messaging-spec-url}#_configuration[MicroProfile Reactive Messaging].
...
Supplied xref:../config/introduction.adoc[Helidon Config] is merged with
...
==== Implicit Config
Implicit config without any hard-coding is possible with xref:../config/introduction.adoc[Helidon Config] following
 notation of link:{microprofile-reactive-messaging-spec-url}#_configuration[MicroProfile Reactive Messaging].
...
As the API is the same for xref:../../mp/reactivemessaging/introduction.adoc[MicroProfile Reactive Messaging] connectors, all that is needed to make connector work in both ways is annotating it with
...
xref:../../mp/reactivemessaging/introduction.adoc#Connector[Messaging Connector Bean].
