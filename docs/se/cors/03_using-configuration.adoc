...
* Learn how to combine the API and configuration to streamline your application code and add
a valuable feature, all described in the <<se/cors/03_using-configuration.adoc,Using Configuration>> documentation.
