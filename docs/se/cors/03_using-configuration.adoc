...
you need to make to your application to incorporate CORS functionality. By using configuration in combination
with the API, you can reduce the amount of change needed in your application.
...
== About the CORS Configuration Formats [[cors-configuration-formats]]
...
To use basic or mapped CORS configuration, you add logic to your application to load sections of configuration
