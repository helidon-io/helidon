...
The browser app uses the URL to retrieve, directly from your application, the OpenAPI document
which describes the application's endpoints.
The browser app then displays a user interface you use to "drive" your application:
