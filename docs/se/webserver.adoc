...
include::{rootdir}/includes/config/io.helidon.webserver.WebServer.adoc[]
...
Helidon supports Http/2 upgrade from Http/1 and Http/2 without prior knowledge.
...
include::{rootdir}/includes/config/io.helidon.webserver.WebServerTls.adoc[]
