...
include::{rootdir}/config/io_helidon_reactive_webserver_WebServer.adoc[leveloffset=+2,tag=config]
...
Use the `io.helidon.reactive.webserver.staticcontent.StaticContentSupport` class to serve files and classpath resources.
...
link:{media-jsonb-javadoc-base-url}/io/helidon/reactive/media/jsonb/JsonbSupport.html[`JsonbSupport`] instance with a
link:{webserver-javadoc-base-url}/io/helidon/reactive/webserver/WebServer.Builder.html[`WebServer.Builder`].
...
link:{webserver-javadoc-base-url}/io/helidon/reactive/webserver/Routing.Builder.html#post-java.lang.String-io.helidon.reactive.webserver.Handler...-[`Routing.Builder#post(String, Handler...)` method]
<2> Use the
link:{webserver-javadoc-base-url}/io/helidon/reactive/webserver/Handler.html#create-java.lang.Class-io.helidon.reactive.webserver.Handler.EntityHandler-[`Handler#create(Class, Handler.EntityHandler)` method]
...
link:{media-jackson-javadoc-base-url}/io/helidon/reactive/media/jackson/JacksonSupport.html[`JacksonSupport`]
instance with a
link:{webserver-javadoc-base-url}/io/helidon/reactive/webserver/WebServer.Builder.html[`WebServer.Builder`].
...
include::{rootdir}/config/io_helidon_reactive_webserver_WebServerTls.adoc[leveloffset=+2,tag=config]
