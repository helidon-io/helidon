...
----
Exception in thread "main" io.helidon.config.ConfigException: Cannot load cipherText from mandatory source FileConfig[missing-file]. File `missing-file` not found.
----
...
----
<1> Will use `meta-config.yaml` by default
