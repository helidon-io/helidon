...
The library service does not yet exist, but you'll create it in the next step of the guide. It has a constructor with the DB Client as a parameter because it will manage the library. The DB Client health check uses the `select-book` statement
