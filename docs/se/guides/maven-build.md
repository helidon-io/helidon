...
Helidon examples and projects generated using the [Helidon Quickstart](../../se/guides/quickstart.md) use a Helidon application POM as their parent. This parent POM provides the following:
...
If you want to use your own parent POM, then take a look at the [standalone quickstart example][standalone-quick]. This example has a standalone POM that you can pattern your own application POM after.

For more details on Helidon application POMs see the [Helidon’s Application POMS][helidon-s-applic]
...
2.  native-image: Build a [GraalVM native image](../../se/guides/graalnative.md). Note: this capability is now provided via the [Maven plugin for GraalVM Native Image][maven-plugin-for]

For full documentation of the plugin please see the [Helidon Maven Plugin README][helidon-maven-pl].
