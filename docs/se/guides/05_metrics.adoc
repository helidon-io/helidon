...
----
<1> Create a link:{metrics-javadoc-base-url}/MetricsSettings.html[`MetricsSettings]` instance (via its link:{metrics-javadoc-base-url}/MetricsSettings.Builder.html[`Builder`]) with the metrics subsystem disabled.
<2> Get a link:{metrics-serviceapi-javadoc-base-url}/MetricsSupport.html[`MetricsSupport]` service (usable in setting routing rules) that responds
to the `/metrics` endpoint with `404` and an explanatory message.
<3> Get a link:{metrics-javadoc-base-url}/RegistryFactory.html[`RegistryFactory]` instance that provides `MetricRegistry` instances which register
...
----
<1> Create a link:{metrics-javadoc-base-url}/ComponentMetricsSettings.html[`ComponentMetricsSettings]` instance (via its link:{metrics-javadoc-base-url}/ComponentMetricsSettings.Builder.html[`Builder`]) indicating that metrics usage should be disabled.
...
* link:{metrics-javadoc-base-url}/RegistryFilterSettings.html[`RegistryFilterSettings`]
* link:{metrics-javadoc-base-url}/RegistrySettings.html[`RegistrySettings`]
* link:{metrics-javadoc-base-url}/MetricsSettings.html[`MetricsSettings`]

and using the resulting `MetricsSettings` to retrieve a suitable link:{metrics-javadoc-base-url}/RegistryFactory.html[`RegistryFactory`].
[source,java]
...
...
    ...
    MetricsSettings metricsSettings = MetricsSettings.builder()
            ...
            .build(); // <2>
----
<1> Create a link:{metrics-javadoc-base-url}/KeyPerformanceIndicatorMetricsSettings.html[`KeyPerformanceIndicatorMetricsSettings]` instance (via its link:{metrics-javadoc-base-url}/KeyPerformanceIndicatorMetricsSettings.Builder.html[`Builder`]) with non-default values.
<2> Create a link:{metrics-javadoc-base-url}/MetricsSettings.html[`MetricsSettings]` instance reflecting the KPI settings.
