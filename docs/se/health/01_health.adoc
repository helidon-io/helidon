...
|deadlock detection
|`deadlock`
| link:{health-javadoc-base-url}/DeadlockHealthCheck.html[`DeadlockHealthCheck`]
| n/a
| n/a

|available disk space
|`diskSpace`
| link:{health-javadoc-base-url}/DiskSpaceHealthCheck.html[`DiskSpaceHealthCheck`]
...
| `heapMemory`
| link:{health-javadoc-base-url}/HeapMemoryHealthCheck.html[`HeapMemoryHealthCheck`]
