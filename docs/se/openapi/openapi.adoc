...
On the other hand, to control the behavior of the OpenAPI feature programmatically you can add and configure the OpenAPI feature explicitly as explained below.
