...
Helidon SE app by providing OpenAPI information about the endpoints without using annotations.

Helidon SE includes a link:{helidon-github-tree-url}/examples/openapi[complete OpenAPI example]
...
include::{rootdir}/includes/openapi/openapi-common.adoc[common-config]
