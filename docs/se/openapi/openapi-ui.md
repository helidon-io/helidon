...
Example OpenAPI UI Screen: ![openapi ui screen capture greeting se
start](../../images/openapi-ui-screen-capture-greeting-se-start.png)
...
Example OpenAPI UI Screen: ![openapi ui screen capture greeting se
expanded](../../images/openapi-ui-screen-capture-greeting-se-expanded.png)
