...
1. Put these in your `pom.xml` or gradle.build file: Annotation processor dependency/path:
...
2. Write your application using w/ standard jakarta.inject.* and jakarta.annotation.* types. Again, see any of the examples for pointers as needed.
