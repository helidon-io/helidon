...
:keywords: helidon, java, microservices, fluent builder, virtual threads
...
Configuration can be achieved through Pico Config-Driven Services. This add-on is based on Helidon's configuration subsystem, and adds support for  _config-driven services_ using the `@ConfiguredBy` annotation. 
...
NOTE: You can use Pico Config-Driven Services in combination with the Helidon configuration subsystem. 
