...
<2> Provide the function that checks if the link:{webserver-javadoc-base-url}/io/helidon/reactive/webserver/ServerRequest.html[`ServerRequest`]
...
and returns the appropriate `Optional<link:{webserver-javadoc-base-url}/io/helidon/reactive/webserver/Handler.html[``Handler``]>`.
