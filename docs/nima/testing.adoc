...
|`@ServerTest`
|
|The client that allows sending of anything, to test bad requests and such.
...
You can create the following test if we want to test our server to return the correct response.
