...
<dependencies>
    <dependency>
        <groupId>io.helidon.reactive.dbclient</groupId>       <!--1-->
        <artifactId>helidon-reactive-dbclient</artifactId>
    </dependency>
    <dependency>
        <groupId>io.helidon.reactive.dbclient</groupId>      <!--2-->
    ...
    <dependency>
        <groupId>io.helidon.reactive.dbclient</groupId>      <!--4-->
        <artifactId>helidon-reactive-dbclient-health</artifactId>
    </dependency>
    <dependency>
        <groupId>io.helidon.reactive.dbclient</groupId>      <!--5-->
        <artifactId>helidon-reactive-dbclient-metrics</artifactId>
    </dependency>
    <dependency>
        <groupId>io.helidon.reactive.dbclient</groupId>      <!--6-->
...
----
import io.helidon.reactive.dbclient.metrics.DbClientMetrics; // <1>
...
As the LibraryService implements `io.helidon.reactive.webserver.Service`, the `update(Routing)` method has to be implemented.
