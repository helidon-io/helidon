...
= Helidon Nima Quickstart
:description: Helidon Nima Quickstart Guide
:keywords: helidon
:rootdir: {docdir}/../..

include::{rootdir}/includes/nima.adoc[]

TO DO FOR NIMA - OLD SE VERSION for reference. This guide describes a basic example of an Helidon Nima application using Docker and Kubernetes.
...
xref:../../about/cli.adoc[Try it now].
