...
|`propagation` |xref:{rootdir}/config/io_helidon_tracing_providers_jaeger_JaegerTracerBuilder_PropagationFormat.adoc[PropagationFormat[&#93;] |`JAEGER` |Add propagation format to use.
