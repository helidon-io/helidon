...
<td>Maximum number of rapid client resets within the check period and server-side resets over the connection lifetime before GOAWAY is sent, or <code>-1</code> to disable both reset-count checks; fixed internal bounds still apply to frames received after the server has locally reset a stream</td>
</tr>
<tr>
<td>
...
<td>
<code>Alt<wbr>SvcConfig</code>
</td>
<td>
</td>
<td>Explicit <code>Alt-<wbr>Svc</code> advertisement for responses handled by HTTP routing, excluding HTTP/2 subprotocol responses such as gRPC</td>
</tr>
</tbody>
</table>
