...
<td>Whether this tracer configuration should be treated as an application-wide ownership candidate when it is resolved from the Helidon service registry</td>
</tr>
<tr>
<td>
<code>global</code>
...
<td>Whether the OpenTelemetry instance created from this configuration should be published as the OpenTelemetry global; if an OpenTelemetry global already exists, Helidon leaves it unchanged and uses the existing global as the application OpenTelemetry instance</td>
</tr>
<tr>
<td>
