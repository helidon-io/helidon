# io.<wbr>helidon.<wbr>security.<wbr>providers.<wbr>Idcs<wbr>Role<wbr>Mapper<wbr>Config
...
- <a href="io.helidon.security.spi.SecurityProvider.md#idcs-role-mapper"><code>security.<wbr>providers.<wbr>idcs-<wbr>role-<wbr>mapper</code></a>
