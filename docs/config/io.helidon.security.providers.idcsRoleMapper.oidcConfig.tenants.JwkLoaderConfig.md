# io.<wbr>helidon.<wbr>security.<wbr>providers.<wbr>idcs<wbr>Role<wbr>Mapper.<wbr>oidc<wbr>Config.<wbr>tenants.<wbr>JwkLoader<wbr>Config

## Description

Configuration for security.providers.idcs-role-mapper.oidc-config.tenants.jwk-loader
...
- <a href="io.helidon.security.providers.oidc.common.TenantConfig.md#jwk-loader"><code>security.<wbr>providers.<wbr>idcs-<wbr>role-<wbr>mapper.<wbr>oidc-<wbr>config.<wbr>tenants.<wbr>jwk-<wbr>loader</code></a>
