...
:description: Configuration of io.helidon.reactive.media.common.MediaContext
:keywords: helidon, config, io.helidon.reactive.media.common.MediaContext
:basic-table-intro: The table below lists the configuration keys that configure io.helidon.reactive.media.common.MediaContext
...
Type: link:{javadoc-base-url}/io.helidon.reactive.media.common/io/helidon/reactive/media/common/MediaContext.html[io.helidon.reactive.media.common.MediaContext]
...
|`services` |spi.io.helidon.reactive.media.common.MediaSupportProvider[&#93; (service provider interface) |{nbsp} |Configures this Builder from the supplied Config.
 <table class="config">
