...
:description: Configuration of common.io.helidon.reactive.media.MediaContext
:keywords: helidon, config, common.io.helidon.reactive.media.MediaContext
:basic-table-intro: The table below lists the configuration keys that configure common.io.helidon.reactive.media.MediaContext
...
Type: link:{javadoc-base-url}/io.helidon.reactive.media.common/io/helidon/reactive/media/common/MediaContext.html[common.io.helidon.reactive.media.MediaContext]
...
|`services` |spi.common.io.helidon.reactive.media.MediaSupportProvider[&#93; (service provider interface) |{nbsp} |Configures this Builder from the supplied Config.
 <table class="config">
