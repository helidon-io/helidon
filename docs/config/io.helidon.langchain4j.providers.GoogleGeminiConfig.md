...
Merged configuration for langchain4j.providers.google-gemini
...
<td>Generated from <code>dev.<wbr>langchain4j.<wbr>model.<wbr>googleai.<wbr>Google<wbr>AiGemini<wbr>Chat<wbr>Model.<wbr>Google<wbr>AiGemini<wbr>Chat<wbr>Model<wbr>Builder#<wbr>maxRetries(<wbr>java.<wbr>lang.<wbr>Integer)</code></td>
</tr>
<tr>
<td>
...
<td>Generated from <code>dev.<wbr>langchain4j.<wbr>model.<wbr>googleai.<wbr>Google<wbr>AiGemini<wbr>Chat<wbr>Model.<wbr>Google<wbr>AiGemini<wbr>Chat<wbr>Model<wbr>Builder#<wbr>supported<wbr>Capabilities(<wbr>java.<wbr>util.<wbr>Set)</code></td>
</tr>
<tr>
<td>
