...
- [`server.media-context.media-supports.jsonb`](io.helidon.http.media.MediaSupport.md#jsonb)
- [`server.sockets.media-context.media-supports.jsonb`](io.helidon.http.media.MediaSupport.md#jsonb)
