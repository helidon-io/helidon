...
Type: link:{javadoc-base-url}/io.helidon.servicecommon.rest/io.helidon.servicecommon.rest.RestServiceSettings[io.helidon.servicecommon.rest.RestServiceSettings]
