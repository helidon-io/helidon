...
:basic-table-intro: The table below lists the configuration keys that configure io.helidon.servicecommon.rest.RestServiceSettings
include::{rootdir}/includes/attributes.adoc[]

= RestServiceSettings (servicecommon.rest) Configuration

// tag::config[]


Type: link:{javadoc-base-url}/io.helidon.servicecommon.rest/io/helidon/servicecommon/rest/RestServiceSettings.html[io.helidon.servicecommon.rest.RestServiceSettings]
