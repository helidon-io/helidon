# io.<wbr>helidon.<wbr>security.<wbr>providers.<wbr>oidc.<wbr>tenants.<wbr>JwkLoader<wbr>Config

## Description

Configuration for security.providers.oidc.tenants.jwk-loader
...
- <a href="io.helidon.security.providers.oidc.common.TenantConfig.md#jwk-loader"><code>security.<wbr>providers.<wbr>oidc.<wbr>tenants.<wbr>jwk-<wbr>loader</code></a>
