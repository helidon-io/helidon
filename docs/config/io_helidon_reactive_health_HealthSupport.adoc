...
:description: Configuration of io.helidon.reactive.health.HealthSupport
:keywords: helidon, config, io.helidon.reactive.health.HealthSupport
:basic-table-intro: The table below lists the configuration keys that configure io.helidon.reactive.health.HealthSupport
...
Type: link:{javadoc-base-url}/io.helidon.health/io/helidon/reactive/health/HealthSupport.html[io.helidon.health.HealthSupport]
