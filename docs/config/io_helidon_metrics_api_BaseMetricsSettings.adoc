...
= BaseMetricsSettings (metrics.api) Configuration

// tag::config[]


Type: link:{javadoc-base-url}/io.helidon.metrics.api/io/helidon/metrics/api/BaseMetricsSettings.html[io.helidon.metrics.api.BaseMetricsSettings]
