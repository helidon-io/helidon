...
:description: Configuration of io.helidon.reactive.webserver.SocketConfiguration.SocketConfigurationBuilder
:keywords: helidon, config, io.helidon.reactive.webserver.SocketConfiguration.SocketConfigurationBuilder
...
Type: link:{javadoc-base-url}/io.helidon.reactive.webserver.SocketConfiguration/io/helidon/reactive/webserver/SocketConfiguration/SocketConfigurationBuilder.html[io.helidon.reactive.webserver.SocketConfiguration.SocketConfigurationBuilder]
