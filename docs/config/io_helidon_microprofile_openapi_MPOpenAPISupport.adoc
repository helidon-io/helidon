...
:description: Configuration of io.helidon.microprofile.openapi.MpOpenApiFeature
:keywords: helidon, config, io.helidon.microprofile.openapi.MpOpenApiFeature
:basic-table-intro: The table below lists the configuration keys that configure io.helidon.microprofile.openapi.MpOpenApiFeature
...
Type: link:{javadoc-base-url}/io.helidon.microprofile.openapi/io/helidon/microprofile/openapi/MPOpenAPISupport.html[io.helidon.microprofile.openapi.MpOpenApiFeature]
