...
|`mp.lra.coordinator.allowed-uri` |string[] |{nbsp} |Additional coordinator URLs whose LRA ids should be trusted, such as direct coordinator nodes behind a load balancer.
