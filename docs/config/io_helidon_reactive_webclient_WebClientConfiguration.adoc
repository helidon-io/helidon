...
:description: Configuration of io.helidon.reactive.webclient.WebClientConfiguration
:keywords: helidon, config, io.helidon.reactive.webclient.WebClientConfiguration
:basic-table-intro: The table below lists the configuration keys that configure io.helidon.reactive.webclient.WebClientConfiguration
...
Type: link:{javadoc-base-url}/io.helidon.reactive.webclient/io/helidon/reactive/webclient/WebClientConfiguration.html[io.helidon.reactive.webclient.WebClientConfiguration]
...
|`media-support` |xref:{rootdir}/config/io_helidon_reactive_media_common_MediaContext.adoc[MediaContext] |{nbsp} |
|`proxy` |xref:{rootdir}/config/io_helidon_reactive_webclient_Proxy.adoc[Proxy] |{nbsp} |Sets new request proxy.
...
|`tls` |xref:{rootdir}/config/io_helidon_reactive_webclient_WebClientTls.adoc[WebClientTls] |{nbsp} |New TLS configuration.
