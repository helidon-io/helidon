...
|`connect-timeout-millis` |long |`1 minute` |Sets new connection timeout of the request.
...
|`read-timeout-millis` |long |`10 minutes` |Sets new read timeout of the response.
