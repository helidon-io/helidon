...
Type: link:{javadoc-base-url}/io.helidon.security.providers.httpauth/io.helidon.security.providers.httpauth.HttpBasicAuthProvider[io.helidon.security.providers.httpauth.HttpBasicAuthProvider]
