...
Type: link:{javadoc-base-url}/io.helidon.servicecommon.rest/io.helidon.servicecommon.rest.HelidonRestServiceSupport[io.helidon.servicecommon.rest.HelidonRestServiceSupport]
