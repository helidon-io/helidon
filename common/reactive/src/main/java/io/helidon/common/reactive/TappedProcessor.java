 ...
 */
public class TappedProcessor<R> extends BufferedProcessor<R, R> implements Multi<R> {
     ...
     *
     * @param <R> Type of the processed items.
     * @return Brand new {@link io.helidon.common.reactive.TappedProcessor}
     */
    public static <R> TappedProcessor<R> create() {
     ...
     * @return This {@link io.helidon.common.reactive.TappedProcessor}
     */
    public TappedProcessor<R> onNext(Function<R, R> function) {
     ...
     * @return This {@link io.helidon.common.reactive.TappedProcessor}
     */
    public TappedProcessor<R> onError(Consumer<Throwable> consumer) {
     ...
     * @return This {@link io.helidon.common.reactive.TappedProcessor}
     */
    public TappedProcessor<R> onComplete(Runnable runnable) {
     ...
     * @return This {@link io.helidon.common.reactive.TappedProcessor}
     */
    public TappedProcessor<R> onCancel(Consumer<Flow.Subscription> consumer) {
