...
public final class TypeNames {
     ...
     */
    public static TypeName LIST = TypeName.create(List.class);
    /**
     * Type name for {@link java.util.Map}.
     */
    public static TypeName MAP = TypeName.create(Map.class);
    /**
     * Type name for {@link java.util.Set}.
     */
    public static TypeName SET = TypeName.create(Set.class);
    /**
     * Type name for {@link java.util.Optional}.
     */
    public static TypeName OPTIONAL = TypeName.create(Optional.class);
}
