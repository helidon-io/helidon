...
public interface HttpTransportObserver {
     ...
     *
     * <p>Duplicate observer instances are included only once. A failure from one observer is logged and does not
     * prevent the remaining observers from receiving the event.
     *
