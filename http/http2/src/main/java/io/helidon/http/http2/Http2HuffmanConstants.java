...
final class Http2HuffmanConstants {
    ...
    static final int HUFFMAN_EMIT_SYMBOL_SHIFT = HUFFMAN_EMIT_SYMBOL << 8;
    static final byte HUFFMAN_FAIL = 1 << 2;
    /**
     * A table of byte tuples (state, flags, output).   They are packed together as:
     * <p>
     * state<<16 + flags<<8 + output
     */
    static final int[] HUFFS = new int[] {
    ...
    static final int HUFFMAN_FAIL_SHIFT = HUFFMAN_FAIL << 8;
