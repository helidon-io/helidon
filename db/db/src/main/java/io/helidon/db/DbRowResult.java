 ...
 *
 * @param <T> type of the result, starts as {@link io.helidon.db.DbRow}
 */
public interface DbRowResult<T> {
     ...
     *
     * <p>
     * The first mapping for row results of type {@link io.helidon.db.DbRow} will also try to locate
