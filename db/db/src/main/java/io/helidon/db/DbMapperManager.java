...
/**
 * Mapper manager of all configured {@link io.helidon.db.DbMapper mappers}.
 */
public interface DbMapperManager {
     ...
     *
     * @param serviceLoader service loader to use to read all {@link io.helidon.db.spi.DbMapperProvider}
     * @return mapper manager
     */
     ...
     * @see io.helidon.db.DbRow#as(Class)
     */
     ...
     * @return instance with data from the row
     * @throws MapperException in case the mapper was not found
     * @see io.helidon.db.DbRow#as(io.helidon.common.GenericType)
     */
     ...
     * @see io.helidon.db.DbStatement#namedParam(Object)
     */
