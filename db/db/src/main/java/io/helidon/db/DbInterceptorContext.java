 ...
 * <p>
 * This is a mutable object - acts as a builder during the invocation of {@link io.helidon.db.DbInterceptor}.
...
public interface DbInterceptorContext {
    ...
    /**
     * Type of this database (usually the same string used by the {@link io.helidon.db.spi.DbProvider#name()}).
     *
