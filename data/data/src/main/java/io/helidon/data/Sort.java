...
public interface Sort {
    ...
    static Sort create(List<Order> orders) {
        return new SortImpl(List.copyOf(orders));
    }

    /**
     * Create new instance of query result ordering with no order rules.
     *
     * @return new query result ordering instance
     */
    static Sort unsorted() {
        return new SortImpl(Collections.emptyList());
    }
