 ...
 */
package io.helidon.data.intercept.reactive;

import io.helidon.data.intercept.DataInterceptor;

/**
 * An interceptor that executes a {@code io.helidon.data.annotation.Query} and a {@code org.reactivestreams.Publisher} that
