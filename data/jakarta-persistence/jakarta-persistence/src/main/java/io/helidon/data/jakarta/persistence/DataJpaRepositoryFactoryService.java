...
class DataJpaRepositoryFactoryService implements RepositoryFactory {
    ...
    DataJpaRepositoryFactoryService(DataJpaSupport support) {
        this.support = support;
    }

    @Override
    public <E, T> T create(Function<E, T> creator) {
        RepositoryFactory repositoryFactory = support.repositoryFactory();
        return repositoryFactory.create(creator);
    }
}
