...
import static io.helidon.data.tests.common.TestUtils.POKEMONS_LIST;
...
public class TestQbmnProjection {
    ...
    public void testListFind() {
        ...
        assertThat(pokemons, Matchers.hasSize(POKEMONS_LIST.size()));
    }
    ...
    public void testStreamFind() {
        ...
        assertThat(pokemons.toList(), Matchers.hasSize(POKEMONS_LIST.size()));
    }
