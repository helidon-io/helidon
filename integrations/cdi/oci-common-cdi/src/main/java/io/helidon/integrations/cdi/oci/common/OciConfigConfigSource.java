...
public final class OciConfigConfigSource implements ConfigSource {
     ...
     *
     * <p>Overrides of this method must return the same value every
     * time they are invoked.</p>
     *
     ...
     * none other.</p>
     *
     * @return the ordinal of this {@link OciConfigConfigSource};
     * {@code 101} by default
     */
    @Override
     ...
     *
     * @return a value for the supplied {@code propertyName}, or
     * {@code null}
     */
    @Override
    ...
    /**
     * Returns a {@link Map} consisting of all property names and
     * their values that this {@link OciConfigConfigSource} knows
     * about at the time that this method is invoked.
     *
     * <p>This method never returns {@code null}.</p>
     *
     ...
     * empty}, is guaranteed to contain at least the following
     * keys:</p>
     *
     * <ul>
     *
     ...
     * guidance on whether the return value of an implementation of
     * the {@link ConfigSource#getProperties()} method should be
     * immutable and/or threadsafe.  This implementation returns an
     * {@linkplain Collections#unmodifiableMap(Map) immutable
     * <code>Map</code>}.</p>
     *
