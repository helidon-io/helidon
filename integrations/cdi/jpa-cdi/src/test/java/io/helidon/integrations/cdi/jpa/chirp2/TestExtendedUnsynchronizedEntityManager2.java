...
@DataSourceDefinition(
    ...
    url = "jdbc:h2:mem:TestExtendedUnsynchronizedEntityManager2;MODE=LEGACY;INIT=SET TRACE_LEVEL_FILE=4\\;RUNSCRIPT FROM 'classpath:chirp2.ddl'",
    serverName = "",
    properties = {
        "user=sa"
    }
)
class TestExtendedUnsynchronizedEntityManager2 {
    ...
    TestExtendedUnsynchronizedEntityManager2() {
        super();
    }
               ...
               SystemException
    {
        ...
        TestExtendedUnsynchronizedEntityManager2 self =
            this.cdiContainer.select(TestExtendedUnsynchronizedEntityManager2.class).get();
        ...
        // transaction.
        EntityManager em = self.getExtendedUnsynchronizedEntityManager();
        ...
        try {
            ...
            // The transaction is over, and our EntityManager is STILL
            // not joined to one.
            assertThat(em.isJoinedToTransaction(), is(false));
