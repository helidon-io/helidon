...
class DelegatingTypedQuery<X> implements TypedQuery<X> {
    ...
    @Override
    public TypedQuery<X> setParameter(Parameter<Calendar> parameter, Calendar value, TemporalType temporalType) {
        this.delegate.setParameter(parameter, value, temporalType);
        return this;
    }

    @Override
    public TypedQuery<X> setParameter(Parameter<Date> parameter, Date value, TemporalType temporalType) {
        this.delegate.setParameter(parameter, value, temporalType);
        return this;
    }
