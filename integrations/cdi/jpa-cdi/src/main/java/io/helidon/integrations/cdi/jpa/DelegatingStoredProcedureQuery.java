...
class DelegatingStoredProcedureQuery extends DelegatingQuery implements StoredProcedureQuery {
    ...
    public DelegatingStoredProcedureQuery registerStoredProcedureParameter(int position, Class type, ParameterMode mode) {
    ...
    @Override
    @SuppressWarnings("rawtypes")
    public DelegatingStoredProcedureQuery registerStoredProcedureParameter(String parameterName, Class type, ParameterMode mode) {
    ...
    @Override
    public DelegatingStoredProcedureQuery setHint(String hintName, Object value) {
        return (DelegatingStoredProcedureQuery) super.setHint(hintName, value);
    }

    @Override
    public <T> DelegatingStoredProcedureQuery setParameter(Parameter<T> parameter, T value) {
        return (DelegatingStoredProcedureQuery) super.setParameter(parameter, value);
    }

    @Override
    public DelegatingStoredProcedureQuery setParameter(Parameter<Calendar> parameter, Calendar value, TemporalType temporalType) {
        return (DelegatingStoredProcedureQuery) super.setParameter(parameter, value, temporalType);
    }

    @Override
    public DelegatingStoredProcedureQuery setParameter(Parameter<Date> parameter, Date value, TemporalType temporalType) {
        return (DelegatingStoredProcedureQuery) super.setParameter(parameter, value, temporalType);
    }

    @Override
    public DelegatingStoredProcedureQuery setParameter(int position, Object value) {
        return (DelegatingStoredProcedureQuery) super.setParameter(position, value);
    }

    @Override
    public DelegatingStoredProcedureQuery setParameter(int position, Calendar value, TemporalType temporalType) {
    ...
    @Override
    public DelegatingStoredProcedureQuery setParameter(String name, Object value) {
        return (DelegatingStoredProcedureQuery) super.setParameter(name, value);
    }

    @Override
    public DelegatingStoredProcedureQuery setParameter(String name, Calendar value, TemporalType temporalType) {
        return (DelegatingStoredProcedureQuery) super.setParameter(name, value, temporalType);
    }

    @Override
    public DelegatingStoredProcedureQuery setParameter(String name, Date value, TemporalType temporalType) {
        return (DelegatingStoredProcedureQuery) super.setParameter(name, value, temporalType);
    }
