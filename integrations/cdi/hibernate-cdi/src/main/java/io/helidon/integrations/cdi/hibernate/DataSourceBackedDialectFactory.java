...
public final class DataSourceBackedDialectFactory
     ...
     * <ul>
     *
     * <li>{@code settings.get(}{@link AvailableSettings#DIALECT DIALECT}{@code )} returns an object that is either {@code
     * null} or a {@linkplain String#isBlank() blank} {@link String}</li>
     *
     * <li>{@code settings.get(}{@link AvailableSettings#JAKARTA_JTA_DATASOURCE JAKARTA_JTA_DATASOURCE}{@code )} returns a
