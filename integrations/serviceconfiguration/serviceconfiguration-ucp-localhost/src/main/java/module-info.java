 ...
 */
module io.helidon.service.configuration.ucp.localhost {
    requires io.helidon.service.configuration.api;
    requires io.helidon.service.configuration.ucp;
    requires com.h2database;

    exports io.helidon.service.configuration.ucp.localhost;
}
