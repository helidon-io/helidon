...
/**
 * Provides classes and interfaces that implement the {@link
 ...
 */
module io.helidon.service.configuration.microprofile.config {
    requires io.helidon.service.configuration.api;
    requires microprofile.config.api;

    exports io.helidon.service.configuration.microprofile.config;
}
