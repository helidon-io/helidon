...
public class Kv1SecurityProvider implements SecretsProvider<Kv1SecurityProvider.Kv1SecretConfig> {
    ...
    public static class Kv1SecretConfig implements ProviderConfig {
        ...
        public static Kv1SecretConfig create(io.helidon.common.config.Config config) {
            return builder()
                    .config(config)
                    .build();
        }
         ...
         */
        public static class Builder implements io.helidon.common.Builder<Builder, Kv1SecretConfig> {
            private String path;
            private String key;
