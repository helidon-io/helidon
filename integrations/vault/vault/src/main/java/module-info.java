 ...
 * Vault integration.
 */
@Features.Name("HCP Vault")
@Features.Description("Vault integration")
...
module io.helidon.integrations.vault {
    ...
    uses io.helidon.integrations.vault.spi.SecretsEngineProvider;
    uses io.helidon.integrations.vault.spi.AuthMethodProvider;
    uses io.helidon.integrations.vault.spi.VaultAuth;
    uses io.helidon.integrations.vault.spi.SysProvider;
