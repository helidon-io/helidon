 ...
 */
public class EclipseStoreCacheConfigurationBuilder<K, V>
        implements CacheConfigurationPropertyNames,
        CacheConfiguration.Builder<K, V>,
        io.helidon.common.Builder<EclipseStoreCacheConfigurationBuilder<K, V>, CacheConfiguration<K, V>> {

    private final Builder<K, V> cacheConfigBuilder;

    protected EclipseStoreCacheConfigurationBuilder(Class<K> keyType, Class<V> valueType) {
        super();
        cacheConfigBuilder = CacheConfiguration.Builder(keyType, valueType);
    }

    protected EclipseStoreCacheConfigurationBuilder(Configuration configuration, Class<K> keyType, Class<V> valueType) {
        super();
     ...
     */
    public static <K, V> EclipseStoreCacheConfigurationBuilder<K, V> builder(Class<K> keyType, Class<V> valueType) {
     ...
     * @return a new CacheConfiguration builder
     */
    public static <K, V> EclipseStoreCacheConfigurationBuilder<K, V> builder(Config config, Class<K> keyType,
                                                                             Class<V> valueType) {
    ...
    @Override
    public EclipseStoreCacheConfigurationBuilder<K, V> readThrough(boolean readTrough) {
        cacheConfigBuilder.readThrough(readTrough);
        return this;
    }

    @Override
    public EclipseStoreCacheConfigurationBuilder<K, V> writeThrough(boolean writeThrough) {
        cacheConfigBuilder.writeThrough(writeThrough);
        return this;
    }

    @Override
    public EclipseStoreCacheConfigurationBuilder<K, V> storeByValue(boolean storeByValue) {
        cacheConfigBuilder.storeByValue(storeByValue);
        return this;
    }

    @Override
    public EclipseStoreCacheConfigurationBuilder<K, V> enableStatistics(boolean enableStatistics) {
        cacheConfigBuilder.enableStatistics(enableStatistics);
        return this;
    }

    @Override
    public EclipseStoreCacheConfigurationBuilder<K, V> enableManagement(boolean enableManagement) {
        cacheConfigBuilder.enableManagement(enableManagement);
        return this;
    }

    @Override
    public EclipseStoreCacheConfigurationBuilder<K, V> expiryPolicyFactory(Factory<ExpiryPolicy> expiryPolicyFactory) {
        cacheConfigBuilder.expiryPolicyFactory(expiryPolicyFactory);
        return this;
    }

    @Override
    public EclipseStoreCacheConfigurationBuilder<K, V> evictionManagerFactory(
    ...
    @Override
    public EclipseStoreCacheConfigurationBuilder<K, V> cacheLoaderFactory(
    ...
    @Override
    public EclipseStoreCacheConfigurationBuilder<K, V> cacheWriterFactory(
