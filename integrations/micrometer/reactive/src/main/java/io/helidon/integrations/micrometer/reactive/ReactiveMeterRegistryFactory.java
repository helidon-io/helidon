 ...
 * </p>
 */
public final class ReactiveMeterRegistryFactory {
    ...
    private static final Logger LOGGER = Logger.getLogger(ReactiveMeterRegistryFactory.class.getName());
     ...
     */
    public static class Builder implements io.helidon.common.Builder<Builder, ReactiveMeterRegistryFactory> {
        ...
        public Builder enrollBuiltInRegistry(BuiltInRegistryType builtInRegistryType) {
            ReactiveMicrometerPrometheusRegistrySupport builtInRegistrySupport =
                    ReactiveMicrometerPrometheusRegistrySupport.create(builtInRegistryType);
            builtInRegistriesRequested.put(builtInRegistryType, builtInRegistrySupport);
            return this;
        }
        ...
        private void enrollBuiltInRegistries(Config registriesConfig) {
            ...
            Map<BuiltInRegistryType, ReactiveMicrometerPrometheusRegistrySupport> candidateBuiltInRegistryTypes =
                    new HashMap<>();
                    ...
                    .ifPresent(confList -> {
                        for (Config registryConfig : confList) {
                            ...
                            try {
                                ...
                                ReactiveMicrometerPrometheusRegistrySupport builtInRegistrySupport =
                                        ReactiveMicrometerPrometheusRegistrySupport.create(type, registryConfig.asNode());
