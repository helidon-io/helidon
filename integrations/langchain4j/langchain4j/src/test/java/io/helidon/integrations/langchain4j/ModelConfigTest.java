...
public class ModelConfigTest {
                  ...
                  models:
                    foo-bar-model:
                      ...
                      array-prop-2:
                        ...
                        - test6
                """;
        var c = ConfigUtils.create(Config.create(ConfigSources.create(cfg, APPLICATION_YAML)),
                                   MODEL,
                                   "foo-bar-model");
    ...
    void testModelListing() {
        ...
        assertThat(ConfigUtils.modelNames(c, MODEL, "foo-bar-provider"), containsInAnyOrder("foo-bar-model", "bar-foo-model"));
    }
}
