...
import static io.helidon.integrations.langchain4j.ConfigUtils.Kind.EMBEDDING_STORE;
...
class CoherenceEmbeddingStorePropertiesTest {
    ...
    void testDefaultRoot(Config c) {
        var config = CoherenceEmbeddingStoreConfig.create(ConfigUtils.create(c, EMBEDDING_STORE, "test-embedding-store"));
