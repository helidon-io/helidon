...
class LanguageModelConfigTest {

    @Test
    void testDefaultRoot() {
        var config = OllamaLanguageModelConfig.create(Config.just(ConfigSources.classpath("application.yaml"))
                .get(OllamaLanguageModelConfig.CONFIG_ROOT));
