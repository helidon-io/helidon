...
/**
 * Configuration class for the Ollama chat model, {@link dev.langchain4j.model.ollama.OllamaChatModel}.
 *
 * @see dev.langchain4j.model.ollama.OllamaChatModel
 */
@Prototype.Configured(OllamaChatModelConfigBlueprint.CONFIG_ROOT)
@Prototype.Blueprint
interface OllamaChatModelConfigBlueprint extends OllamaCommonConfig {
    /**
     * Default configuration prefix.
     */
    String CONFIG_ROOT = "langchain4j.ollama.chat-model";
