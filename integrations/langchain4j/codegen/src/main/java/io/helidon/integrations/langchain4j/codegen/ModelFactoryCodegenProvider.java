...
import static io.helidon.integrations.langchain4j.codegen.LangchainTypes.MODEL_CUSTOM_FACTORIES;
...
public class ModelFactoryCodegenProvider implements CodegenExtensionProvider {
    ...
    static final Set<TypeName> SUPPORTED_ANNOTATIONS = Set.of(MODEL_CONFIG_TYPE, MODEL_CONFIGS_TYPE, MODEL_CUSTOM_FACTORIES);
    ...
    public CodegenExtension create(CodegenContext ctx, TypeName generator) {
        return new ModelFactoryCodegen();
    }
}
