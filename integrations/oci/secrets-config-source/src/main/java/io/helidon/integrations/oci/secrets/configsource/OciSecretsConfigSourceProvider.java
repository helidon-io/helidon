 ...
 * file</a>). Authentication with OCI is accomplished via the {@code helidon-integrations-oci} module;
 * please see its documentation.</li>
 *
 * <li>Ensure there is a classpath resource, or a file present named {@code meta-config.yaml}.</li>
 *
 * <li>Ensure the {@code meta-config.yaml} contains a {@code sources} element with a {@code type} of
