...
package io.helidon.integrations.oci.sdk.tests.test.module1;
...
class AServiceUsingObjectStorage {
    ...
    private final Supplier<ObjectStorage> standbyObjStorageClientProvider;

    @Service.Inject
    AServiceUsingObjectStorage(ObjectStorage objStorage,
                               @Service.Named("StandbyProfile") Supplier<ObjectStorage> standbyObjStorageProvider) {
