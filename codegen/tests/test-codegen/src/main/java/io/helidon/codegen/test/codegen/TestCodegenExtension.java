...
class TestCodegenExtension implements CodegenExtension {
    ...
    private Annotation annotation() {
        return Annotation.builder()
                ...
                .property("longValue", 49L)
                .property("doubleValue", 49.0D)
                .property("intValue", 49)
                .property("byteValue", (byte) 49)
                .property("charValue", 'x')
                .property("shortValue", (short) 49)
                .property("floatValue", 49.0F)
                .property("classValue", String.class)
                .property("typeValue", TypeName.create(String.class))
                .property("enumValue", ElementType.FIELD)
                .property("annotationValue", targetAnnotation(ElementType.CONSTRUCTOR))
                ...
                .property("lclass", List.of(String.class, Integer.class))
                .property("ltype",
                ...
                .property("lannotation", List.of(targetAnnotation(ElementType.CONSTRUCTOR),
                                                 targetAnnotation(ElementType.FIELD)))
                .property("emptyList", List.of())
                .property("singletonList", List.of("value"))
                .build();
    }
