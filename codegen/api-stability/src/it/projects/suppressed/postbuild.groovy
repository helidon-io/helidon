...
import io.helidon.codegen.api.stability.ApiStabilityProcessorProjectsIT
...
try {
    ...
    def results = EngineTestKit.engine("junit-jupiter")
            .selectors(selectMethod(ApiStabilityProcessorProjectsIT.class, "suppressedBuildSucceeds"))
            .execute()
