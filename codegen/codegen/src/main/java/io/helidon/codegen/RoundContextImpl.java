...
class RoundContextImpl implements RoundContext {
    ...
    /**
     * Uses the declared name of a generated top level class when the processing
     * environment supplies only an unresolved simple name.
     * <p>
     * Source may refer to a class generated by an earlier extension before javac
     * compiles that class. In this case, {@link #generatedClass(TypeName)} can find
     * the registered class model by searching generated packages, but the requested
     * name still has no package. The matched {@link ClassModel} contains the
     * authoritative declared name used to create {@link TypeInfo}. Qualified and
     * nested requested names are preserved.
     *
