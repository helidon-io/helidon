...
public interface DirectJunitExtension extends HelidonJunitExtension {
     ...
     * {@link io.helidon.nima.testing.junit5.webserver.SetUpRoute} static methods.
     *
     * @param <T> type of the parameter (such as {@link io.helidon.nima.webserver.http.HttpRouting.Builder}
     */
