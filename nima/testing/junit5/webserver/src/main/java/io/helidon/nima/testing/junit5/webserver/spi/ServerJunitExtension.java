...
public interface ServerJunitExtension extends HelidonJunitExtension {
    ...
    /**
     * Called for sockets defined by {@link io.helidon.nima.testing.junit5.webserver.SetUpRoute}.
     *
     ...
     *
     * @param type type of the parameter to {@link io.helidon.nima.testing.junit5.webserver.SetUpRoute} method
    ...
    /**
     * Handler of server test parameters of methods annotated with {@link io.helidon.nima.testing.junit5.webserver.SetUpRoute}.
     *
     * @param <T>
     */
