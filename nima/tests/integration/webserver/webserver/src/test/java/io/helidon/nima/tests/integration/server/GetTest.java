...
class GetTest {
    ...
    private static final HeaderValue REQUEST_HEADER_VALUE = Http.HeaderNames.create(REQUEST_HEADER_NAME, REQUEST_HEADER_VALUE_STRING);
    ...
    public static final HeaderValue CONTENT_LENGTH_5 = Http.HeaderNames.create(CONTENT_LENGTH, "5");
