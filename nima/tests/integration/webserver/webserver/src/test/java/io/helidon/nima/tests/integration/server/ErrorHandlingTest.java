...
class ErrorHandlingTest {
    ...
    private static final Http.Header FIRST = Http.HeaderNames.create(CONTROL_HEADER, "first");
    private static final Http.Header SECOND = Http.HeaderNames.create(CONTROL_HEADER, "second");
    private static final Http.Header ROUTING = Http.HeaderNames.create(CONTROL_HEADER, "routing");
    private static final Http.Header CUSTOM = Http.HeaderNames.create(CONTROL_HEADER, "custom");
