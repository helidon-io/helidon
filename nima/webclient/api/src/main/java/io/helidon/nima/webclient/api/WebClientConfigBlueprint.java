...
interface WebClientConfigBlueprint extends HttpClientConfigBlueprint, Prototype.Factory<WebClient> {
    ...
    /**
     * List of HTTP protocols by order of preference. If left empty, all discovered providers will be used, ordered by
     * weight.
     * <p>
     ...
     *
     * @return list of HTTP protocols in order of preference
     */
    @Prototype.Singular
