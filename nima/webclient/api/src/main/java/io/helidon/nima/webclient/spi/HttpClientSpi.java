...
public interface HttpClientSpi {
     ...
     *     {@link io.helidon.nima.webclient.api.HttpClientRequest#protocolId(String)}</li>
     *     <li>There is no fallback protocol enabled, in such a case, we use the one with highest priority - see
     *     {@link io.helidon.nima.webclient.api.WebClientConfig.Builder#addProtocolPreference(String)}</li>
