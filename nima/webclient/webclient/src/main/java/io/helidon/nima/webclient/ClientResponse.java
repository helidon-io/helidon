...
public interface ClientResponse extends AutoCloseable {
    ...
    /**
     * Entity input stream.
     * This is a shortcut to {@link #entity()} and {@link io.helidon.nima.http.media.ReadableEntity#inputStream()}.
     *
     * @return input stream
     */
     ...
     * This is a shortcut to {@link #entity()} and {@link io.helidon.nima.http.media.ReadableEntity#as(Class)}.
     *
