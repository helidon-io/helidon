...
/**
 * A number of helper methods to handle sending responses to a {@link io.grpc.stub.StreamObserver}.
 */
public final class ResponseHelper {
    ...
    /**
     * Send the values from a {@link java.util.stream.Stream} to the {@link io.grpc.stub.StreamObserver#onNext(Object)} method
     * until the
    ...
    /**
     * Asynchronously send the values from a {@link java.util.stream.Stream} to the
     * {@link io.grpc.stub.StreamObserver#onNext(Object)} method until
    ...
    /**
     * Asynchronously send the values from a {@link java.util.stream.Stream} to the
     * {@link io.grpc.stub.StreamObserver#onNext(Object)} method
    ...
    /**
     * Obtain a {@link java.util.function.Consumer} that can be used to send values to the
     * {@link io.grpc.stub.StreamObserver#onNext(Object)} method until
     ...
     * @param <T>      they type of the request result
     * @return a {@link java.util.function.Consumer} that can be used to send values to the
     *         {@link io.grpc.stub.StreamObserver#onNext(Object)} method
     */
     ...
     * Obtain a {@link java.util.function.Consumer} that can be used to send values to the
     * {@link io.grpc.stub.StreamObserver#onNext(Object)} method until
     * the {@link java.util.concurrent.CompletionStage} completes then asynchronously call
     * {@link io.grpc.stub.StreamObserver#onCompleted()} using the
     ...
     * {@link io.grpc.stub.StreamObserver#onNext(Object)} method until
     * the {@link java.util.concurrent.CompletionStage} completes then asynchronously call
     * {@link io.grpc.stub.StreamObserver#onCompleted()} using the executor
     * thread.
     * <p>
     * If the {@link java.util.concurrent.CompletionStage} completes with an error then
     * {@link io.grpc.stub.StreamObserver#onError(Throwable)}
