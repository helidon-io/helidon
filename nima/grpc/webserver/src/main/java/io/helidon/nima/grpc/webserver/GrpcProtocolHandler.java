...
class GrpcProtocolHandler<REQ, RES> implements Http2SubProtocolSelector.SubProtocolHandler {
    ...
    private static final HeaderValue GRPC_CONTENT_TYPE = HeaderNames.createCached(HeaderNames.CONTENT_TYPE, "application/grpc");
    private static final HeaderValue GRPC_ENCODING_IDENTITY = HeaderNames.createCached("grpc-encoding", "identity");
