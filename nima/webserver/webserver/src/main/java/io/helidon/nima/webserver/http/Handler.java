...
public interface Handler extends ServerLifecycle {
    /**
     * Create a handler that only runs code and returns {@link io.helidon.common.http.Http.Status#OK_200}.
     *
    ...
    /**
     * Create a handler that consumes a {@link ServerRequest} and returns {@link io.helidon.common.http.Http.Status#OK_200}.
     *
    ...
    /**
     * Create a handler that consumes typed request entity and sends {@link io.helidon.common.http.Http.Status#OK_200}.
     *
