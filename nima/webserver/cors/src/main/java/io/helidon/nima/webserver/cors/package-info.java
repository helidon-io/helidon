...
/**
 * <h2>Helidon Níma CORS Support</h2>
 * <p>
 * Use {@link io.helidon.nima.webserver.cors.CorsSupport} and its {@link io.helidon.nima.webserver.cors.CorsSupport.Builder} to
 * add CORS
 * handling to resources in your application.
 * <p>
 * Because Níma does not use annotation processing to identify endpoints, you need to provide the CORS information for
 * your application another way. You can use Helidon configuration, the Níma CORS API, or a combination.
 * <h3>Configuration</h3>
 * <h4>Format</h4>
 ...
 * Although Níma prescribes the CORS config format, you can put it wherever you want in your application's configuration
 ...
 *
 * <h3>The Níma CORS API</h3>
 * You can define your application's CORS behavior programmatically -- together with configuration if you want -- by:
 * <ul>
 *     <li>creating a {@link io.helidon.nima.webserver.cors.CrossOriginConfig.Builder} instance,</li>
 ...
 * instance. Níma will process requests to the path you specify with those services in that order. Also, note that you have
