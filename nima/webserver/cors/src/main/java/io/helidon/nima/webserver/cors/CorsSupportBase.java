...
/**
 * A Helidon Níma service and handler implementation that implements CORS, for both the application and for built-in Níma
 ...
 *         it applies, and</li>
 *         <li>by setting individual CORS-related attributes on the {@link CorsSupportBase.Builder} (which
 *         affects the CORS behavior for the
 *         {@value Aggregator#PATHLESS_KEY} path).</li>
 *     </ul>
 * <p>
 *     See the {@link CorsSupportBase.Builder#build} method for how the builder resolves conflicts among
 *     these sources.
 * </p>
 * <p>
...
public abstract class CorsSupportBase<Q, R, T extends CorsSupportBase<Q, R, T, B>,
    ...
    /**
     * Update the base class from provided builder.
     *
    ...
    protected interface RequestAdapter<T> {
         ...
         *
         * @return authority of the request
         */
        String authority();
    ...
    protected interface ResponseAdapter<T> {
         ...
         * @return the adapter
         */
        ResponseAdapter<T> header(HeaderName key, String value);
         ...
         * @return the adapter
         */
        ResponseAdapter<T> header(HeaderName key, Object value);
    ...
    public abstract static class Builder<Q, R, T extends CorsSupportBase<Q, R, T, B>, B extends Builder<Q, R, T, B>>
        ...
        /**
         * Request default behavior if none defined.
         *
         * @return updated builder
         */
        ...
        private void reportUseOfMissingConfig(Config config) {
            if (!config.exists()) {
                LOGGER.log(Level.INFO,
                           String.format(
                                   "Attempt to load %s using empty config with key '%s'; continuing with default CORS "
                                           + "information",
