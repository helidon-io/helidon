...
import static io.helidon.nima.webserver.cors.Aggregator.PATHLESS_KEY;
...
public class CrossOriginConfig {
    ...
    /**
     * Path pattern, by default matches everything.
     *
    ...
    /**
     * Headers that can be exposed in response.
     *
    ...
    public static class Builder implements CorsSetter<Builder>, io.helidon.common.Builder<Builder, CrossOriginConfig> {
        ...
        public String toString() {
            return String.format("Builder{pathPattern=%s, enabled=%b, origins=%s, allowHeaders=%s, exposeHeaders=%s, "
                                         + "allowMethods=%s, allowCredentials=%b, maxAgeSeconds=%d",
                                 pathPattern,
                                 enabled,
                                 Arrays.toString(origins),
                                 Arrays.toString(allowHeaders),
                                 Arrays.toString(exposeHeaders),
                                 Arrays.toString(allowMethods),
                                 allowCredentials,
                                 maxAgeSeconds);
        }
