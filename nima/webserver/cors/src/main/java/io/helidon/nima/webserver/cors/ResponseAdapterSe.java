...
class ResponseAdapterSe implements CorsSupportBase.ResponseAdapter<ServerResponse> {
    ...
    @Override
    public CorsSupportBase.ResponseAdapter<ServerResponse> header(HeaderName key, String value) {
        serverResponse.header(key, value);
        return this;
    }

    @Override
    public CorsSupportBase.ResponseAdapter<ServerResponse> header(HeaderName key, Object value) {
