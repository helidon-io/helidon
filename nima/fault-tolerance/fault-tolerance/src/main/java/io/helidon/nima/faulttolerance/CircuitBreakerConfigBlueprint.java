...
@Prototype.Blueprint(decorator = CircuitBreakerConfigBlueprint.BuilderInterceptor.class)
...
interface CircuitBreakerConfigBlueprint extends Prototype.Factory<CircuitBreaker> {
    ...
    class BuilderInterceptor implements Prototype.BuilderDecorator<CircuitBreakerConfig.BuilderBase<?, ?>> {
        @Override
        public CircuitBreakerConfig.BuilderBase<?, ?> decorate(CircuitBreakerConfig.BuilderBase<?, ?> target) {
