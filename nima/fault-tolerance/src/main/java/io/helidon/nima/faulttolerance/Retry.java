...
public interface Retry extends FtHandler {
    ...
    /**
     * Fluent API builder for {@link io.helidon.nima.faulttolerance.Retry}.
     */
    class Builder implements io.helidon.common.Builder<Builder, Retry> {
         ...
         * Defaults to a {@link io.helidon.nima.faulttolerance.Retry.JitterRetryPolicy}
    ...
    class DelayingRetryPolicy implements RetryPolicy {
        ...
        /**
         * A builder to customize configuration of {@link io.helidon.nima.faulttolerance.Retry.DelayingRetryPolicy}.
         *
         * @return a new builder
         */
        ...
        /**
         * Fluent API builder for {@link io.helidon.nima.faulttolerance.Retry.DelayingRetryPolicy}.
         */
    ...
    class JitterRetryPolicy implements RetryPolicy {
        ...
        /**
         * A new fluent API builder to configure instances of {@link io.helidon.nima.faulttolerance.Retry}.
         *
         * @return a new builder
         */
        public static Builder builder() {
        ...
        /**
         * Fluent API builder for {@link io.helidon.nima.faulttolerance.Retry.JitterRetryPolicy}.
         */
    ...
    class FibonacciRetryPolicy implements RetryPolicy {
        ...
        /**
         * Fluent API builder for {@link io.helidon.nima.faulttolerance.Retry.FibonacciRetryPolicy}.
         */
    ...
    class ExponentialRetryPolicy implements RetryPolicy {
        ...
        /**
         * Fluent API builder for {@link io.helidon.nima.faulttolerance.Retry.ExponentialRetryPolicy}.
         */
