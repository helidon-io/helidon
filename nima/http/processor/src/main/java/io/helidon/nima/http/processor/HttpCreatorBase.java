...
class HttpCreatorBase {
    ...
    protected String className(TypeName base, String suffix) {
        return base.className().replace('.', '_') + "_"
                + suffix;
    }

    private record CacheRecord(TypeName annotationType, TypeName enclosingType, String methodName) {
    }
}
