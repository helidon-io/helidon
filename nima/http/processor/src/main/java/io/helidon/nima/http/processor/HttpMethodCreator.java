...
public class HttpMethodCreator extends HttpCreatorBase implements CustomAnnotationTemplateCreator {
    ...
    private void processParameter(HttpDef httpDef,
        ...
        for (Annotation annotation : annotations) {
            if (PARAM_ANNOTATIONS.contains(annotation.typeName().resolved())) {
        ...
        switch (httpAnnotation.typeName().resolved()) {
        ...
        default -> throw new IllegalStateException("Invalid annotation \"" + httpAnnotation.typeName().resolved()
