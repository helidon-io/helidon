...
class Http2ClientConnectionHandler {
    ...
    private static final Http.Header CONNECTION_UPGRADE_HEADER = Http.HeaderNames.createCached(Http.HeaderNames.CONNECTION,
                                                                                               "Upgrade, HTTP2-Settings");
    // h2c stands for HTTP/2 plaintext protocol (only used without TLS)
    private static final Http.Header UPGRADE_HEADER = Http.HeaderNames.createCached(Http.HeaderNames.UPGRADE, "h2c");
