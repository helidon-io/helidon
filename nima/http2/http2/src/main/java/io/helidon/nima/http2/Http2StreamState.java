...
public enum Http2StreamState {
     ...
     * <ul>
     *     <li>send {@link io.helidon.nima.http2.Http2FrameType#PUSH_PROMISE} -> {@link #RESERVED_LOCAL}</li>
     *     <li>recv {@link io.helidon.nima.http2.Http2FrameType#PUSH_PROMISE} -> {@link #RESERVED_REMOTE}</li>
     * </ul>
     */
    IDLE,
    /**
     ...
     * <ul>
     *     <li>{@link #IDLE} -> send {@link io.helidon.nima.http2.Http2FrameType#PUSH_PROMISE}</li>
     * </ul>
     * <p>
     * Transitions from this state:
     * <ul>
     *     <li>send {@link io.helidon.nima.http2.Http2FrameType#HEADERS} -> {@link #HALF_CLOSED_REMOTE}</li>
     *     <li>send {@link io.helidon.nima.http2.Http2FrameType#RST_STREAM} -> {@link #CLOSED}</li>
     *     <li>recv {@link io.helidon.nima.http2.Http2FrameType#RST_STREAM} -> {@link #CLOSED}</li>
     * </ul>
     */
    RESERVED_LOCAL,
    /**
     ...
     * Transitions to this state:
     * <ul>
     *     <li>{@link #IDLE} -> recv {@link io.helidon.nima.http2.Http2FrameType#PUSH_PROMISE}</li>
     * </ul>
     * <p>
     * Transitions from this state:
     * <ul>
     *     <li>recv {@link io.helidon.nima.http2.Http2FrameType#HEADERS} -> {@link #HALF_CLOSED_LOCAL}</li>
     *     <li>recv {@link io.helidon.nima.http2.Http2FrameType#RST_STREAM} -> {@link #CLOSED}</li>
     *     <li>send {@link io.helidon.nima.http2.Http2FrameType#RST_STREAM} -> {@link #CLOSED}</li>
     * </ul>
     */
     ...
     * Transitions to this state:
     * <ul>
     *     <li>{@link #IDLE} -> send {@link io.helidon.nima.http2.Http2FrameType#HEADERS}</li>
     *     <li>{@link #IDLE} -> recv {@link io.helidon.nima.http2.Http2FrameType#HEADERS}</li>
     * </ul>
     * <p>
     * Transitions from this state
     * (end of stream may be part of {@link io.helidon.nima.http2.Http2FrameType#HEADERS} or
     *  {@link io.helidon.nima.http2.Http2FrameType#DATA}):
     * <ul>
     *     <li>send {@link io.helidon.nima.http2.Http2Flag#END_OF_STREAM} -> {@link #HALF_CLOSED_LOCAL}</li>
     *     <li>recv {@link io.helidon.nima.http2.Http2Flag#END_OF_STREAM} -> {@link #HALF_CLOSED_REMOTE}</li>
     *     <li>send {@link io.helidon.nima.http2.Http2FrameType#RST_STREAM} -> {@link #CLOSED}</li>
     *     <li>recv {@link io.helidon.nima.http2.Http2FrameType#RST_STREAM} -> {@link #CLOSED}</li>
     * </ul>
     */
     ...
     * Transitions to this state:
     * <ul>
     *     <li>{@link #RESERVED_REMOTE} -> recv {@link io.helidon.nima.http2.Http2FrameType#HEADERS}</li>
     *     <li>{@link #OPEN} -> send {@link io.helidon.nima.http2.Http2Flag#END_OF_STREAM}</li>
     * </ul>
     * <p>
     * Transitions from this state:
     * <ul>
     *     <li>recv {@link io.helidon.nima.http2.Http2Flag#END_OF_STREAM} -> {@link #CLOSED}</li>
     *     <li>send {@link io.helidon.nima.http2.Http2FrameType#RST_STREAM} -> {@link #CLOSED}</li>
     *     <li>recv {@link io.helidon.nima.http2.Http2FrameType#RST_STREAM} -> {@link #CLOSED}</li>
     * </ul>
     */
     ...
     * Transitions to this state:
     * <ul>
     *     <li>{@link #RESERVED_LOCAL} -> send {@link io.helidon.nima.http2.Http2FrameType#HEADERS}</li>
     *     <li>{@link #OPEN} -> recv {@link io.helidon.nima.http2.Http2Flag#END_OF_STREAM}</li>
     * </ul>
     * <p>
     * Transitions from this state:
     * <ul>
     *     <li>send {@link io.helidon.nima.http2.Http2Flag#END_OF_STREAM} -> {@link #CLOSED}</li>
     *     <li>send {@link io.helidon.nima.http2.Http2FrameType#RST_STREAM} -> {@link #CLOSED}</li>
     *     <li>recv {@link io.helidon.nima.http2.Http2FrameType#RST_STREAM} -> {@link #CLOSED}</li>
     * </ul>
     */
     ...
     *     {@link io.helidon.nima.http2.Http2FrameType#RST_STREAM}</li>
