...
@GraphQlServer.Context("/secured-graphql")
class SecureGraphEndpoint {
    @GraphQl.Query
    String securedRequest(SecurityContext securityContext) {
        return "Secured request " + securityContext.userName();
    }
}
