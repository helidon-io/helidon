...
final class CorsTypes {
    ...
    static final TypeName CORS_ALLOWED_ORIGINS = TypeName.create("io.helidon.webserver.cors.Cors.AllowedOrigins");
    static final TypeName CORS_ALLOWED_METHODS = TypeName.create("io.helidon.webserver.cors.Cors.AllowedMethods");
    static final TypeName CORS_ALLOWED_HEADERS = TypeName.create("io.helidon.webserver.cors.Cors.AllowedHeaders");
