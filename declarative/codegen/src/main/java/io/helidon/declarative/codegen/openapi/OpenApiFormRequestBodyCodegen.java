...
final class OpenApiFormRequestBodyCodegen {
    ...
    void addRequestBody(Method.Builder method,
        ...
        boolean inferredRequired = formParameters.stream().anyMatch(requiredPredicate);
        validator.validateRequestBodyRequiredness(restMethodDescription,
                                                  inferredRequired,
                                                  requiredOverride,
                                                  "@Http.FormParam parameters");
        boolean required = requiredOverride.orElse(inferredRequired);
