 ...
 * services to handle declarative websocket client endpoints.
 */
...
public class WebSocketClientExtensionProvider implements RegistryCodegenExtensionProvider {
    ...
    public Set<TypeName> supportedAnnotations() {
        return Set.of(WebSocketClientTypes.ANNOTATION_ENDPOINT);
    }

    @Override
    public RegistryCodegenExtension create(RegistryCodegenContext codegenContext) {
        return new WebSocketClientExtension(codegenContext);
    }
}
