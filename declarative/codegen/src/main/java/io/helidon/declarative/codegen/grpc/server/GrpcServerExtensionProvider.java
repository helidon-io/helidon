 ...
 * services to handle declarative gRPC server endpoints.
 */
@Weight(Weighted.DEFAULT_WEIGHT - 30)
public class GrpcServerExtensionProvider implements RegistryCodegenExtensionProvider {

    /**
     * Required public constructor for {@link java.util.ServiceLoader}.
     */
    @Api.Internal
    public GrpcServerExtensionProvider() {
    }
    ...
    public RegistryCodegenExtension create(RegistryCodegenContext codegenContext) {
        return new GrpcServerExtension(codegenContext);
    }
}
