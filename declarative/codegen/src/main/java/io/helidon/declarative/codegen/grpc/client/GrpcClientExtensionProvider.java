 ...
 */
public class GrpcClientExtensionProvider implements RegistryCodegenExtensionProvider {
    /**
     * Default constructor required by {@link java.util.ServiceLoader}.
     */
    public GrpcClientExtensionProvider() {
    }
    ...
    public RegistryCodegenExtension create(RegistryCodegenContext ctx) {
        return new GrpcClientExtension(ctx);
    }
}
