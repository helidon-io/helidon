...
final class FtTypes {
    ...
    static final TypeName RETRY_GENERATED_METHOD =
            TypeName.create("io.helidon.faulttolerance.FtSupport.RetryMethod");
    ...
    static final TypeName CIRCUIT_BREAKER_GENERATED_METHOD =
            TypeName.create("io.helidon.faulttolerance.FtSupport.CircuitBreakerMethod");
    ...
    static final TypeName BULKHEAD_GENERATED_METHOD =
            TypeName.create("io.helidon.faulttolerance.FtSupport.BulkheadMethod");
    ...
    static final TypeName TIMEOUT_GENERATED_METHOD =
            TypeName.create("io.helidon.faulttolerance.FtSupport.TimeoutMethod");
    ...
    static final TypeName ASYNC_GENERATED_METHOD =
            TypeName.create("io.helidon.faulttolerance.FtSupport.AsyncMethod");
