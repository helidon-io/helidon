...
public abstract class AbstractParametersProvider {
     ...
     * @deprecated use {@link #codegenFromParameters(ParameterCodegenContext, TypeName, String, boolean, ParametersSource)}
     *             or {@link #codegenFromParameters(FieldHandler, ContentBuilder, TypeName, String, boolean, ParametersSource)}
     *             for mapper-aware and generic-type-aware generation; this legacy overload is retained only to preserve
     *             the pre-4.5.0 code shape for existing subclasses
     */
    ...
    protected void codegenFromParameters(ContentBuilder<?> contentBuilder,
        ...
        if (optional) {
            ...
            contentBuilder
                    ...
                    .addContent("\").");
            legacyAsMethod(contentBuilder, realType);
            ...
            legacyGetMethod(contentBuilder, realType);
            ...
            contentBuilder
                    ...
                    .increaseContentPadding()
                    .addContent(".");
            legacyAsMethod(contentBuilder, parameterType);
    ...
    private void legacyAsMethod(ContentBuilder<?> content, TypeName type) {
    ...
    private void legacyGetMethod(ContentBuilder<?> content, TypeName type) {
        TypeName boxed = type.boxed();
