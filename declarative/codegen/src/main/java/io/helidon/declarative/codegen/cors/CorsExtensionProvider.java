...
public class CorsExtensionProvider implements RegistryCodegenExtensionProvider {
    ...
    public Set<TypeName> supportedAnnotations() {
        return Set.of(CorsTypes.CORS_DEFAULTS,
                      CorsTypes.CORS_ALLOWED_ORIGINS,
                      CorsTypes.CORS_ALLOWED_METHODS,
                      CorsTypes.CORS_ALLOWED_HEADERS,
                      CorsTypes.CORS_EXPOSE_HEADERS,
                      CorsTypes.CORS_ALLOW_CREDENTIALS,
                      CorsTypes.CORS_MAX_AGE_SECONDS);
    }
