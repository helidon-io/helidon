 ...
 * services to handle declarative websocket server endpoint.
 */
...
public class WebSocketServerExtensionProvider implements RegistryCodegenExtensionProvider {
    ...
    public Set<TypeName> supportedAnnotations() {
        return Set.of(WebSocketServerTypes.ANNOTATION_ENDPOINT);
    }

    @Override
    public RegistryCodegenExtension create(RegistryCodegenContext codegenContext) {
        return new WebSocketExtension(codegenContext);
    }
}
