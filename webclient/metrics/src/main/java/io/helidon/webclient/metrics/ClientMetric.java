 ...
 */
abstract class ClientMetric implements ClientService {
    ...
    static Builder builder(ClientMetricType clientMetricType) {
    ...
    Metadata createMetadata(ClientServiceRequest request, ClientServiceResponse response) {
        String name;
        if (response == null) {
    ...
    String createName(ClientServiceRequest request, ClientServiceResponse response) {
        return String.format(nameFormat(), request.method().name(), request.uri().getHost(), response.status().code());
    }

    String createName(ClientServiceRequest request) {
     ...
     */
    public static final class Builder implements io.helidon.common.Builder<ClientMetric> {
        ...
        private Builder(ClientMetricType type) {
            this.type = type;
        }
