...
class Http1CrossOriginRedirectEntityTest {
    ...
    private static final String CROSS_ORIGIN_REDIRECT_PROPERTY_PREFIX =
            ClientRequestBase.class.getName() + ".redirect.cross-origin.";
    ...
    private record AuthorizationService() implements WebClientService {
        ...
        public WebClientServiceResponse handle(Chain chain, WebClientServiceRequest request) {
            assertThat(request.properties().keySet()
                               .stream()
                               .noneMatch(it -> it.startsWith(CROSS_ORIGIN_REDIRECT_PROPERTY_PREFIX)),
                       is(true));
