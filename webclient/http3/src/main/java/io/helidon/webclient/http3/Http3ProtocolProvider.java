...
class Http3ProtocolProvider
        implements ClientProtocolProviderCacheLifecycle<Http3Client, Http3ClientProtocolConfig> {
    static final String CONFIG_KEY = "h3";
    ...
    @Override
    public Http3Client protocol(WebClient client, Http3ClientProtocolConfig config) {
    ...
    @Override
    public boolean cacheReplacementReady(Http3Client client) {
        return ((Http3ClientImpl) client).isFullyClosed();
    }
}
