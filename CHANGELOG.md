...
- API stability annotations follow up (4.x) [11783](https://github.com/helidon-io/helidon/pull/11783)
- Builder method setValues adjusted [11777](https://github.com/helidon-io/helidon/pull/11777)
- Builder: Fix builder generic type variable handling (4.x) [11816](https://github.com/helidon-io/helidon/pull/11816)
- Builders: Apply container semantics to TypeHandlerOptional (4.x) [11970](https://github.com/helidon-io/helidon/pull/11970)
- Builders: Fix Configured config key Javadoc (4.x) [11959](https://github.com/helidon-io/helidon/pull/11959)
- Codegen: Fix codegen TypeName annotation handling (4.x) [11870](https://github.com/helidon-io/helidon/pull/11870)
- Codegen: Fix generic contract annotation merging (4.x) [11955](https://github.com/helidon-io/helidon/pull/11955)
- Codegen: Fix validated interface codegen switch (4.x) [11863](https://github.com/helidon-io/helidon/pull/11863)
- Common: Defensively copy TLS SSL parameters (4.x) [11890](https://github.com/helidon-io/helidon/pull/11890)
- Common: Fix BufferData lastIndexOf index handling (4.x) [11903](https://github.com/helidon-io/helidon/pull/11903)
- Common: Fix invalid feature flavor metadata (4.x) [11898](https://github.com/helidon-io/helidon/pull/11898)
- Common: Fix ListContext unregister identity handling (4.x) [11907](https://github.com/helidon-io/helidon/pull/11907)
- Common: Fix thread pool keep-alive duration conversion (4.x) [11881](https://github.com/helidon-io/helidon/pull/11881)
- Common: Fix TLS reload without initial managers (4.x) [11885](https://github.com/helidon-io/helidon/pull/11885)
- Common: Fix writeTo(OutputStream) writing excess bytes after partial read [11739](https://github.com/helidon-io/helidon/pull/11739)
- Common: Preserve malformed percent sequences in URI decoding (4.x) [11910](https://github.com/helidon-io/helidon/pull/11910)
- Common: Resolve deprecations in module helidon-common-mapper (4.x) [11549](https://github.com/helidon-io/helidon/pull/11549)
- Common: Guard null context classloaders [12078](https://github.com/helidon-io/helidon/pull/12078)
- Common: Reject malformed HPACK integers [dfd75c8120](https://github.com/helidon-io/helidon/commit/dfd75c81209f655b0d08ffbe36a41da4c0303674)
- Common: Sanitize content disposition filenames [0deb918d47](https://github.com/helidon-io/helidon/commit/0deb918d477390ab2d3b11237fe7441a3f012f02)
- Common: Use generic internal error response [06ac02fc7b](https://github.com/helidon-io/helidon/commit/06ac02fc7b54954bb880a4e8d351369ac00e4a60)
- Config: Fix helidon-config-metadata modules (4.x) [11767](https://github.com/helidon-io/helidon/pull/11767)
- Config: Fix MP config service registry warning (4.x) [12042](https://github.com/helidon-io/helidon/pull/12042)
- Config: Remove MP-generated config schema pages [11655](https://github.com/helidon-io/helidon/pull/11655)
- Config: Use context class loader to locate mp-meta-config (4.x) [11792](https://github.com/helidon-io/helidon/pull/11792)
- Config: Config value encryption format strengthened [98810f6c4d](https://github.com/helidon-io/helidon/commit/98810f6c4d068b31f6c20d53314dd64fd5468521)
- Config: Constrain Git config source paths [73f70f834a](https://github.com/helidon-io/helidon/commit/73f70f834a95f94a3465ccc17028c726975fa399)
- Config: Make config observer secret masking case-insensitive [900b2ec0ae](https://github.com/helidon-io/helidon/commit/900b2ec0aed6157d55b8174f6d88c9351f7d6af9)
- Config: Mask unsafe config observe values [d3573b552e](https://github.com/helidon-io/helidon/commit/d3573b552e0de78fbee717a997e333c9d707a01a)
- CORS: Backport CORS wildcard credentials guard [c0fbde1a08](https://github.com/helidon-io/helidon/commit/c0fbde1a08d7ff1d9510b2d11ddbe32d1b2fdb18)
- Data: Fix generated data repository deprecation warning (4.x) [11809](https://github.com/helidon-io/helidon/pull/11809)
- DBClient: Helidon JSON DBClient mapper and provider added [11929](https://github.com/helidon-io/helidon/pull/11929)
- DBClient: Mongodb Helidon JSON integration [11932](https://github.com/helidon-io/helidon/pull/11932)
- Declarative API stability (4.x) [11727](https://github.com/helidon-io/helidon/pull/11727)
- Declarative: Apply declarative validation constraints from service interfaces (4.x) [11931](https://github.com/helidon-io/helidon/pull/11931)
- Declarative: Fix declarative request parameter codegen (4.x) [11763](https://github.com/helidon-io/helidon/pull/11763)
- Declarative: Fix explicit classloader loading for HTTP parameter providers [11664](https://github.com/helidon-io/helidon/pull/11664)
- Declarative: Move declarative configuration to preview and support @Configuration.Value expressions (4.x) [11808](https://github.com/helidon-io/helidon/pull/11808)
- Declarative: Move declarative data APIs to preview (4.x) [11859](https://github.com/helidon-io/helidon/pull/11859)
- FT: Fix timeout current-thread completion logging (4.x) [11899](https://github.com/helidon-io/helidon/pull/11899)
- gRPC: Send te: trailers on every gRPC client request [11833](https://github.com/helidon-io/helidon/pull/11833)
- gRPC: Add gRPC security integration [174ee890cf](https://github.com/helidon-io/helidon/commit/174ee890cf3a9b64ca4038e8d8bd4b60002689b9)
- gRPC: Isolate gRPC reflection routing state [7a33bf7b3a](https://github.com/helidon-io/helidon/commit/7a33bf7b3ae4e789dbc1aa805b79691c51ca814c)
- HTTP: Fix Content-Location header constant (4.x) [11922](https://github.com/helidon-io/helidon/pull/11922)
- HTTP: Handle tokenized HTTP header values and fix HTTP/1 redirect probe framing (4.x) [11641](https://github.com/helidon-io/helidon/pull/11641)
- HTTP: Fix rebase follow-up failures [612e79b62c](https://github.com/helidon-io/helidon/commit/612e79b62c4c6a56f65dcc33172c8bd4c9ee8628)
- HTTP: Guard HPACK string length decoding [f817e4fc8b](https://github.com/helidon-io/helidon/commit/f817e4fc8b3824e788fadd1d11b5484ba0c234eb)
- HTTP: Require strict request content length parsing [34cb31d4f7](https://github.com/helidon-io/helidon/commit/34cb31d4f75aeb771929e5b50a0eee1333881b1f)
- HTTP: Require trusted proxy entry for forwarded URI discovery [fcc999c9ef](https://github.com/helidon-io/helidon/commit/fcc999c9efb425a2851842948c7c64ce8bdbdf24)
- HTTP: Strip client certificate header from requests [5b7e002158](https://github.com/helidon-io/helidon/commit/5b7e0021589678f6cd89698f1eff1284c60e31b8)
- HTTP: Validate HTTP/1 response headers by default [b39cbbddcf](https://github.com/helidon-io/helidon/commit/b39cbbddcf210c265240be913c34a28c691d2cf1)
- HTTP: Harden HTTP protocol logging [d6aa0ee873](https://github.com/helidon-io/helidon/commit/d6aa0ee8736d256e39e948ab137f783c5b4ff205)
- HTTP: Tighten HTTP signature validation [cbac593a51](https://github.com/helidon-io/helidon/commit/cbac593a51575278d1cec3265cb537c8934a2f92)
- HTTP/2: Fix HTTP/2 concurrent stream accounting [13fb9357ab](https://github.com/helidon-io/helidon/commit/13fb9357ab099859b4bd538454a1bb8d21b07c62)
- Integrations: Deprecate helidon-integrations-oci-sdk-cdi [11594](https://github.com/helidon-io/helidon/pull/11594)
- Integrations: Deprecate Micronaut integrations (4.x) [11689](https://github.com/helidon-io/helidon/pull/11689)
- JSON: Common REST uses Helidon JSON now [11709](https://github.com/helidon-io/helidon/pull/11709)
- JSON: Eureka integration JSON-P removal [11743](https://github.com/helidon-io/helidon/pull/11743)
- JSON: Eureka provider Helidon JSON rework [11714](https://github.com/helidon-io/helidon/pull/11714)
- JSON: Fix JSON stream parser buffer compaction [12064](https://github.com/helidon-io/helidon/pull/12064)
- JSON: Helidon JSON modules stability updates [11744](https://github.com/helidon-io/helidon/pull/11744)
- JSON: Helidon JSON used in helidon-lra-coordinator-server [11750](https://github.com/helidon-io/helidon/pull/11750)
- JSON: integrations-oci JSON-P deprecation [11675](https://github.com/helidon-io/helidon/pull/11675)
- JSON: Json Schema changed to use Helidon JSON [11770](https://github.com/helidon-io/helidon/pull/11770)
- JSON: JSON-P removed from the JSON-RPC (4.x) [11769](https://github.com/helidon-io/helidon/pull/11769)
- JSON: JSON-P replaced in helidon-security-jwt [11644](https://github.com/helidon-io/helidon/pull/11644)
- JSON: JSON-P replaced in Observe Info [11611](https://github.com/helidon-io/helidon/pull/11611)
- JSON: JSON-P replaced in Webserver Observer Log [11593](https://github.com/helidon-io/helidon/pull/11593)
- JSON: Missing JsonObject.Builder methods added [11952](https://github.com/helidon-io/helidon/pull/11952)
- JSON: OIDC and IDCS JSON-P deprecation [11681](https://github.com/helidon-io/helidon/pull/11681)
- JSON: Replace JSON-P with Helidon JSON in helidon-webserver-observe-metrics [11605](https://github.com/helidon-io/helidon/pull/11605)
- JSON: Telemetry tracing test JSON-P removed [11679](https://github.com/helidon-io/helidon/pull/11679)
- JSON: Document Helidon JSON DB Client support [005cfbe5a4](https://github.com/helidon-io/helidon/commit/005cfbe5a498a07802465e9880e2a1002a23608f)
- Mechanism to specify and enforce API stability (4.x) [11564](https://github.com/helidon-io/helidon/pull/11564)
- Media Support: Ignore multipart part Content-Length [d79ef9ac02](https://github.com/helidon-io/helidon/commit/d79ef9ac02777c11192cce6de5a317e86dd980a1)
- Media Support: Limit multipart part count [02caf625fe](https://github.com/helidon-io/helidon/commit/02caf625fe6765bcda967984309e804765002abf)
- Metrics: Avoid duplicate metrics registry init in declarative apps (4.x) [11810](https://github.com/helidon-io/helidon/pull/11810)
- Metrics: Deprecate Prometheus metrics API integration (4.x) [11755](https://github.com/helidon-io/helidon/pull/11755)
- Metrics: Deprecate Services.get replacement accessors (4.x) [11857](https://github.com/helidon-io/helidon/pull/11857)
- Metrics: Fix MP metrics thread deadlock (4.x) [11753](https://github.com/helidon-io/helidon/pull/11753)
- Metrics: Prepare publishers during `createMeterRegistry` as well as during `globalRegistry` [11828](https://github.com/helidon-io/helidon/pull/11828)
- Metrics: Restore Metrics interface compatibility (4.x) [11785](https://github.com/helidon-io/helidon/pull/11785)
- MicroProfile: Discover and register HttpFeature to the server [11640](https://github.com/helidon-io/helidon/pull/11640)
- MicroProfile: Tighten LRA participant callback dispatch [77fd844663](https://github.com/helidon-io/helidon/commit/77fd84466307c3b2c84b370a4097600f00dbf24e)
- OpenAPI: Protect OpenAPI service routes when authorization is required [4114b24f46](https://github.com/helidon-io/helidon/commit/4114b24f4641ad77e622ad1caffcd116db90af7e)
- Reactive: Fix OutputStreamMulti buffer size for write(byte[], off, len) [11583](https://github.com/helidon-io/helidon/pull/11583)
- Registry: Fix qualified late-binding lock leak (4.x) [12043](https://github.com/helidon-io/helidon/pull/12043)
- Registry: Fix service registry codegen for interface-contract validation (4.x) [11875](https://github.com/helidon-io/helidon/pull/11875)
- Security: Deprecate HTTP Digest Authentication provider (4.x) [11717](https://github.com/helidon-io/helidon/pull/11717)
- Security: Restore ProviderRequest class shape (4.x) [12020](https://github.com/helidon-io/helidon/pull/12020)
- Security: Support custom JWT groups paths (4.x) [11961](https://github.com/helidon-io/helidon/pull/11961)
- Security: Support disabling OIDC redirect attempt param  [11992](https://github.com/helidon-io/helidon/pull/11992)
- Security: Avoid logging digest credential values [19617b5d1c](https://github.com/helidon-io/helidon/commit/19617b5d1cf232d8b4ce24b70c000aca211f7747)
- Security: Fix IDCS mapper token request setup [3ad30c7787](https://github.com/helidon-io/helidon/commit/3ad30c778742c1df54d60f05c5838dd71db6b17b)
- Security: Harden OIDC fallback secret file [423584ec56](https://github.com/helidon-io/helidon/commit/423584ec565025562eb4be07c74b84a0314d69b3)
- Security: Reject invalid OIDC logout state [ab0bd39ea0](https://github.com/helidon-io/helidon/commit/ab0bd39ea038d97c0e064972eba5efa812667ce0)
- Security: Reject RSA1_5 JWE key management [c05807f548](https://github.com/helidon-io/helidon/commit/c05807f548e3e01f0b2a272a05c2f62f067b119a)
- Security: Require JWT claim checks without signatures [4a7e489ae8](https://github.com/helidon-io/helidon/commit/4a7e489ae865b9a6b3469e55eb2dc845f2a3769b)
- Security: Require MP JWT issuer validation [4fc37f9db7](https://github.com/helidon-io/helidon/commit/4fc37f9db73f78cdece69403fbac35877ab67fbf)
- Security: Use constant-time basic auth password comparison [27b8de18b2](https://github.com/helidon-io/helidon/commit/27b8de18b2a3d3e33f174de944952e7b871eed2c)
- Security: Use secure randomness for digest server secret [17de96b7a1](https://github.com/helidon-io/helidon/commit/17de96b7a16ce7943a945261c747b169d5660939)
- Security: Validate OIDC post-login redirects [8fe6702a15](https://github.com/helidon-io/helidon/commit/8fe6702a15fde00f5bfb98f27ab62df2d1af7be0)
- SSE: Neutralize line breaks in SSE fields [a13dbe1d48](https://github.com/helidon-io/helidon/commit/a13dbe1d48552c89c8f5bc883307660d177864ef)
- Services: Mark ServiceLoader constructors internal (4.x) [11688](https://github.com/helidon-io/helidon/pull/11688)
- Telemetry: Allow telemetry to be disabled without startup exception [11969](https://github.com/helidon-io/helidon/pull/11969)
- Telemetry: Remove incorrect double-setting of OTel baggage context in MP [11886](https://github.com/helidon-io/helidon/pull/11886)
- Telemtry: Add missing MDC support to OTel config support [4.x] [11912](https://github.com/helidon-io/helidon/pull/11912)
- TLS: Fix HTTP/2 TLS write race [11659](https://github.com/helidon-io/helidon/pull/11659)
- Tracing: Backward compatible SamplerType configuration [11988](https://github.com/helidon-io/helidon/pull/11988)
- Tracing: Fix MP tracing startup without telemetry config (4.x) [12049](https://github.com/helidon-io/helidon/pull/12049)
- WebClient: Avoid unnecessary DNS resolution without proxy [11837](https://github.com/helidon-io/helidon/pull/11837)
- WebClient: Backport 4.4.1 fixes from release branch (4.x) [11829](https://github.com/helidon-io/helidon/pull/11829)
- WebClient: Deprecate LockingStreamIdSequence constructor [12013](https://github.com/helidon-io/helidon/pull/12013)
- WebClient: Fix HTTP/2 client h2c stalls under load [11991](https://github.com/helidon-io/helidon/pull/11991)
- WebServer: BufferDataInputStream must return -1 at EOF, not 0 or throw [11736](https://github.com/helidon-io/helidon/pull/11736)
- WebServer: Fix flaky observe log level test on Windows (4.x) [11729](https://github.com/helidon-io/helidon/pull/11729)
- WebServer: Fix smart socket writer (4.x) [11895](https://github.com/helidon-io/helidon/pull/11895)
- WebServer: Fix SSE comment-only events [12011](https://github.com/helidon-io/helidon/pull/12011)
- WebServer: Fix Unix address parsing in WebServer and WebClient configuration (4.x) [11856](https://github.com/helidon-io/helidon/pull/11856)
- WebServer: Graceful handling of exceptions when writing to response (4.x) [11684](https://github.com/helidon-io/helidon/pull/11684)
- WebServer: Re-encoding already encoded content (4.x) [11663](https://github.com/helidon-io/helidon/pull/11663)
- WebServer: Remove declarative WebServer startup warning (4.x) [11858](https://github.com/helidon-io/helidon/pull/11858)
- WebServer: Contain filesystem static content symlinks on [419e5324dc](https://github.com/helidon-io/helidon/commit/419e5324dcce286c88d9fb6119992d12a4f45ae2)
- WebServer: Enforce decoded request entity limits [55619c5ff9](https://github.com/helidon-io/helidon/commit/55619c5ff92e987f5ede3cbcc35374c92001d6ed)
- WebServer: Fall back to NIO for valid static content [ce68be5f37](https://github.com/helidon-io/helidon/commit/ce68be5f37ad052cd916072df7600daf5b209522)
- WebServer: Fix MadeYouReset reset accounting [54cdf7c253](https://github.com/helidon-io/helidon/commit/54cdf7c2532dc52a6997d58094abe14ef0f5834c)
- WebServer: Fix rapid reset threshold accounting [afa7384c18](https://github.com/helidon-io/helidon/commit/afa7384c18205c58b3b5d638583e1aaeaf176f5c)
- WebServer: Honor secure handler role hints in secure routes [9ea76e7bec](https://github.com/helidon-io/helidon/commit/9ea76e7bec997abe0101f6c36fffac9b27cbdc7f)
- WebServer: Release connection permits on setup failure [aad4b72ac4](https://github.com/helidon-io/helidon/commit/aad4b72ac4de021ad42c94521fe0cf0c26155d82)
- WebSocket: Secure routed WebSocket upgrades on [e33561bca0](https://github.com/helidon-io/helidon/commit/e33561bca0093942969cfe450d45d67de3997f0d)
- WebSocket: Fix WsSession.send race (4.x) [11795](https://github.com/helidon-io/helidon/pull/11795)
- Build: dependency check updates [11975](https://github.com/helidon-io/helidon/pull/11975)
...
- Dependencies: Adopt OpenTelemetry 1.62.0 [11981](https://github.com/helidon-io/helidon/pull/11981)
- Dependencies: Upgrade Jackson to 2.21.3 [11996](https://github.com/helidon-io/helidon/pull/11996)
- Dependencies: Upgrade log4j to 2.25.4 [11818](https://github.com/helidon-io/helidon/pull/11818)
- Dependencies: Upgrade maven api to 3.9.15 [11730](https://github.com/helidon-io/helidon/pull/11730)
- Dependencies: Upgrade micronaut to 4.10.23 [11976](https://github.com/helidon-io/helidon/pull/11976)
- Dependencies: Upgrade Netty to 4.1.135.Final [12089](https://github.com/helidon-io/helidon/pull/12089)
- Dependencies: Upgrade Handlebars to 4.5.1, Opennlp to 2.5.9 [11924](https://github.com/helidon-io/helidon/pull/11924)
- Dependencies: Upgrade OCI SDK to 3.86.2 [11995](https://github.com/helidon-io/helidon/pull/11995)
- Dependencies: upgrade postgres jdbc driver to 42.7.11 [11850](https://github.com/helidon-io/helidon/pull/11850)
- Dependencies: Upgrade snakeyaml to 2.6 [11993](https://github.com/helidon-io/helidon/pull/11993)
- Dependencies: Upgrade typesafe to 1.4.8 [11994](https://github.com/helidon-io/helidon/pull/11994)
- Docs: Document max-tcp-connections admission semantics (4.x) [11944](https://github.com/helidon-io/helidon/pull/11944)
- Docs: tree-ify config reference documentation [11642](https://github.com/helidon-io/helidon/pull/11642)
...
OpenTelemtry OTLP exporter. For more details see [11069](https://github.com/helidon-io/helidon/issues/11069).
...
[LangChain4j documentation](https://helidon.io/docs/v4/se/ai/langchain4j/langchain4j)
...
- Builders: Annotations properly generated with the Blueprint [11016](https://github.com/helidon-io/helidon/pull/11016)
- Builders: Builder extensibility [10838](https://github.com/helidon-io/helidon/pull/10838)
- Builders: Correctly discover parent configured blueprints even when from a different module [10985](https://github.com/helidon-io/helidon/pull/10985)
- Builders: Default methods on blueprint now generate backward compatible prototypes. [11061](https://github.com/helidon-io/helidon/pull/11061)
- Builders: Ensure that decorator methods for Set and List are called with correctly types values [11244](https://github.com/helidon-io/helidon/pull/11244)
- Builders: Fix a problem where we kept bad candidates for builder methods. [10897](https://github.com/helidon-io/helidon/pull/10897)
- Builders: Fix builder regression - generate singular setter with consumer of prototype builder [11252](https://github.com/helidon-io/helidon/pull/11252)
- Builders: Generate service descriptors without deprecated code for annotations. [11183](https://github.com/helidon-io/helidon/pull/11183)
- Builders: helidon-builder-processor as a shim of helidon-builder-codegen [11278](https://github.com/helidon-io/helidon/pull/11278)
- Builders: Improve annotation processing diagnostics [11281](https://github.com/helidon-io/helidon/pull/11281)
- Builders: Update builders to support third party types as runtime types. [11113](https://github.com/helidon-io/helidon/pull/11113)
- Builders: Update documentation of classValue in Annotation [11228](https://github.com/helidon-io/helidon/pull/11228)
- Codegen: Add support for enum and record types to class model. [11071](https://github.com/helidon-io/helidon/pull/11071)
- Codegen: Codegen Unit Testing [11283](https://github.com/helidon-io/helidon/pull/11283)
- Codegen: Fix addContentLiteral in content builder in class model [11249](https://github.com/helidon-io/helidon/pull/11249)
- Codegen: Prettify class-model annotation rendering and support nested annotations [11282](https://github.com/helidon-io/helidon/pull/11282)
- Common: Fix weight comparator. [11129](https://github.com/helidon-io/helidon/pull/11129)
- Config: Changes in handling environment variables in SE config. [11049](https://github.com/helidon-io/helidon/pull/11049)
- Config: Common config alternatives [11261](https://github.com/helidon-io/helidon/pull/11261)
- Config: Create config from text and media type. [11138](https://github.com/helidon-io/helidon/pull/11138)
- Config: File ConfigSource fails generating MD5 digest. [11233](https://github.com/helidon-io/helidon/pull/11233)
- Config: Fix a bug in config expression resolution, where the `:` separating c… [11200](https://github.com/helidon-io/helidon/pull/11200)
- Config: Fixes for Javadoc when building on Java 26 EA [11174](https://github.com/helidon-io/helidon/pull/11174)
- Config: helidon-config-metadata-processor as a shim of helidon-config-metadata-codegen [11279](https://github.com/helidon-io/helidon/pull/11279)
- Config: Log setup of configuration - filters, config sources, parsers etc. [11140](https://github.com/helidon-io/helidon/pull/11140)
- Config: Merged config [11072](https://github.com/helidon-io/helidon/pull/11072)
- Config: Meta config can now use config sources provided via service registry [10842](https://github.com/helidon-io/helidon/pull/10842)
- Config: Move MP config encryption from SE module. [11097](https://github.com/helidon-io/helidon/pull/11097)
- Config: Prevent recursion when getting global config in the deprecated way. [11171](https://github.com/helidon-io/helidon/pull/11171)
- CORS: updated and declarative CORS [11155](https://github.com/helidon-io/helidon/pull/11155)
- Data: Fix codegen to generate a for cycle instead of a for-each lambda [11203](https://github.com/helidon-io/helidon/pull/11203)
- Declarative metrics. [10869](https://github.com/helidon-io/helidon/pull/10869)
- Declarative security [10701](https://github.com/helidon-io/helidon/pull/10701)
- Declarative tracing [10934](https://github.com/helidon-io/helidon/pull/10934)
- Declarative Validation [10755](https://github.com/helidon-io/helidon/pull/10755)
- Declarative WebSocket [11050](https://github.com/helidon-io/helidon/pull/11050)
- Declarative: Fix handling of generic type for client response. [11300](https://github.com/helidon-io/helidon/pull/11300)
- Declarative: Fix validation codegen to generate validation in order of declaration. [11142](https://github.com/helidon-io/helidon/pull/11142)
- Declarative: WebSocket Client [11081](https://github.com/helidon-io/helidon/pull/11081)
- Discovery: Web Client Discovery integration [10786](https://github.com/helidon-io/helidon/pull/10786)
- FT: Terminate monitor thread created by the timeout implementation when supplier returns [10833](https://github.com/helidon-io/helidon/pull/10833)
- gRPC: Fix "typo" in header name construction [10987](https://github.com/helidon-io/helidon/pull/10987)
- gRPC: Fix problem handling server-side gRPC errors. Handles grpc-status hea… [10890](https://github.com/helidon-io/helidon/pull/10890)
- gRPC: Update gRPC reflection service to support imports [11075](https://github.com/helidon-io/helidon/pull/11075)
- JSON-RPC: Add support for SSE event sources to JsonRpcResponse [11031](https://github.com/helidon-io/helidon/pull/11031)
- JSON: Compile-time JSON implementation [10961](https://github.com/helidon-io/helidon/pull/10961)
- JSON: Helidon JSON media support for JsonValue subclasses. [11176](https://github.com/helidon-io/helidon/pull/11176)
- JSON: Helidon JSON polymorphism support [11187](https://github.com/helidon-io/helidon/pull/11187)
- JSON: Helidon JSON serialization loop fix [11218](https://github.com/helidon-io/helidon/pull/11218)
- JSON: Insufficient number parsing fixed [11227](https://github.com/helidon-io/helidon/pull/11227)
- JSON: Json API fixes [11286](https://github.com/helidon-io/helidon/pull/11286)
- JSON: JSON generator fixes [11074](https://github.com/helidon-io/helidon/pull/11074)
- JSON: Object deserialization fix [11236](https://github.com/helidon-io/helidon/pull/11236)
- JSON: Remove incubating from Helidon JSON module [11219](https://github.com/helidon-io/helidon/pull/11219)
- JSON: Use Helidon JSON instead of JSON-P for Config observer. [11264](https://github.com/helidon-io/helidon/pull/11264)
- LC4J: Agentic [10972](https://github.com/helidon-io/helidon/pull/10972)
- LC4J: Agentic MCP [11190](https://github.com/helidon-io/helidon/pull/11190)
- LC4J: Add LangChain4j Mock ChatModel provider [10966](https://github.com/helidon-io/helidon/pull/10966)
- LC4J: Add warning for incompatible langchain4j config keys [11287](https://github.com/helidon-io/helidon/pull/11287)
- LC4J: documentation update. Bump version to 1.12.1 [11275](https://github.com/helidon-io/helidon/pull/11275)
- LC4J: Fix MockStreamingChatModel cofig root [11277](https://github.com/helidon-io/helidon/pull/11277)
- LC4J: Support injection in guardrails #10714 [11024](https://github.com/helidon-io/helidon/pull/11024)
- Media Support: Update of JSON media supports [11234](https://github.com/helidon-io/helidon/pull/11234)
- Media: Add custom `Gson` type adapter factories during runtime [10437](https://github.com/helidon-io/helidon/pull/10437)
- Media: Add support for buffering entities [11151](https://github.com/helidon-io/helidon/pull/11151)
- Messaging: Add config-metadata support to JMS, AQ & Kafka connectors #5227 [10863](https://github.com/helidon-io/helidon/pull/10863)
- MetaData: Fix loading of metadata when we have a split package [11170](https://github.com/helidon-io/helidon/pull/11170)
- MetaData: Fixes a bug in metadata discovery, where we failed to call next() before remove() on iterator [11202](https://github.com/helidon-io/helidon/pull/11202)
- Metrics: Improve handling and doc of `baseUnit` for `Timer` [10881](https://github.com/helidon-io/helidon/pull/10881)
- Metrics: Improve Prometheus output performance [10850](https://github.com/helidon-io/helidon/pull/10850)
- Metrics: Log warnings (if not configured to suppress) upon multiple instantiations of `MMeterRegistry` [10859](https://github.com/helidon-io/helidon/pull/10859)
- Native-image: Changes for native image to work with GraalVM 25 for a simple application [10862](https://github.com/helidon-io/helidon/pull/10862)
- OCI: Fully deprecate old OCI SE support [10899](https://github.com/helidon-io/helidon/pull/10899)
- OpenAPI: Export package from OpenAPI UI integration module; with integration test [10902](https://github.com/helidon-io/helidon/pull/10902)
- OpenAPI: Fix incorrect config examples and text for customizing UI settings in SE [10884](https://github.com/helidon-io/helidon/pull/10884)
- OTel: Add support for exporting Helidon metrics via OTLP [11231](https://github.com/helidon-io/helidon/pull/11231)
- OTel: Adopt later OpenTelemetry release [11066](https://github.com/helidon-io/helidon/pull/11066)
- OTel: Allow and document how users control SE tracing for OpenTelemetry using Helidon config under `tracing` [10791](https://github.com/helidon-io/helidon/pull/10791)
- OTel: Support OpenTelemetry logging set-up using Helidon configuration [11260](https://github.com/helidon-io/helidon/pull/11260)
- Registry: Allow service registry injected ConfigSources to work in Helidon MP [11029](https://github.com/helidon-io/helidon/pull/11029)
- Registry: If System.exit is called from post construct method, do not deadlock [11060](https://github.com/helidon-io/helidon/pull/11060)
- Registry: Remove preview flag from service registry. [10907](https://github.com/helidon-io/helidon/pull/10907)
- Registry: Set all contracts when calling Services.set [10816](https://github.com/helidon-io/helidon/pull/10816)
- Scheduling: Add configurable enabled flag for scheduling tasks (#10812) [10825](https://github.com/helidon-io/helidon/pull/10825)
- Scheduling: Configurable MP Scheduling #11004 [11005](https://github.com/helidon-io/helidon/pull/11005)
- Scheduling: Helidon SE Scheduling: Add ZoneId support in cron builder [11000](https://github.com/helidon-io/helidon/pull/11000)
- Scheduling: Make sure we do not fail validation of scheduling in MP [10846](https://github.com/helidon-io/helidon/pull/10846)
- Scheduling: Scheduling fixes [10837](https://github.com/helidon-io/helidon/pull/10837)
- Security: Allow creation of ProviderRequest by changing it to an interface [11047](https://github.com/helidon-io/helidon/pull/11047)
- Security: Backward compatible fix for common config in SecurityProviderService [11046](https://github.com/helidon-io/helidon/pull/11046)
- SSE: Add support for content encoding in SSE [11273](https://github.com/helidon-io/helidon/pull/11273)
- Telemetry: Add support for OpenTelemetry metrics configuration using Helidon config [11044](https://github.com/helidon-io/helidon/pull/11044)
- Telemetry: Provide equivalent of OTel's Jaeger exporter for Helidon compatibility [11112](https://github.com/helidon-io/helidon/pull/11112)
- Telemetry: Support OpenTelemetry metrics and tracing semantic conventions for web clients [11065](https://github.com/helidon-io/helidon/pull/11065)
- Telemetry: Support OpenTelemetry server HTTP semantic conventions metrics [11168](https://github.com/helidon-io/helidon/pull/11168)
- Testing: Fix testcontainers logging [11181](https://github.com/helidon-io/helidon/pull/11181)
- Testing: Require CDI qualifier(s) to resolve JUnit method parameter from CDI [11247](https://github.com/helidon-io/helidon/pull/11247)
- Tracing: Fix tracer factory to use a global tracer instead of a no-op tracer [11010](https://github.com/helidon-io/helidon/pull/11010)
- WebClient: Add ConnectionListener interface to WebClient config to enable writing Proxy Protocol information [11179](https://github.com/helidon-io/helidon/pull/11179)
- WebClient: Convert webclient OTel metrics sem. conv. to OTel API instead of Helidon metrics API [11172](https://github.com/helidon-io/helidon/pull/11172)
- WebClient: Do not switch to chunked encoding in webclient when the length is known [10828](https://github.com/helidon-io/helidon/pull/10828)
- WebClient: Remove duplicate Http/2 frame split in client #10815 [10829](https://github.com/helidon-io/helidon/pull/10829)
- WebServer: Add support for extrracting TLV information from Proxy Protocol V2 [11152](https://github.com/helidon-io/helidon/pull/11152)
- WebServer: Deprecated public constructor of DataReader, replaced with static create method [10867](https://github.com/helidon-io/helidon/pull/10867)
- WebServer: Do not use timeout on offering return of a connection to the pool. [10880](https://github.com/helidon-io/helidon/pull/10880)
- WebServer: Expose TLS reload methods in MP #10773 [10841](https://github.com/helidon-io/helidon/pull/10841)
- WebServer: Filters invoked twice when Http1DirectJunitExtension [11059](https://github.com/helidon-io/helidon/pull/11059)
- WebServer: Fix issues with trailers in HTTP/2 [10997](https://github.com/helidon-io/helidon/pull/10997)
- WebServer: Fixed a case where we may return a negative number from an input stream in multipart. [10875](https://github.com/helidon-io/helidon/pull/10875)
- WebServer: Fixed parsing of HTTP prologue for big endian machines [11051](https://github.com/helidon-io/helidon/pull/11051)
- WebServer: HTTP/2 hasEntity() [10885](https://github.com/helidon-io/helidon/pull/10885)
- WebServer: Prevent double compression when handler has already set content encoding [10887](https://github.com/helidon-io/helidon/pull/10887)
- WebServer: Throughput rate limiting feature [10969](https://github.com/helidon-io/helidon/pull/10969)
- WebServer: UNIX Domain Socket support [10894](https://github.com/helidon-io/helidon/pull/10894)
- WebServer: Validate HTTP/2 MAX_FRAME_SIZE before applying client settings [11291](https://github.com/helidon-io/helidon/pull/11291)
- Build: Attempt to fix intermittent compilation failures. [11165](https://github.com/helidon-io/helidon/pull/11165)
- Build: bundles-apt added to the bom [11220](https://github.com/helidon-io/helidon/pull/11220)
- Build: Fix dependency:analyze-only for http-media-json [11077](https://github.com/helidon-io/helidon/pull/11077)
- Build: Fix issue when a maven build does compilation without clean. [11193](https://github.com/helidon-io/helidon/pull/11193)
- Build: Fix schema location for pom files. [11006](https://github.com/helidon-io/helidon/pull/11006)
- Build: Free disk space in tests job [10851](https://github.com/helidon-io/helidon/pull/10851)
- Build: Make sure we have a plugin dependency for features codegen and codegen apt [10954](https://github.com/helidon-io/helidon/pull/10954)
- Build: removes jaxb-impl from jpa-cdi/pom.xml [10898](https://github.com/helidon-io/helidon/pull/10898)
- Build: Use a new profile `long-tests` for tests that use testcontainers [11132](https://github.com/helidon-io/helidon/pull/11132)
- Dependencies: Bump com.oracle.oci.sdk:oci-java-sdk-bom from 3.77.2 to 3.78.1 in /dependencies [11067](https://github.com/helidon-io/helidon/pull/11067)
- Dependencies: Bump-up LangChain4j to 1.10.0 [10955](https://github.com/helidon-io/helidon/pull/10955)
- Dependencies: Force upgrade jinjava to 2.8.3 [11166](https://github.com/helidon-io/helidon/pull/11166)
- Dependencies: Micronaut Data cannot build on Java 24 with the current MN versi… [10883](https://github.com/helidon-io/helidon/pull/10883)
- Dependencies: Upgrade apache commons-text to 1.15.0 [10976](https://github.com/helidon-io/helidon/pull/10976)
- Dependencies: Upgrade build-tools to 4.0.25 [11246](https://github.com/helidon-io/helidon/pull/11246)
- Dependencies: Upgrade commons-logging to 1.3.5 [11084](https://github.com/helidon-io/helidon/pull/11084)
- Dependencies: Upgrade GSON to 2.13.2 [11082](https://github.com/helidon-io/helidon/pull/11082)
- Dependencies: Upgrade guava to 33.3.1-jre. Exclude some troublesome google artifacts from dep convergence [10839](https://github.com/helidon-io/helidon/pull/10839)
- Dependencies: Upgrade Jackson to 2.21.0 [11052](https://github.com/helidon-io/helidon/pull/11052)
- Dependencies: Upgrade Jackson to 2.21.1 [11239](https://github.com/helidon-io/helidon/pull/11239)
- Dependencies: Upgrade Jersey to 3.1.11 [10970](https://github.com/helidon-io/helidon/pull/10970)
- Dependencies: Upgrade junit to 5.12.2 [11177](https://github.com/helidon-io/helidon/pull/11177)
- Dependencies: Upgrade Kafka client to 3.9.2 [11207](https://github.com/helidon-io/helidon/pull/11207)
- Dependencies: Upgrade log4j to 2.25.3 [10518](https://github.com/helidon-io/helidon/pull/10518)
- Dependencies: Upgrade Netty to 4.1.130.Final [10973](https://github.com/helidon-io/helidon/pull/10973)
- Dependencies: Upgrade slf4j to 2.0.17 [11083](https://github.com/helidon-io/helidon/pull/11083)
- Dependencies: Upgrade test-containers to 1.21.4 [11164](https://github.com/helidon-io/helidon/pull/11164)
- Dependencies: Upgrades Byte Buddy to 1.18.5 [11189](https://github.com/helidon-io/helidon/pull/11189)
- Dependencies: Upgrades Narayana to 7.1.0.Final [10900](https://github.com/helidon-io/helidon/pull/10900)
- Dependencies: Upgrades Oracle drivers to latest version [11271](https://github.com/helidon-io/helidon/pull/11271)
- Dependencies: Upgrades version.lib.ojdbc to 23.26.0.0.0 [10872](https://github.com/helidon-io/helidon/pull/10872)
- Docs: Add reference to oci guide [11109](https://github.com/helidon-io/helidon/pull/11109)
- Docs: Compile time json documentation [11055](https://github.com/helidon-io/helidon/pull/11055)
- Docs: Config reference docs updates [11284](https://github.com/helidon-io/helidon/pull/11284)
- Docs: Declarative security docs [10865](https://github.com/helidon-io/helidon/pull/10865)
- Docs: Doc for using the OTel API directly from a Helidon app [11235](https://github.com/helidon-io/helidon/pull/11235)
- Docs: Document support for service registry through Testing.Test annotation. [11243](https://github.com/helidon-io/helidon/pull/11243)
- Docs: Exclude src/it from aggregated javadocs [11122](https://github.com/helidon-io/helidon/pull/11122)
- Docs: Remove /#/ from helidon.io docs links [10960](https://github.com/helidon-io/helidon/pull/10960)
- Docs: Remove MCP page and its reference in MP docs [11013](https://github.com/helidon-io/helidon/pull/11013)
- Docs: Update docs to mention support for AOT Cache in custom jlink images [11226](https://github.com/helidon-io/helidon/pull/11226)
- Docs: Update documentation with support for configuration expressions in scheduling [11169](https://github.com/helidon-io/helidon/pull/11169)
- Docs: Update Helidon introduction page [11250](https://github.com/helidon-io/helidon/pull/11250)
- Docs: Update LangChain4j docs for new provider/model config [11225](https://github.com/helidon-io/helidon/pull/11225)
- Docs: Update OCI Integration documentation for SE [11032](https://github.com/helidon-io/helidon/pull/11032)
- Docs: Update quick start (and related) documentation [11208](https://github.com/helidon-io/helidon/pull/11208)
- Docs: Updates to SE and MP Upgrade Guides [11272](https://github.com/helidon-io/helidon/pull/11272)
- Examples: Add OpenTelemetry as archetype tracing choice, make it default, remove Jaeger [11274](https://github.com/helidon-io/helidon/pull/11274)
- Examples: Remove usage of Config.global in the archetypes [11162](https://github.com/helidon-io/helidon/pull/11162)
- Tests: Accounts for Hibernate 6.6 and future versions' unique interpretation of an area of the JPA spec [11188](https://github.com/helidon-io/helidon/pull/11188)
- Tests: Enable microprofile/tests/tck/tck-config/src/test/tck-suite.xml tests [8173](https://github.com/helidon-io/helidon/pull/8173)
- Tests: Fix AckMPTest RC when delayed ack asks offset of the next message [10831](https://github.com/helidon-io/helidon/pull/10831)
- Tests: Fix concurrent update problem in test log handler [10823](https://github.com/helidon-io/helidon/pull/10823)
- Tests: Fix timeout duration in test [11040](https://github.com/helidon-io/helidon/pull/11040)
- Tests: Isolate tests modules with -Ptests [11280](https://github.com/helidon-io/helidon/pull/11280)
- Tests: Java 25 test fixes [11293](https://github.com/helidon-io/helidon/pull/11293)
- Tests: Remove flaky HTTP/2 CutConnectionTest [11296](https://github.com/helidon-io/helidon/pull/11296)
- Tests: Remove unused types from gson test. [10992](https://github.com/helidon-io/helidon/pull/10992)
- Tests: Remove usage of local environment variables in test. [10878](https://github.com/helidon-io/helidon/pull/10878)
- Tests: Tolerate test log tracing output that has attributes with no value [11085](https://github.com/helidon-io/helidon/pull/11085)
...
- Builders: Check supertypes during validation of runtime types. Added test [10273](https://github.com/helidon-io/helidon/pull/10273)
- Builders: Fix wrong method generated for factory methods in builder [10522](https://github.com/helidon-io/helidon/pull/10522)
- Builders: Support for nested types with generics in configured options in blueprints [10262](https://github.com/helidon-io/helidon/pull/10262)
- Builders: Support for varargs in common types [10228](https://github.com/helidon-io/helidon/pull/10228)
- Builders: TypeName multidimensional array support added [10236](https://github.com/helidon-io/helidon/pull/10236)
- Builders: Updated parsing of annotations from String for class model and builder [10318](https://github.com/helidon-io/helidon/pull/10318)
- Codegen updates [10069](https://github.com/helidon-io/helidon/pull/10069)
...
- Common: Avoid recursive update in TypeStash [10649](https://github.com/helidon-io/helidon/pull/10649)
...
- Config: Change occurrences of `"${AES"` to `"${GCM"` [10659](https://github.com/helidon-io/helidon/pull/10659)
...
- Config: Fix change event support for lazy config sources. [10697](https://github.com/helidon-io/helidon/pull/10697)
- Config: Global config now works consistent with Testing.Test and global service registry [10648](https://github.com/helidon-io/helidon/pull/10648)
- Config: Rename TestFilterService to FilterServiceTest so it is run [10656](https://github.com/helidon-io/helidon/pull/10656)
- Config: Services.set for config will set both config contracts [10473](https://github.com/helidon-io/helidon/pull/10473)
- Config: Set addClasspath to true so config encryption jar is runnable [10658](https://github.com/helidon-io/helidon/pull/10658)
- Context propagation over HTTP [10200](https://github.com/helidon-io/helidon/pull/10200)
- CORS: For MP CORS, suppress explanation of rejection in response; log it instead [10655](https://github.com/helidon-io/helidon/pull/10655)
- CORS: In MP CORS do not add CORS headers if request is rejected [10676](https://github.com/helidon-io/helidon/pull/10676)
- CORS: Reduce text in CORS response status [10631](https://github.com/helidon-io/helidon/pull/10631)
- Data: Helidon Data documentation fixes. [10696](https://github.com/helidon-io/helidon/pull/10696)
...
- Declarative: Class model constants in annotations [10238](https://github.com/helidon-io/helidon/pull/10238)
- Declarative: Codegen and supporting types for runtime of Helidon Declarative APIs [10215](https://github.com/helidon-io/helidon/pull/10215)
- Declarative: configuration expression [10491](https://github.com/helidon-io/helidon/pull/10491)
- Declarative: Fixed missing required query and header parameters in declarative [10668](https://github.com/helidon-io/helidon/pull/10668)
- Declarative: Introduction of APIs for Helidon Declarative [10136](https://github.com/helidon-io/helidon/pull/10136)
- Declarative: Use get instead of getString in declarative HTTP, as it bypasses usage of Mappers. [10618](https://github.com/helidon-io/helidon/pull/10618)
...
- Feature metadata now uses a JSON based format [9966](https://github.com/helidon-io/helidon/pull/9966)
- Features: Use `SetUpFeatures` annotation [10037](https://github.com/helidon-io/helidon/pull/10037)
- FT: Fault Tolerance API update for declarative [10074](https://github.com/helidon-io/helidon/pull/10074)
- gRPC: Adds support for a gRPC reflection service [10014](https://github.com/helidon-io/helidon/pull/10014)
- gRPC: Adds support for gRPC reflection service version v1alpha  [10122](https://github.com/helidon-io/helidon/pull/10122)
- gRPC: Adds support for new gRPC MP annotation  [10276](https://github.com/helidon-io/helidon/pull/10276)
- gRPC: Adds support for tracing to gRPC client [10314](https://github.com/helidon-io/helidon/pull/10314)
- gRPC: Decrease log level severity when a stream timeout is retried [10445](https://github.com/helidon-io/helidon/pull/10445)
- gRPC: Ensures gRPC client calls pass metadata as headers [10301](https://github.com/helidon-io/helidon/pull/10301)
- gRPC: Fix gRPC ALPN negotiation by advertising h2 protocol [10439](https://github.com/helidon-io/helidon/pull/10439)
- gRPC: Fixes problems cancelling a client-streaming gRPC call [10128](https://github.com/helidon-io/helidon/pull/10128)
- gRPC: Fixes problems converting HTTP/2 headers to Metadata [10300](https://github.com/helidon-io/helidon/pull/10300)
- gRPC: grpc changes for proper event notification and tracing span propagation [10403](https://github.com/helidon-io/helidon/pull/10403)
- gRPC: Improvements [10147](https://github.com/helidon-io/helidon/pull/10147)
- gRPC: Improves support for new gRPC V2 blocking stub calls [10453](https://github.com/helidon-io/helidon/pull/10453)
- gRPC: Proper handling of ACK frames and long gRPC data frames [10303](https://github.com/helidon-io/helidon/pull/10303)
- gRPC: Refactors code that handles gRPC interceptors in webserver [10089](https://github.com/helidon-io/helidon/pull/10089)
- gRPC: Replaces TODOs with proper argument validation  [10112](https://github.com/helidon-io/helidon/pull/10112)
- Grpc: Small fix for grpc deprecation [10606](https://github.com/helidon-io/helidon/pull/10606)
- gRPC: Support for gRPC server metrics [10098](https://github.com/helidon-io/helidon/pull/10098)
- gRPC: Support for metrics in gRPC client [10101](https://github.com/helidon-io/helidon/pull/10101)
- Health: Add ability to exclude health checks by name; clarify doc [10379](https://github.com/helidon-io/helidon/pull/10379)
- HTTP: Allow option for adding Iterable<String> header values [10331](https://github.com/helidon-io/helidon/pull/10331)
- HTTP: Check consistency of x-forwarded- headers; fix incorrect port assignment in compatibility helper [10336](https://github.com/helidon-io/helidon/pull/10336)
- HTTP: http module updates (constants for annotations, dependency plugin, javadocs fail on warning) [10088](https://github.com/helidon-io/helidon/pull/10088)
- HTTP/2: Connection checks update [10549](https://github.com/helidon-io/helidon/pull/10549)
- JSON Schema: incubating feature flag [10716](https://github.com/helidon-io/helidon/pull/10716)
- JSON Schema: Json schema support [10686](https://github.com/helidon-io/helidon/pull/10686)
- JSON-RPC: Add support for exception mappers to JSON-RPC [10663](https://github.com/helidon-io/helidon/pull/10663)
- JSON-RPC: Make request context available in JSON-RPC request [10712](https://github.com/helidon-io/helidon/pull/10712)
- JSON-RPC: Allow a JsonRpcResponse to obtain an SSE sink [10619](https://github.com/helidon-io/helidon/pull/10619)
- LC4J: Add Coherence ChatMemory Store Support [10438](https://github.com/helidon-io/helidon/pull/10438)
- LC4J: Add Coherence Embedding Store Support [10419](https://github.com/helidon-io/helidon/pull/10419)
- LC4J: LangChain4j integration update [10362](https://github.com/helidon-io/helidon/pull/10362)
...
- LC4J: Fix NPE in ChatModelListener [10705](https://github.com/helidon-io/helidon/pull/10705)
...
- LC4J: Package private lc4j model factories [10678](https://github.com/helidon-io/helidon/pull/10678)
- MDC: Enhance MDC to allow mapping a key to a supplier of string; enhance tracing to add `trace_id`  [10143](https://github.com/helidon-io/helidon/pull/10143)
- Media: Add Gson Support [10265](https://github.com/helidon-io/helidon/pull/10265)
- Media: Fix Jackson when charset is used for Accept header. [10270](https://github.com/helidon-io/helidon/pull/10270)
- Media: JSON-P/B configuration methods added [10242](https://github.com/helidon-io/helidon/pull/10242)
- Metrics: Add support for `metrics.rest-request.enabled` (with dot instead of hyphen) in SE metrics config [10177](https://github.com/helidon-io/helidon/pull/10177)
...
- Metrics: Manage REST request metrics for resource methods on a superclass [10198](https://github.com/helidon-io/helidon/pull/10198)
- Metrics: Move feature info from metrics API to Micrometer implementation component [10672](https://github.com/helidon-io/helidon/pull/10672)
- Metrics: Use common config instead of config with `Services.get` [10365](https://github.com/helidon-io/helidon/pull/10365)
- Metrics: Use Services.get(Config.class) instead of global config [10339](https://github.com/helidon-io/helidon/pull/10339)
- Modules: Move from old feature annotations and processor to new ones and codegen [10634](https://github.com/helidon-io/helidon/pull/10634)
...
- OTel: Coordinate the OpenTelemetry tracing provider init with the new config-based init [10624](https://github.com/helidon-io/helidon/pull/10624)
- OTel: Fix assignment of `http.route`; do it during end-of-span processing because `matchingPattern` is not available earlier [10615](https://github.com/helidon-io/helidon/pull/10615)
- Performance: Use an instance of mappers when creating Headers, path, UriQuery etc. [10635](https://github.com/helidon-io/helidon/pull/10635)
...
- Security: Leftover dependencies on jersey client removed from the OIDC [10643](https://github.com/helidon-io/helidon/pull/10643)
- Security: OIDC Client credentials flow fix [10709](https://github.com/helidon-io/helidon/pull/10709)
- Security: PKCE and Client credential flow added to the OIDC [9930](https://github.com/helidon-io/helidon/pull/9930)
- Security: Removed default header when abstain [10145](https://github.com/helidon-io/helidon/pull/10145)
...
- Service Registry: CDI bridge for service registry + config factory improvements [9845](https://github.com/helidon-io/helidon/pull/9845)
- Service Registry: Fix issue with invalid registry if global registry is shutdown [10376](https://github.com/helidon-io/helidon/pull/10376)
- Service Registry: Remove unused code from AbstractRegistry and Registry [10428](https://github.com/helidon-io/helidon/pull/10428)
...
- Service Registry: Improve performance of Services.get(Class). [10627](https://github.com/helidon-io/helidon/pull/10627)
- SSE: Adds support for multi-line SSE event [10406](https://github.com/helidon-io/helidon/pull/10406)
- Telemetry: Reusable telemetry tracing test utilities [10684](https://github.com/helidon-io/helidon/pull/10684)
- Testing: io.helidon.microprofile.testing.AddConfig* do not require a reset [10583](https://github.com/helidon-io/helidon/pull/10583)
- Testing: JUnit5 testing module is now marked as `open`, so we can run test on module path [10661](https://github.com/helidon-io/helidon/pull/10661)
...
- WebClient: Full debugging possible for HTTP client requests [10231](https://github.com/helidon-io/helidon/pull/10231)
- WebClient: Read timeout deprecated in the ConnectionKey [10353](https://github.com/helidon-io/helidon/pull/10353)
- WebClient: SecurityEnvironment query propagation [10213](https://github.com/helidon-io/helidon/pull/10213)
- WebServer: Add header to metrics, health, OpenAPI, info, and config output to discourage browsers from sniffing data to infer the content type [10116](https://github.com/helidon-io/helidon/pull/10116)
- WebServer: Add tracing support to concurrenty limits [10189](https://github.com/helidon-io/helidon/pull/10189)
- WebServer: Adds support for JSON-RPC client and server APIs [10244](https://github.com/helidon-io/helidon/pull/10244)
...
- WebServer: Ensure exception is not lost if thrown after data was written and there is an exception handler [10675](https://github.com/helidon-io/helidon/pull/10675)
- WebServer: Error handling no longer resets headers on response [10581](https://github.com/helidon-io/helidon/pull/10581)
- WebServer: Fix 10124 UnknownFormatConversionException in log statement [10211](https://github.com/helidon-io/helidon/pull/10211)
- WebServer: Fix content type handling in server request headers. [10191](https://github.com/helidon-io/helidon/pull/10191)
- WebServer: Fix for #10154 Graceful shutdown [10158](https://github.com/helidon-io/helidon/pull/10158)
- WebServer: Optimizations on hot path of the webserver [10621](https://github.com/helidon-io/helidon/pull/10621)
- WebServer: Path pattern fix for WebServer [10162](https://github.com/helidon-io/helidon/pull/10162)
- WebServer: Provides access to matching pattern in ServerRequest [10032](https://github.com/helidon-io/helidon/pull/10032)
- WebServer: route can match based on request headers [10070](https://github.com/helidon-io/helidon/pull/10070)
- WebServer: Shutdown services in reverse order (fixes issue #10239) [10240](https://github.com/helidon-io/helidon/pull/10240)
- WebServer: Shutdown services in reverse order when using `Weight` (fixes issue #10267) [10268](https://github.com/helidon-io/helidon/pull/10268)
- WebServer: Static content service a single resource from classpath [10558](https://github.com/helidon-io/helidon/pull/10558)
- WebServer: Use ofNullable for matching pattern [10054](https://github.com/helidon-io/helidon/pull/10054)
- WebServer: Validate that a webserver filter behaves correctly, throw an exception if not [10703](https://github.com/helidon-io/helidon/pull/10703)
- WebServer: Validate that named routing has an existing named listener. [10087](https://github.com/helidon-io/helidon/pull/10087)
...
- Build: Add checkstyle rules to forbid `assert` keyword and fixme/todo comments [10067](https://github.com/helidon-io/helidon/pull/10067)
- Build: Add project names to langchain4j modules. Add urls to application poms. [10182](https://github.com/helidon-io/helidon/pull/10182)
...
- Build: Increase Linux runner free disk space [10043](https://github.com/helidon-io/helidon/pull/10043)
- Build: Metadata module and loading of files compatible with single jars [10660](https://github.com/helidon-io/helidon/pull/10660)
- Build: migrate release workflow to use Central Publishing Portal [10114](https://github.com/helidon-io/helidon/pull/10114)
- Build: Pipeline - Run build and test on latest stable java version [9892](https://github.com/helidon-io/helidon/pull/9892)
- Build: Update cache-config.xml [10319](https://github.com/helidon-io/helidon/pull/10319)
- Cleanup: Remove unused class EWMA [10480](https://github.com/helidon-io/helidon/pull/10480)
- Cleanup: Remove unused class InterceptorBase and his subclass [10495](https://github.com/helidon-io/helidon/pull/10495)
...
- Cleanup: Remove unused classes from webclient/http2 [10568](https://github.com/helidon-io/helidon/pull/10568)
- Cleanup: Remove unused code from HelidonGauge and MetricStore [10316](https://github.com/helidon-io/helidon/pull/10316)
- Cleanup: Remove unused code from io.helidon.metrics.providers.micrometer.MMeter [10281](https://github.com/helidon-io/helidon/pull/10281)
- Cleanup: Removed unnecessary modifier protected of utility methods in SchemaGeneratorHelper [10309](https://github.com/helidon-io/helidon/pull/10309)
- Cleanup: Removed unused classes from microprofile/metrics [10405](https://github.com/helidon-io/helidon/pull/10405)
- Cleanup: Removed unused code from FaultToleranceMetrics [10308](https://github.com/helidon-io/helidon/pull/10308)
- Dependencies: Add helidon-data-codegen to helidon-bundles-apt [10566](https://github.com/helidon-io/helidon/pull/10566)
- Dependencies: Adopt Micrometer 1.15.2 [10451](https://github.com/helidon-io/helidon/pull/10451)
- Dependencies: Align ojdbc version [10692](https://github.com/helidon-io/helidon/pull/10692)
- Dependencies: Bump com.oracle.oci.sdk:oci-java-sdk-bom from 3.72.0 to 3.73.1 in /dependencies [10695](https://github.com/helidon-io/helidon/pull/10695)
- Dependencies: Bump up lc4j to 1.3.0 [10567](https://github.com/helidon-io/helidon/pull/10567)
- Dependencies: Bump-up lc4j 1.3.0 -> 1.5.0 [10683](https://github.com/helidon-io/helidon/pull/10683)
- Dependencies: commons lang 3.18.0 [10387](https://github.com/helidon-io/helidon/pull/10387)
- Dependencies: Force upgrade jinjava fourth party dependency to 2.8.1 [10689](https://github.com/helidon-io/helidon/pull/10689)
- Dependencies: Micro Upgrades to microprofile lra, reactive messaging, reactive operators [10436](https://github.com/helidon-io/helidon/pull/10436)
- Dependencies: Update Jakarta EL implementation to org.glassfish.expressly:expressly:5.0.0 [10378](https://github.com/helidon-io/helidon/pull/10378)
- Dependencies: Update jandex-maven-plugin version to match that of jandex lib [10178](https://github.com/helidon-io/helidon/pull/10178)
- Dependencies: Update MP OpenAPI to 3.1.2 [10076](https://github.com/helidon-io/helidon/pull/10076)
- Dependencies: Update to Jandex 3.3.0 [10080](https://github.com/helidon-io/helidon/pull/10080)
- Dependencies: Upgrade eclipselink to 4.0.7 [10287](https://github.com/helidon-io/helidon/pull/10287)
- Dependencies: Upgrade google-api-java-client to 2.7.2 and address dep convergence [10019](https://github.com/helidon-io/helidon/pull/10019)
- Dependencies: Upgrade gson to 2.13.1 [10407](https://github.com/helidon-io/helidon/pull/10407)
...
- Dependencies: Upgrade netty to 4.1.126.Final [10644](https://github.com/helidon-io/helidon/pull/10644)
...
- Docs: describes interaction HelidonTest with MicroProfile Config profiles (#8849) [10306](https://github.com/helidon-io/helidon/pull/10306)
...
- Docs: Fix typo in webserver docs [10061](https://github.com/helidon-io/helidon/pull/10061)
- Docs: fixes typo in REST.request configuration option [10173](https://github.com/helidon-io/helidon/pull/10173)
- Docs: Helidon Data docs [10534](https://github.com/helidon-io/helidon/pull/10534)
...
- Docs: Initial documentation for Helidon Declarative [10691](https://github.com/helidon-io/helidon/pull/10691)
...
- Docs: Lc4j doc update [10674](https://github.com/helidon-io/helidon/pull/10674)
- Docs: Recommend Java 25 [10681](https://github.com/helidon-io/helidon/pull/10681)
- Docs: Remove asciidoc collapsible as it's unsupported [10269](https://github.com/helidon-io/helidon/pull/10269)
- Docs: specify version of gen ai metrics specs [10613](https://github.com/helidon-io/helidon/pull/10613)
- Docs: Top-level bullets for AI in the docs [10693](https://github.com/helidon-io/helidon/pull/10693)
...
- Docs: Updates class comment dropping remark about interal use only [10351](https://github.com/helidon-io/helidon/pull/10351)
- Docs: Updates to gRPC documentation [10108](https://github.com/helidon-io/helidon/pull/10108)
- Tests: Disable only the slowest test in FileSystemWatcherTest [9682](https://github.com/helidon-io/helidon/pull/9682)
...
- Tests: Fix test problems with REST client metrics; also fix lack of support for on-demand registration of REST client metrics [10274](https://github.com/helidon-io/helidon/pull/10274)
- Tests: Fixes a timing issue in EurekaDiscoveryIT.java [10574](https://github.com/helidon-io/helidon/pull/10574)
- Tests: Insulate metrics update test from possible timing issues [10288](https://github.com/helidon-io/helidon/pull/10288)
...
- Builders: Fix usage of types with static builder method that does not return Builder class [9953](https://github.com/helidon-io/helidon/pull/9953)
- Config: Make sure Config.asMap() returns all nodes with values [9876](https://github.com/helidon-io/helidon/pull/9876)
- CORS: Encode paths before using `UriPath` in preparing `CrossOriginConfigMatchable` [9982](https://github.com/helidon-io/helidon/pull/9982)
- DBClient: Update DB Column to support null values correctly. [10005](https://github.com/helidon-io/helidon/pull/10005)
- JAX-RS: Adds config flag to disable header copying in JaxRsService [9990](https://github.com/helidon-io/helidon/pull/9990)
- Metrics: Apply config setting for built-in meter name case to extended KPI meter names [9800](https://github.com/helidon-io/helidon/pull/9800)
- Metrics: Use `Timer` base units to format `Timer#toString` and JSON output [9980](https://github.com/helidon-io/helidon/pull/9980)
- Metrics: Tolerate if `PostRequestMetricsSupport` is missing from request context [10010](https://github.com/helidon-io/helidon/pull/10010)
- Rest Client: Connector configuration improvements [9891](https://github.com/helidon-io/helidon/pull/9891)
- Security: OIDC Certificate bound access token [9922](https://github.com/helidon-io/helidon/pull/9922)
- Service Registry: Make sure service registry manager start works with empty binding [9852](https://github.com/helidon-io/helidon/pull/9852)
- Services Registry: Use runtime dependencies in Service Maven Plugin [9868](https://github.com/helidon-io/helidon/pull/9868)
- Tracing: Fix problems in tracing with headers that appear multiple times in an incoming request [9924](https://github.com/helidon-io/helidon/pull/9924)
- WebClient: Adds configurable buffering support to TcpClientConnection [9893](https://github.com/helidon-io/helidon/pull/9893)
- WebServer: Accepts colon ':' as a valid character in a URI as mandated by RFC 3986 [9864](https://github.com/helidon-io/helidon/pull/9864)
- WebServer: Adds support for new request processing event called beforeTrailers [9931](https://github.com/helidon-io/helidon/pull/9931)
- WebServer: Allow user error handling of `BadRequestException` when thrown from routing [9972](https://github.com/helidon-io/helidon/pull/9972)
- WebServer: Fix static content handling, where jar file was closed when it should… [9943](https://github.com/helidon-io/helidon/pull/9943)
- WebServer: H2 with IPv6 URI fix #9590 [9961](https://github.com/helidon-io/helidon/pull/9961)
- WebServer: Make `StaticContentFeature` weight mutable [9952](https://github.com/helidon-io/helidon/pull/9952)
- WebServer: Support Jersey on Helidon SE WebServer [9985](https://github.com/helidon-io/helidon/pull/9985)
- WebServer: Update path matchers to honor quantifiers in Regular expressions [9976](https://github.com/helidon-io/helidon/pull/9976)
- Archetypes: Update Coherence version to 25.03 [9983](https://github.com/helidon-io/helidon/pull/9983)
- Build: Update all module to be compilable and testable with Java 24. [9865](https://github.com/helidon-io/helidon/pull/9865)
- Cleanup: Remove unnecessary check in BiConsumerChain [9803](https://github.com/helidon-io/helidon/pull/9803)
- Cleanup: Remove unused class io.helidon.dbclient.jdbc.JdbcClientServiceContext [9926](https://github.com/helidon-io/helidon/pull/9926)
- Cleanup: Remove unused code from io.helidon.codegen.classmodel.Type [9874](https://github.com/helidon-io/helidon/pull/9874)
- Config: Ensures that Helidon does not violate the CDI specification by implementing jakarta.enterprise.inject.Instance or jakarta.inject.Provider [10017](https://github.com/helidon-io/helidon/pull/10017)
- Dependencies: Bump com.oracle.oci.sdk:oci-java-sdk-bom from 3.62.0 to 3.62.1 in /dependencies [9975](https://github.com/helidon-io/helidon/pull/9975)
- Dependencies: Upgrade byte-buddy to 1.17.5 and asm to 9.8 for Java 25 support [9964](https://github.com/helidon-io/helidon/pull/9964)
- Dependencies: Upgrade langchain4j to 0.36.2 [9954](https://github.com/helidon-io/helidon/pull/9954)
- Dependencies: Upgrade neo4j driver to 5.28.3 [9895](https://github.com/helidon-io/helidon/pull/9895)
- Dependencies: Upgrade parsson to 1.1.7 [9996](https://github.com/helidon-io/helidon/pull/9996)
- Deprecation of Microstream modules. [9871](https://github.com/helidon-io/helidon/pull/9871)
- Docs: Add docs about ability to use HelidonTest in a meta-annotation (#9944) [9978](https://github.com/helidon-io/helidon/pull/9978)
- Docs: Add Note for Preview features [9878](https://github.com/helidon-io/helidon/pull/9878)
- Docs: Broken doc link #9366 [9937](https://github.com/helidon-io/helidon/pull/9937)
- Docs: Clarifies configuration of concurrency limits [9917](https://github.com/helidon-io/helidon/pull/9917)
- Docs: Clarifies that FT metrics can only be enabled programmatically  [9916](https://github.com/helidon-io/helidon/pull/9916)
- Docs: Clarify docs about built-in healthchecks and Graal VM (#9021) [9807](https://github.com/helidon-io/helidon/pull/9807)
- Docs: Fix messaging documentation snippets (#9856) [9919](https://github.com/helidon-io/helidon/pull/9919)
- Docs: Minor change in the docs [9404](https://github.com/helidon-io/helidon/pull/9404)
- Docs: Revise OpenAPI doc page for controlling OpenAPI behavior [9977](https://github.com/helidon-io/helidon/pull/9977)
- Test: Adding missing test for OracleEmbeddingStoreConfig [9963](https://github.com/helidon-io/helidon/pull/9963)
- Test: Fixes race condition in BeforeTrailersTest [9984](https://github.com/helidon-io/helidon/pull/9984)
- Test: Make MP test annotations ordering deterministic [9904](https://github.com/helidon-io/helidon/pull/9904)
- Test: New gRPC test that uses the repeated keyword [9880](https://github.com/helidon-io/helidon/pull/9880)
- Test: Restore existing configuration on test container close [9988](https://github.com/helidon-io/helidon/pull/9988)
...
- AI: Langchain4j integration [9733](https://github.com/helidon-io/helidon/pull/9733)
- AI: Add support for Ollama Langchain4j models [9749](https://github.com/helidon-io/helidon/pull/9749)
- AI: Langchain4j - adds support for Langchain4j Cohere provider. [9753](https://github.com/helidon-io/helidon/pull/9753)
- AI: Removed max retries from OpenAI streaming chat model [9767](https://github.com/helidon-io/helidon/pull/9767)
- CORS: CORS support helper change log level. [9846](https://github.com/helidon-io/helidon/pull/9846)
- Config: Deprecation of old config options now replaced by SocketOptions [9709](https://github.com/helidon-io/helidon/pull/9709)
- Config: Meta-configuration fixes [9233](https://github.com/helidon-io/helidon/pull/9233)
- Config: Use Helidon gRPC client in Config Etcd module [9674](https://github.com/helidon-io/helidon/pull/9674)
- Config: Use newly defined exception to report problems while processing meta config [9390](https://github.com/helidon-io/helidon/pull/9390)
- Config: Fix empty config values propagation #9506 [9750](https://github.com/helidon-io/helidon/pull/9750)
- CRaC support [9643](https://github.com/helidon-io/helidon/pull/9643)
- Cleanup: Remove unused code from ResourceUtil [9779](https://github.com/helidon-io/helidon/pull/9779)
- Fault Tolerance: Metrics support for FT SE [9654](https://github.com/helidon-io/helidon/pull/9654)
- Health: Restore setting of no-cache header in health HTTP responses; add test [9671](https://github.com/helidon-io/helidon/pull/9671)
- Health: fix status from deadlock health check if invoking the MBean fails [9694](https://github.com/helidon-io/helidon/pull/9694)
- Inject: Helidon inject collateral 5 [9244](https://github.com/helidon-io/helidon/pull/9244)
- Inject: Inject fixes [9515](https://github.com/helidon-io/helidon/pull/9515)
- Inject: Introduction of Helidon Service Inject. [9249](https://github.com/helidon-io/helidon/pull/9249)
- Inject: Maven plugin for Helidon Service Inject [9461](https://github.com/helidon-io/helidon/pull/9461)
- Inject: Only generate scope constants for custom scopes. [9504](https://github.com/helidon-io/helidon/pull/9504)
- Inject: Remove deprecated Helidon Inject [9642](https://github.com/helidon-io/helidon/pull/9642)
- Inject: Support for service lifecycle [9198](https://github.com/helidon-io/helidon/pull/9198)
- Inject: Custom main class support for Helidon Inject with full ApplicationBinding [9840](https://github.com/helidon-io/helidon/pull/9840)
- Integration: Fix Micronaut integration [8230](https://github.com/helidon-io/helidon/pull/8230)
- JAX-RS: Have JaxRsService save response headers and, if Jersey does not handle the request, restore the saved headers [9683](https://github.com/helidon-io/helidon/pull/9683)
- JAX-RS: Makes ApplicationPath a bean defining annotation [9582](https://github.com/helidon-io/helidon/pull/9582)
- Logging: Fixes apparent omission of String.format calls in Http1ConnectionCache.java [9797](https://github.com/helidon-io/helidon/pull/9797)
- MP RestClient: Add MP metrics annotation support to MP REST clients [9534](https://github.com/helidon-io/helidon/pull/9534)
- MP RestClient: Fix possible NPE if user code creates a REST client 'early' [9554](https://github.com/helidon-io/helidon/pull/9554)
- Media: Faster Jackson default settings [9335](https://github.com/helidon-io/helidon/pull/9335)
- Media: Support for application/json-patch+json media type [9684](https://github.com/helidon-io/helidon/pull/9684)
- Metrics: Add ability for users to configure settings related to virtual threads meters [9653](https://github.com/helidon-io/helidon/pull/9653)
- Metrics: Add metrics related to virtual threads [9619](https://github.com/helidon-io/helidon/pull/9619)
- Metrics: Allow colon in Prometheus meter name; add test [9689](https://github.com/helidon-io/helidon/pull/9689)
- Metrics: Change virtual threads metrics default to disabled; remove count-leve enable/disable; update tests and doc [9701](https://github.com/helidon-io/helidon/pull/9701)
- Metrics: Close recording stream on shutdown [9705](https://github.com/helidon-io/helidon/pull/9705)
- Metrics: fix pinned meter type [9657](https://github.com/helidon-io/helidon/pull/9657)
- Metrics: metrics app name tag fix [9665](https://github.com/helidon-io/helidon/pull/9665)
- MicroProfile: silence jersey warnings [9613](https://github.com/helidon-io/helidon/pull/9613)
- Native image: Add additional eclipselink native image configuration [9382](https://github.com/helidon-io/helidon/pull/9382)
- Native image: Add additional postgresql + hibernate native-image configuration [9393](https://github.com/helidon-io/helidon/pull/9393)
- Performance: Optimize compareNotNull and compareNotNullSigned Methods in BitsSubstitution Class [9379](https://github.com/helidon-io/helidon/pull/9379)
- Scheduling: Replace deprecated method Scheduling.fixedRateBuilder() on Scheduling.fixedRate() in CoordinatorService [9458](https://github.com/helidon-io/helidon/pull/9458)
- Security: JWT module description changed [9405](https://github.com/helidon-io/helidon/pull/9405)
- Security: Policy statement method matching added [9501](https://github.com/helidon-io/helidon/pull/9501)
- Service Registry: Fix for external delegates. [9810](https://github.com/helidon-io/helidon/pull/9810)
- Service Registry: Registry services factory fix [9768](https://github.com/helidon-io/helidon/pull/9768)
- Service Registry: Remove GlobalServiceRegistry context qualifier constants [9827](https://github.com/helidon-io/helidon/pull/9827)
- Testing: Ability to use HelidonTest in a meta-annotation #4918 [8759](https://github.com/helidon-io/helidon/pull/8759)
- Testing: Fix MockBean to work with argument matchers [9398](https://github.com/helidon-io/helidon/pull/9398)
- Testing: Improved Helidon MP testing [9695](https://github.com/helidon-io/helidon/pull/9695)
- Testing: Integrate pinning detection to @HelidonTest [9593](https://github.com/helidon-io/helidon/pull/9593)
- Testing: MicroProfile Testing AddConfigSource annotation [9743](https://github.com/helidon-io/helidon/pull/9743)
- Tracing: Fix warning message; add test [9631](https://github.com/helidon-io/helidon/pull/9631)
- Tracing: Support for callback-enabled OTel types [9718](https://github.com/helidon-io/helidon/pull/9718)
- Tracing: fix span nesting in filter [9788](https://github.com/helidon-io/helidon/pull/9788)
- WebClient: Make ClientRequestBase mock friendly [9281](https://github.com/helidon-io/helidon/pull/9281)
- WebClient: WebClient optional reason phrase #9646 [9647](https://github.com/helidon-io/helidon/pull/9647)
- WebClient: Combines prologue and headers into a single write in WebClient [9842](https://github.com/helidon-io/helidon/pull/9842)
- WebServer: Gracefully reject HTTP 1.0 connections  [9715](https://github.com/helidon-io/helidon/pull/9715)
- WebServer: Update to static content [9502](https://github.com/helidon-io/helidon/pull/9502)
- WebServer: Adds afterStart(WebServer) implementations to various delegating ServerLifecycle implementations that were missing it [9820](https://github.com/helidon-io/helidon/pull/9820)
- WebServer: Adds an afterStart pseudo-event to LoomServer observable by Router implementations [9655](https://github.com/helidon-io/helidon/pull/9655
- WebServer: Config to prevent reflection of user input when reporting errors [9811](https://github.com/helidon-io/helidon/pull/9811)
- WebServer: Enhancements to support queue with AIMD and new metrics [9605](https://github.com/helidon-io/helidon/pull/9605)
- WebServer: Improves handling of cookies in server responses [9751](https://github.com/helidon-io/helidon/pull/9751)
- WebServer: Introduces EurekaRegistrationFeature [9789](https://github.com/helidon-io/helidon/pull/9789)
- Archetypes: Remove Verrazzano option from archetype [9829](https://github.com/helidon-io/helidon/pull/9829)
- Archetypes: archetype - Fixes code format in generated files [9847](https://github.com/helidon-io/helidon/pull/9847)
- Archetypes: archetype - Update Helidon console handler [9830](https://github.com/helidon-io/helidon/pull/9830)
- Archetypes: archetypes: add coherence caching option [9824](https://github.com/helidon-io/helidon/pull/9824)
- Build: Add Windows OS Github Worflow [7227](https://github.com/helidon-io/helidon/pull/7227)
- Build: Add new `helidon-microprofile-rest-client-metrics` component to all/pom.xml [9556](https://github.com/helidon-io/helidon/pull/9556)
- Build: Add smoke tests to release workflow [9236](https://github.com/helidon-io/helidon/pull/9236)
- Build: Get annotation processing going with Eclipse Compiler for Java [8913](https://github.com/helidon-io/helidon/pull/8913)
- Build: Rename MAVEN_ARGS to MVN_ARGS [9660](https://github.com/helidon-io/helidon/pull/9660)
- Build: Replace ${helidon.version} with ${project.version} in service/tests poms [9692](https://github.com/helidon-io/helidon/pull/9692)
- Build: Lc4j integration - added missing bom pom and all pom entries. [9752](https://github.com/helidon-io/helidon/pull/9752)
- Build: Uptake Helidon Build Tools v4.0.16 [9844](https://github.com/helidon-io/helidon/pull/9844)
- Cleanup: Remove duplicated methods from CustomScalars [9474](https://github.com/helidon-io/helidon/pull/9474)
- Cleanup: Remove unnecessary logging from HoconMpConfigIncluder [9223](https://github.com/helidon-io/helidon/pull/9223)
- Cleanup: Remove unused code from  ClasspathSourceHelper [9611](https://github.com/helidon-io/helidon/pull/9611)
- Cleanup: Remove unused code from  ConfigAsciidocGenerator [9617](https://github.com/helidon-io/helidon/pull/9617)
- Cleanup: Remove unused code from  EncryptionUtil [9608](https://github.com/helidon-io/helidon/pull/9608)
- Cleanup: Remove unused code from SystemTagsManagerImpl [9532](https://github.com/helidon-io/helidon/pull/9532)
- Cleanup: Remove unused code from io.helidon.http.Utils [9623](https://github.com/helidon-io/helidon/pull/9623)
- Cleanup: Remove unused method ConfigMapperManager.mapper [9622](https://github.com/helidon-io/helidon/pull/9622)
- Cleanup: Remove unused method NativeUtil.findResources [9580](https://github.com/helidon-io/helidon/pull/9580)
- Cleanup: Remove unused methods 'produce' and 'dispose' from PersistenceExtension.ReferenceCountingProducer [8872](https://github.com/helidon-io/helidon/pull/8872)
- Cleanup: Remove unused private static classes from io.helidon.config.BuilderImpl [9197](https://github.com/helidon-io/helidon/pull/9197)
- Cleanup: Remove workaround for Parsson unicode detection issue (#8260) [9472](https://github.com/helidon-io/helidon/pull/9472)
- Cleanup: Replace manual casts on pattern with instanceof in helidon/config modules [9230](https://github.com/helidon-io/helidon/pull/9230)
- Cleanup: Replace manual casts on pattern with instanceof in helidon/messaging modules [9242](https://github.com/helidon-io/helidon/pull/9242)
- Cleanup: Replace manual casts on pattern with instanceof in yaml config modules [9427](https://github.com/helidon-io/helidon/pull/9427)
- Dependencies: Bump com.oracle.oci.sdk:oci-java-sdk-bom from 3.55.3 to 3.56.0 in /dependencies [9720](https://github.com/helidon-io/helidon/pull/9720)
- Dependencies: Bump commons-io:commons-io from 2.11.0 to 2.14.0 [9319](https://github.com/helidon-io/helidon/pull/9319)
- Dependencies: Don't manage logback version. Use slf4j-bom. [9649](https://github.com/helidon-io/helidon/pull/9649)
- Dependencies: Update Micrometer Prometheus release [9225](https://github.com/helidon-io/helidon/pull/9225)
- Dependencies: Upgrade Jersey to 3.1.10 [9641](https://github.com/helidon-io/helidon/pull/9641)
- Dependencies: Bump com.oracle.oci.sdk:oci-java-sdk-bom from 3.57.1 to 3.57.2 in /dependencies [9823](https://github.com/helidon-io/helidon/pull/9823)
- Dependencies: Upgrade snakeyaml to 2.4 [9838](https://github.com/helidon-io/helidon/pull/9838)
- Docs: Add documentation for server.base-path [9677](https://github.com/helidon-io/helidon/pull/9677)
- Docs: Add jsonb dependency to migration guide [9512](https://github.com/helidon-io/helidon/pull/9512)
- Docs: Add missing dependencies from OIDC guides [9478](https://github.com/helidon-io/helidon/pull/9478)
- Docs: Do not use --short with kubectl version [9614](https://github.com/helidon-io/helidon/pull/9614)
- Docs: Document ServerLifecycle beforeStart and afterStop [9629](https://github.com/helidon-io/helidon/pull/9629)
- Docs: Enhance metrics doc and Javadoc on Helidon metrics API types [9635](https://github.com/helidon-io/helidon/pull/9635)
- Docs: Expand Jandex indexing discussion and link to new example [9419](https://github.com/helidon-io/helidon/pull/9419)
- Docs: Fix MP OIDC guide configuration [9543](https://github.com/helidon-io/helidon/pull/9543)
- Docs: Fix formatting [9621](https://github.com/helidon-io/helidon/pull/9621)
- Docs: Fix typo @Provided -> @Provider in jaxrs-applications.adoc [9632](https://github.com/helidon-io/helidon/pull/9632)
- Docs: Fix typo in jbatch documentation [9537](https://github.com/helidon-io/helidon/pull/9537)
- Docs: Fixes a link in MP Config documentation [9637](https://github.com/helidon-io/helidon/pull/9637)
- Docs: Remove note stating that webclient is experimental [9714](https://github.com/helidon-io/helidon/pull/9714)
- Docs: Replace deprecated VM memory flags in docs for building container images (#8876) [9479](https://github.com/helidon-io/helidon/pull/9479)
- Docs: Updates to builder documentation. [9487](https://github.com/helidon-io/helidon/pull/9487)
- Docs: Add more javadoc for AddConfigBlock annotations (#9697) [9761](https://github.com/helidon-io/helidon/pull/9761)
- Docs: Adds new sections that describe direct handlers in docs [9836](https://github.com/helidon-io/helidon/pull/9836)
- Docs: Helidon Builder docs [9544](https://github.com/helidon-io/helidon/pull/9544)
- Docs: Helidon Inject documentation [9742](https://github.com/helidon-io/helidon/pull/9742)
- Docs: Javadoc update [9792](https://github.com/helidon-io/helidon/pull/9792)
- Docs: LangChain4J documentation [9802](https://github.com/helidon-io/helidon/pull/9802)
- Docs: New doc describing the concurrency limit support in webserver [9725](https://github.com/helidon-io/helidon/pull/9725)
- Docs: Update instructions for generation docs in README.md (#9759) [9760](https://github.com/helidon-io/helidon/pull/9760)
- Docs: improvement of generated config docs from blueprints [9809](https://github.com/helidon-io/helidon/pull/9809)
- Tests: Add metrics tests for disabling using config [9310](https://github.com/helidon-io/helidon/pull/9310)
- Tests: Add unit tests for BitsSubstitution class [9416](https://github.com/helidon-io/helidon/pull/9416)
- Tests: Adds test in jpa-cdi to prove that application- and container-managed EntityManagers can co-exist [9145](https://github.com/helidon-io/helidon/pull/9145)
- Tests: Fixes unresolved dependency issue with TestApplicationAndContainerManagedInjections [9318](https://github.com/helidon-io/helidon/pull/9318)
- Tests: Global Service Registry support in tests [9656](https://github.com/helidon-io/helidon/pull/9656)
- Tests: JPA testing-related improvements [9131](https://github.com/helidon-io/helidon/pull/9131)
- Tests: Refactor assertions to use `assertThat` with appropriate matchers [9503](https://github.com/helidon-io/helidon/pull/9503)
...
- Config: Use replace instead of replaceAll for string replacement  [9464](https://github.com/helidon-io/helidon/pull/9464)
- WebServer: Attempt to fix infinite await in Jersey output writer [9468](https://github.com/helidon-io/helidon/pull/9468)
- WebServer: URI Validation updates [9476](https://github.com/helidon-io/helidon/pull/9476)
- Dependencies: Adopt MP metrics 5.1.2  [9463](https://github.com/helidon-io/helidon/pull/9463)
- Dependencies: Update jackson to 2.18.1 [9467](https://github.com/helidon-io/helidon/pull/9467)
- Docs: Adds documentation for gRPC Client in SE.  [9462](https://github.com/helidon-io/helidon/pull/9462)
- Docs: Adds link to config table for gRPC protocol and to example.  [9465](https://github.com/helidon-io/helidon/pull/9465)
- Docs: Fix doc bug about configuring metrics or health alternate port (#9438) [9457](https://github.com/helidon-io/helidon/pull/9457)
- Examples: clean up warning messages from archetype generated projects  [9466](https://github.com/helidon-io/helidon/pull/9466)
