...
- WebServer: HTTP/2 Locally half-closed streams needs to be able to receive frames [7499](https://github.com/helidon-io/helidon/pull/7499)
- WebServer: HTTP/2 Unconsumed entity [7466](https://github.com/helidon-io/helidon/pull/7466)
...
- WebClient: Client URL scheme validation #6547 [7475](https://github.com/helidon-io/helidon/pull/7475)
...
- Tracing: Simple to Batch Span exporter [7418](https://github.com/helidon-io/helidon/pull/7418)
...
- Security: Fix get in evictable cache, as it did not update last accessed timestamp [7422](https://github.com/helidon-io/helidon/pull/7422)
- Security: Fix google-login behind proxy [7472](https://github.com/helidon-io/helidon/pull/7472)
...
- OCI: Introduces Lazy OCI Vault ConfigSource [7470](https://github.com/helidon-io/helidon/pull/7470)
- OCI: Makes SecretBundleConfigSource public; improves modification logic [7421](https://github.com/helidon-io/helidon/pull/7421)
- Metrics: Initial commit of neutral metrics API with high-level interfaces; more to come [7261](https://github.com/helidon-io/helidon/pull/7261)
- Media: Header and Media type API consistency [7351](https://github.com/helidon-io/helidon/pull/7351)
- JPA/JTA: Forward ports all 3.x JDBC/JPA/JTA work [7437](https://github.com/helidon-io/helidon/pull/7437)
...
- DBClient: DB client JDBC connection pool separated to a standalone module. [7265](https://github.com/helidon-io/helidon/pull/7265)
...
- Common: Update module-info [7037](https://github.com/helidon-io/helidon/pull/7037)
- Config: Fix SeConfig.asMap to not truncate keys [7494](https://github.com/helidon-io/helidon/pull/7494)
...
- Tests: Fix tracing test [7489](https://github.com/helidon-io/helidon/pull/7489)
- Tests: Tests to validate requested URI is correctly used with IPv6 [7480](https://github.com/helidon-io/helidon/pull/7480)
...
- Examples: Refactor TODO app examples to not use NodeJS/NPM [7471](https://github.com/helidon-io/helidon/pull/7471)
- Examples: small archetype issues [7459](https://github.com/helidon-io/helidon/pull/7459)
...
- Docs: Remove description of Config.changes() API and other cleanup [7501](https://github.com/helidon-io/helidon/pull/7501)
- Docs: Update version numbers and prereqs for 4x [7504](https://github.com/helidon-io/helidon/pull/7504)
...
[4.0.0-M2]: https://github.com/oracle/helidon/compare/4.0.0-ALPHA6...4.0.0-M2
