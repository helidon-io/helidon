...
public class HealthCheckIT {
    ...
    public void testHealthCheckWithCustomNamedDML() {
        if (!pingDml) {
            LOGGER.log(System.Logger.Level.DEBUG, () -> String.format("Database %s does not support DML ping, skipping this test", DB_CLIENT.dbType()));
            return;
        }
    ...
    public void testHealthCheckWithCustomDML() {
        ...
        LOGGER.log(System.Logger.Level.DEBUG, () -> String.format("Using db.statements.ping-dml value %s", statement));
    ...
    public void testHealthCheckWithCustomQuery() {
        ...
        LOGGER.log(System.Logger.Level.DEBUG, () -> String.format("Using db.statements.ping-query value %s", statement));
