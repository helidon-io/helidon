...
public class CheckIT {
        ...
        public void accept(Config config) {
            ...
            while (true) {
                try {
                    ...
                    LOGGER.log(System.Logger.Level.DEBUG, () -> String.format("Connection check: %s", ex.getMessage()), ex);
    ...
    /**
     * Store database connection configuration and build {@link java.sql.Connection} instance.
     */
    ...
    public void testDmlStatementExecution() throws SQLException {
        ...
        try (Connection conn = builder.createConnection()) {
            if (pingDml) {
                ...
                LOGGER.log(System.Logger.Level.DEBUG, () -> String.format("Command ping result: %d", result));
            } else {
