...
/**
 * Executes the shared imperative transaction contract against PostgreSQL.
 */
@Testcontainers(disabledWithoutDocker = true)
class PostgreSqlImperativeJdbcTransactionTest extends AbstractJdbcTransactionContract {
    @Container
