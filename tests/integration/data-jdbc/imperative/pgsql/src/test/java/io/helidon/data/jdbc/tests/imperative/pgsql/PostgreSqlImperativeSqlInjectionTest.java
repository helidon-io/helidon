...
/**
 * Executes the shared SQL-injection contract through imperative PostgreSQL operations.
 */
@Testcontainers(disabledWithoutDocker = true)
class PostgreSqlImperativeSqlInjectionTest extends AbstractJdbcSqlInjectionContract {
    @Container
