...
/**
 * Executes the shared SQL-injection contract through imperative H2 operations.
 */
class H2ImperativeSqlInjectionTest extends AbstractJdbcSqlInjectionContract {
    @Override
