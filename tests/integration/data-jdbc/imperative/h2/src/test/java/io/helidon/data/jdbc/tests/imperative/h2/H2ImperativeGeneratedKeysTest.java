...
/**
 * Executes the shared generated-key contract through imperative H2 operations.
 */
class H2ImperativeGeneratedKeysTest extends AbstractJdbcGeneratedKeysContract {
    @Override
