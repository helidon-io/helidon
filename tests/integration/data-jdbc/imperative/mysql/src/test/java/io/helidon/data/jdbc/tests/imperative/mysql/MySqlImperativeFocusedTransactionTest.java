...
/**
 * Executes focused imperative transaction behavior against MySQL.
 */
@Testcontainers(disabledWithoutDocker = true)
class MySqlImperativeFocusedTransactionTest extends AbstractJdbcFocusedTransactionContract {
    @Container
