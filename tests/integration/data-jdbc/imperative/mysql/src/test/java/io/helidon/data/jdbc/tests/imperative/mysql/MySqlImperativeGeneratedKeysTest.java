...
/**
 * Executes the shared generated-key contract through imperative MySQL operations.
 */
@Testcontainers(disabledWithoutDocker = true)
class MySqlImperativeGeneratedKeysTest extends AbstractJdbcGeneratedKeysContract {
    @Container
