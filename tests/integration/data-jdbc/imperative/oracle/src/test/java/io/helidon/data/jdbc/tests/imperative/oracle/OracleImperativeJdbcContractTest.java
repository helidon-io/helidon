...
/**
 * Executes the shared imperative application contract against Oracle Database.
 */
@Testcontainers(disabledWithoutDocker = true)
class OracleImperativeJdbcContractTest extends AbstractJdbcApplicationContract {
    @Container
    static final org.testcontainers.containers.GenericContainer<?> ORACLE = OracleImperativeTestSupport.ORACLE;
