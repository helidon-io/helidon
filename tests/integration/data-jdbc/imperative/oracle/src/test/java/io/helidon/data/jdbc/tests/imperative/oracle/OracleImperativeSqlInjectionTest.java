...
/**
 * Executes the shared SQL-injection contract through imperative Oracle operations.
 */
@Testcontainers(disabledWithoutDocker = true)
class OracleImperativeSqlInjectionTest extends AbstractJdbcSqlInjectionContract {
    @Container
