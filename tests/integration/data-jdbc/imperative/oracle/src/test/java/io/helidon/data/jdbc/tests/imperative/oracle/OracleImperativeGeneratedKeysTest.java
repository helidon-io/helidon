...
/**
 * Executes the shared generated-key contract through imperative Oracle operations.
 */
@Testcontainers(disabledWithoutDocker = true)
class OracleImperativeGeneratedKeysTest extends AbstractJdbcGeneratedKeysContract {
    @Container
