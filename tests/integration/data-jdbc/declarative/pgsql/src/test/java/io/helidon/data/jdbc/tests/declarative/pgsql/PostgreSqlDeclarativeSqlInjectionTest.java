...
/**
 * Executes the shared SQL-injection contract through declarative PostgreSQL operations.
 */
@Testcontainers(disabledWithoutDocker = true)
class PostgreSqlDeclarativeSqlInjectionTest extends AbstractJdbcSqlInjectionContract {
    @Container
