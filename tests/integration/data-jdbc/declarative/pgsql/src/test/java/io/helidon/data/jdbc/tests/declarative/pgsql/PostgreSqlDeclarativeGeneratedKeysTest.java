...
/**
 * Executes the shared generated-key contract through declarative PostgreSQL operations.
 */
@Testcontainers(disabledWithoutDocker = true)
class PostgreSqlDeclarativeGeneratedKeysTest extends AbstractJdbcGeneratedKeysContract {
    @Container
