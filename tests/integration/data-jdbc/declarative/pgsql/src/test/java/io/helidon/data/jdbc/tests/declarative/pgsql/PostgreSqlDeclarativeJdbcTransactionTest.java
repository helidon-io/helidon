...
/**
 * Executes the shared declarative transaction contract against PostgreSQL.
 */
@Testcontainers(disabledWithoutDocker = true)
class PostgreSqlDeclarativeJdbcTransactionTest extends AbstractJdbcTransactionContract {
    @Container
