...
/**
 * Executes the shared declarative application contract against PostgreSQL.
 */
@Testcontainers(disabledWithoutDocker = true)
class PostgreSqlDeclarativeJdbcContractTest extends AbstractJdbcApplicationContract {
    @Container
