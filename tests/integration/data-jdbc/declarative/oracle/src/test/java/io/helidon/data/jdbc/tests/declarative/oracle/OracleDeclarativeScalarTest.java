...
/**
 * Executes the generated scalar and typed-null contract against Oracle Database.
 */
@Testcontainers(disabledWithoutDocker = true)
class OracleDeclarativeScalarTest extends AbstractDeclarativeScalarContract {
    @Container
