...
/**
 * Executes the shared generated-key contract through declarative Oracle operations.
 */
@Testcontainers(disabledWithoutDocker = true)
class OracleDeclarativeGeneratedKeysTest extends AbstractJdbcGeneratedKeysContract {
    @Container
