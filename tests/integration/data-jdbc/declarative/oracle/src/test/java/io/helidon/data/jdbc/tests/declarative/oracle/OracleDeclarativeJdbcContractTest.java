...
/**
 * Executes the shared declarative application contract against Oracle Database.
 */
@Testcontainers(disabledWithoutDocker = true)
class OracleDeclarativeJdbcContractTest extends AbstractJdbcApplicationContract {
    @Container
