...
/**
 * Executes the shared generated-key contract through declarative H2 operations.
 */
class H2DeclarativeGeneratedKeysTest extends AbstractJdbcGeneratedKeysContract {
    @Override
