...
/**
 * Executes focused generated-repository transaction behavior against H2.
 */
class H2DeclarativeFocusedTransactionTest extends AbstractJdbcFocusedTransactionContract {
    @Override
