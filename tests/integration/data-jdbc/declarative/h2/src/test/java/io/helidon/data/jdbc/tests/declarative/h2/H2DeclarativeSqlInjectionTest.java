...
/**
 * Executes the shared SQL-injection contract through declarative H2 operations.
 */
class H2DeclarativeSqlInjectionTest extends AbstractJdbcSqlInjectionContract {
    @Override
