...
/**
 * Executes type-level generated-repository transaction behavior against H2.
 */
class H2DeclarativeTypeLevelTransactionTest extends AbstractJdbcTypeLevelTransactionContract {
    @Override
