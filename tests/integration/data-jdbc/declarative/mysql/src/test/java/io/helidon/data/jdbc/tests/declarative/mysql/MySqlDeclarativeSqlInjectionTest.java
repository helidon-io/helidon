...
/**
 * Executes the shared SQL-injection contract through declarative MySQL operations.
 */
@Testcontainers(disabledWithoutDocker = true)
class MySqlDeclarativeSqlInjectionTest extends AbstractJdbcSqlInjectionContract {
    @Container
