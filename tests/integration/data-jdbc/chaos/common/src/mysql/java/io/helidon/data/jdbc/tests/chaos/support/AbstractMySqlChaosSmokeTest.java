...
/**
 * Supplies MySQL-specific configuration and one-connection pool assertions for chaos smoke tests.
 */
public abstract class AbstractMySqlChaosSmokeTest extends AbstractJdbcChaosSmokeContract {
    @Container
    ...
    protected AutoCloseable beforeStartPooledApplication() {
        dataSource = ChaosMySqlDatabase.dataSource(MYSQL);
