...
/**
 * Supplies Oracle-specific configuration and one-connection pool assertions for chaos smoke tests.
 */
public abstract class AbstractOracleChaosSmokeTest extends AbstractJdbcChaosSmokeContract {
    @Container
    ...
    protected AutoCloseable beforeStartPooledApplication() {
        dataSource = ChaosOracleDatabase.dataSource(ORACLE);
