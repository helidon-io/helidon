...
/**
 * Runs PostgreSQL chaos smoke coverage through generated declarative repository operations.
 */
@Testcontainers(disabledWithoutDocker = true)
class PostgreSqlDeclarativeChaosSmokeTest extends AbstractPostgreSqlChaosSmokeTest {
    @Override
