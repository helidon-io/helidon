...
/**
 * Runs MySQL chaos smoke coverage through generated declarative repository operations.
 */
@Testcontainers(disabledWithoutDocker = true)
class MySqlDeclarativeChaosSmokeTest extends AbstractMySqlChaosSmokeTest {
    @Override
