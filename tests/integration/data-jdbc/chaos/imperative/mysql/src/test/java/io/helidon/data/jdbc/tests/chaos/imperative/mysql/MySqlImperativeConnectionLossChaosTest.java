...
/**
 * Runs native MySQL session loss through public imperative {@code JdbcClient} operations.
 */
@Testcontainers(disabledWithoutDocker = true)
class MySqlImperativeConnectionLossChaosTest extends AbstractMySqlConnectionLossChaosTest {
    @Override
