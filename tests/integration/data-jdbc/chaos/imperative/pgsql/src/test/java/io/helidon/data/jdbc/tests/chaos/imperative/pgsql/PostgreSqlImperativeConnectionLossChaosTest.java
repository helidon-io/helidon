...
/**
 * Runs native PostgreSQL session loss through public imperative {@code JdbcClient} operations.
 */
@Testcontainers(disabledWithoutDocker = true)
class PostgreSqlImperativeConnectionLossChaosTest extends AbstractPostgreSqlConnectionLossChaosTest {
    @Override
