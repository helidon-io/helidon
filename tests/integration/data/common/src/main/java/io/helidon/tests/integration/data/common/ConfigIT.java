...
public class ConfigIT {
    ...
    private static final String CONFIG_PROPERTY_NAME="io.helidon.tests.integration.data.config";

    private static final String DEFAULT_CONFIG_FILE="test.yaml";

    /**
     * Retrieve configuration file from {@code io.helidon.tests.integration.data.config}
     * property if exists.
