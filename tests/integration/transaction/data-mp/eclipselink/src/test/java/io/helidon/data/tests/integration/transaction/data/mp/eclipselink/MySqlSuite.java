 ...
 */
package io.helidon.data.tests.integration.transaction.data.mp.eclipselink;
...
public class MySqlSuite implements SuiteProvider {
    ...
    public void beforeSuite() {
        ...
        // register an MP config created from our SE config
        // and then use existing configuration in the tests (see below)
        providerResolver
