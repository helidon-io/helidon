 ...
 */
package io.helidon.tests.integration.dbclient.app.it.transaction;
...
public class TransactionQueriesIT {
    ...
    private void executeTest(String testName, Pokemon pokemon) {
        LOGGER.log(Level.DEBUG, () -> String.format("Running TransactionQueriesIT.%s on client", testName));
