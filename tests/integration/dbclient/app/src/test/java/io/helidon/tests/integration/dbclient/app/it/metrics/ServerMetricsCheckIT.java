 ...
 */
package io.helidon.tests.integration.dbclient.app.it.metrics;
...
public class ServerMetricsCheckIT {
    ...
    public void testHttpMetrics() {
        LOGGER.log(System.Logger.Level.DEBUG, "Running ServerMetricsCheckIT.testHttpMetrics on client");
