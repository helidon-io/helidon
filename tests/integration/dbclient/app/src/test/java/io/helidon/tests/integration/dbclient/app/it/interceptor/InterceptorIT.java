 ...
 */
package io.helidon.tests.integration.dbclient.app.it.interceptor;

import io.helidon.common.LazyValue;
import io.helidon.tests.integration.dbclient.app.it.metrics.ServerMetricsCheckIT;
...
public class InterceptorIT {
    ...
    public void testStatementInterceptor() {
        LOGGER.log(System.Logger.Level.DEBUG, "Running InterceptorIT.testStatementInterceptor on client");
        testClient.get().callServiceAndGetData("testStatementInterceptor");
    }
