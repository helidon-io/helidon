...
@Builder(defineDefaultMethods = true, allowNulls = true)
public interface HelidonOpenApiConfig extends FakeOpenApiConfig {
    ...
    /**
     * Override to mix-in the {@link io.helidon.builder.Singular} annotation.
     */
    @Override
    @Singular
