...
/**
 * A representation of a JSON-RPC request params. Provides access to each param
 * as well as conversions.
 */
public interface JsonRpcParams {

    /**
     * Check if params have been included in the request. Note that this
     * method will return {@code false} for an empty object or array.
     *
     * @return {@code true} if params are set, {@code false} otherwise
     */
    boolean isPresent();
