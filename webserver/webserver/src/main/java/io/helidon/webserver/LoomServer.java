...
class LoomServer implements WebServer {
    ...
    private void registerShutdownHook() {
        this.shutdownHandler = new ServerShutdownHandler(LOGGER, listeners, startFutures, running, context.id());
    ...
    private static final class ServerShutdownHandler implements HelidonShutdownHandler {
        ...
        private ServerShutdownHandler(System.Logger logger,
                                      Map<String, ServerListener> listeners,
