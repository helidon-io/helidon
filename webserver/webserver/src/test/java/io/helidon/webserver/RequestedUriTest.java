...
class RequestedUriTest {
    ...
    private static class TestData {
        ...
        private final List<SocketConfiguration.RequestedUriDiscoveryType> discoveryTypes;
        private final AllowList trustedProxies;
        private final Map<String, List<String>> headers;
        private final HttpRequest.Path path;
        private final UriInfo expectedUriInfo;

        private TestData(String testDescription,
            ...
            this.path = path;
            this.expectedUriInfo = expectedUriInfo;
        }
        ...
        private List<SocketConfiguration.RequestedUriDiscoveryType> discoveryTypes() {
        ...
        private UriInfo expectedUriInfo() {
            return expectedUriInfo;
        }
