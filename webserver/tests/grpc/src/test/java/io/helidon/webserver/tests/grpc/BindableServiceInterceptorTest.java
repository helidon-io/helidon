...
/**
 * Shows interception of {@link io.grpc.BindableService} methods. Should
 * take into account any {@link io.helidon.common.Weight}s associated with
 * the interceptors.
 */
@ServerTest
class BindableServiceInterceptorTest extends BaseInterceptorTest {
    ...
    BindableServiceInterceptorTest(WebServer server) {
        super(server);
    }
