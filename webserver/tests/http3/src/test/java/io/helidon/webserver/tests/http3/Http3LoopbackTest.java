...
class Http3LoopbackTest {
    ...
    @Test
    void shouldServeSharedRouteOverIpv6Loopback() throws Exception {
        Assumptions.assumeTrue(Http3TestSupport.ipv6LoopbackAvailable(), "IPv6 loopback is not available.");
