 ...
 * <p>
 * Use {@link io.helidon.webserver.cors.CorsSupport} and its {@link io.helidon.webserver.cors.CorsSupport.Builder} to
 * add CORS
 * handling to resources in your application.
 * <p>
 * Because Helidon WebServer does not use annotation processing to identify endpoints, you need to provide the CORS information for
 * your application another way. You can use Helidon configuration, the Helidon WebServer CORS API, or a combination.
 * <h2>Configuration</h2>
 * <h3>Format</h3>
 ...
 * Although Helidon WebServer prescribes the CORS config format, you can put it wherever you want in your application's configuration
 ...
 *
 * <h2>The Helidon WebServer CORS API</h2>
 ...
 * Also, note that you have to make sure you use the same path in this API call and in your {@code MyApp} service if you adjust
 * the routing there.
 * <p>
