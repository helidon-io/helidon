 ...
 * }</pre> Use {@link io.helidon.config.Config.Builder} to construct a new {@code Config} instance
 * from one or more specific {@link io.helidon.config.spi.ConfigSource}s using the {@link #builder()}.
 * <p>
 ...
 * </tr>
 * <tr>
 * <td>{@link io.helidon.config.ConfigSources#create}</td>
 * <td>{@link io.helidon.config.spi.ConfigSource}</td>
 ...
 * </tr>
 * <tr>
 * <td>{@link io.helidon.config.OverrideSources}</td>
 * <td></td>
 ...
 * a URL, or in a file, or by invoking {@link io.helidon.config.OverrideSources#create} and passing
 * the name-matching expressions and the corresponding replacement value as a
 * {@code Map}.</td>
 * </tr>
 * <tr>
 * <td>{@link Builder#addMapper(Class, java.util.function.Function)}</td>
 ...
 * fully-qualified name to {@link io.helidon.config.Config#get}:
 * <pre>{@code
 * Config greeting = config.get("greeting");
 * }</pre> Method {@link #key()} always returns fully-qualified
 * {@link io.helidon.config.Config.Key} of a config node.
 * <pre>{@code
 ...
 * </ul>
 * <p>
 * To get node value, use {@link #as(Class)} to access this config node as a {@link io.helidon.config.ConfigValue}
 *
 ...
 * which return {@link io.helidon.config.ConfigValue} representing Java primitive data values ({@code boolean, double, int}, etc.)
 * <p>
 * The {@link io.helidon.config.ConfigValue} can be used to access the value or use optional style methods.
 *
 * The config value provides access to the value in multiple ways.
 * See {@link io.helidon.config.ConfigValue} for reference.
 *
 * Basic usages:
 * <pre>{@code
 ...
 *   }</pre>
 * </li>
 * <li>{@link #as(java.util.function.Function)} to convert the config node using the function provided.
 ...
 * }</pre>
 * </li>
 * <li>{@link #as(io.helidon.common.GenericType)} to convert the config node to an instance of the specified generic type, if there is a
 ...
 * mapping logic by:
 * <ul>
 * <li>invoking the {@link io.helidon.config.Config#as(java.util.function.Function)} method variants, </li>
 * <li>adding custom mapping function implementations using the
 * {@link Builder#addMapper(Class, java.util.function.Function)} method,</li>
 * <li>add custom mapping function using the {@link Builder#addStringMapper(Class, java.util.function.Function)}</li>
 ...
 * throws {@link io.helidon.config.ConfigMappingException}, unless you use the config beans support,
 ...
 * {@link #create}, might be associated with multiple {@link io.helidon.config.spi.ConfigSource}s. The
 * config system deals with multiple sources as follows.
 * <p>
 * The {@link io.helidon.config.ConfigSources.CompositeBuilder} class handles multiple config
 * sources; in fact the config system uses an instance of that builder
 * automatically when your application invokes {@link io.helidon.config.Config#create} and
 * {@link io.helidon.config.Config#builder}, for example. Each such composite builder has a
 ...
 * the {@link io.helidon.config.FallbackMergingStrategy}: configuration sources earlier in the
 ...
 * {@link io.helidon.config.ConfigSources.CompositeBuilder#mergingStrategy(io.helidon.config.ConfigSources.MergingStrategy)}, passing the strategy
 * to be used:
 * <pre>
...
public interface Config {
    ...
    /**
     * Returns a new default {@link io.helidon.config.Config} loaded using one of the
     ...
     * <p>
     * Meta-configuration specifies at least one {@link io.helidon.config.spi.ConfigSource} or
     * {@link io.helidon.config.Config.Builder} from which the system can load configuration. The
     ...
     * <ol type="a">
     * <li>{@link io.helidon.config.ConfigSources#environmentVariables() environment variables};</li>
     * <li>{@link io.helidon.config.ConfigSources#systemProperties() system properties}</li>
     ...
     * which has neither a {@link io.helidon.config.PollingStrategies#nop() polling strategy} nor
     * a {@link io.helidon.config.RetryPolicies#justCall() retry policy}. To set up these and other
     ...
     *
     * @return new instance of {@link io.helidon.config.Config}
     */
    ...
    /**
     * Creates a new {@link io.helidon.config.Config} loaded from environment variables, system
     * properties, and the specified {@link io.helidon.config.spi.ConfigSource}s.
     * <p>
     * The resulting configuration uses the following sources, in order:
     * <ol>
     * <li>{@link io.helidon.config.ConfigSources#environmentVariables() environment variables config source}<br>
     * Can disabled by {@link Builder#disableEnvironmentVariablesSource()}</li>
     * <li>{@link io.helidon.config.ConfigSources#systemProperties() system properties config source}
     ...
     * @return new instance of {@link io.helidon.config.Config}
     * @see #builder(java.util.function.Supplier[])
     * @see Builder#sources(java.util.List)
     * @see Builder#disableEnvironmentVariablesSource()
     * @see Builder#disableSystemPropertiesSource()
     * @see io.helidon.config.ConfigSources#create(java.util.function.Supplier[])
     * @see io.helidon.config.ConfigSources.CompositeBuilder
     * @see io.helidon.config.ConfigSources.MergingStrategy
     */
    @SafeVarargs
    ...
    /**
     * Provides a {@link Builder} for creating a {@link io.helidon.config.Config}
     * based on the specified {@link io.helidon.config.spi.ConfigSource} instances.
     * <p>
     * The resulting configuration uses the following sources, in order:
     * <ol>
     * <li>{@link io.helidon.config.ConfigSources#environmentVariables() environment variables}<br>
     * Can be disabled by invoking {@link Builder#disableEnvironmentVariablesSource()}</li>
     * <li>{@link io.helidon.config.ConfigSources#systemProperties() system properties config source}<br>
     ...
     * @see #builder()
     * @see #create(java.util.function.Supplier[])
     * @see Builder#sources(java.util.List)
     * @see Builder#disableEnvironmentVariablesSource()
     * @see Builder#disableSystemPropertiesSource()
     * @see io.helidon.config.ConfigSources#create(java.util.function.Supplier[])
    ...
    /**
     * Provides a {@link Builder} for creating a {@link io.helidon.config.Config} instance.
     *
     ...
     * @throws io.helidon.config.ConfigMappingException in case the String provided cannot be converted to the type expected
     * @see io.helidon.config.Config#as(Class)
     */
    ...
    /**
     * Typed value as a {@link io.helidon.config.ConfigValue} for a generic type.
    ...
    /**
     * Typed value as a {@link io.helidon.config.ConfigValue}.
     *
     * @param type type class
     * @param <T>  type
     * @return typed value
     * @see io.helidon.config.ConfigValue#map(java.util.function.Function)
     * @see io.helidon.config.ConfigValue#supplier()
     * @see io.helidon.config.ConfigValue#get()
     * @see io.helidon.config.ConfigValue#orElse(Object)
     */
    <T> ConfigValue<T> as(Class<T> type);

    /**
     * Typed value as a {@link io.helidon.config.ConfigValue} created from factory method.
     * To convert from String, you can use
     * {@link #asString() config.asString()}{@link io.helidon.config.ConfigValue#as(java.util.function.Function) .as(Function)}.
     *
     ...
     * @throws io.helidon.config.ConfigMappingException in case of problem to map property value.
     */
     ...
     * @param <T>    type of list elements
     * @return a typed list with values
     * @throws io.helidon.config.ConfigMappingException in case the mapper fails to map the values
     */
    <T> ConfigValue<List<T>> asList(Function<Config, T> mapper) throws ConfigMappingException;

    /**
     * Returns existing current config node as a {@link java.util.Optional} instance
     * or {@link java.util.Optional#empty()} in case of {@link Type#MISSING} node.
     *
     * @return current config node as a {@link java.util.Optional} instance
     *         or {@link java.util.Optional#empty()} in case of {@link Type#MISSING} node.
     */
     ...
     * Throws {@link io.helidon.config.MissingValueException} if the node is {@link Type#MISSING}.
     * Otherwise, if node is {@link Type#VALUE}, it throws {@link io.helidon.config.ConfigMappingException}.
     *
     * @return a list of {@link Type#OBJECT} members or a list of {@link Type#LIST} members
     * @throws io.helidon.config.ConfigMappingException in case the node is {@link Type#VALUE}
     */
     ...
     * @throws io.helidon.config.MissingValueException in case the node is {@link Type#MISSING}.
     * @see #traverse()
     * @see #detach()
     */
     ...
     * }</pre>
     *
     * @see io.helidon.config.Config#key()
     */
    interface Key extends Comparable<Key> {
         ...
         * @see io.helidon.config.Config#name()
         */
        String name();
    ...
    /**
     * Context associated with specific {@link io.helidon.config.Config} node that allows to access the last loaded instance of the node
    ...
    interface Context {
         ...
         * @see io.helidon.config.Config#timestamp()
         */
        Instant timestamp();

        /**
         * Returns instance of Config node related to same Config {@link io.helidon.config.Config#key() key}
         * as original {@link io.helidon.config.Config#context() node} used to get Context from.
         * <p>
         ...
         * @see io.helidon.config.Config#context()
         */
        Config last();

        /**
         * Requests reloading of whole configuration and returns new instance of
         * Config node related to same Config {@link io.helidon.config.Config#key() key}
         * as original {@link io.helidon.config.Config#context() node} used to get Context from.
         *
         * @return the new instance of Config node associated with same key as original node
         * @see io.helidon.config.Config.Builder
         */
        Config reload();
    }

    /**
     * {@link io.helidon.config.Config} Builder.
     * <p>
     ...
     * <li>{@code sources} - instances of {@link io.helidon.config.spi.ConfigSource configuration source};</li>
     ...
     * the mapping attempt throws a {@link io.helidon.config.ConfigMappingException}.
     * <p>
     ...
     * <p>
     * If a {@link io.helidon.config.spi.ConfigSource} is not specified, following default config source is used. Same as {@link #create()} uses.
     ...
     * <ol>
     * <li>{@link io.helidon.config.ConfigSources#environmentVariables() Environment variables};</li>
     * <li>or else {@link io.helidon.config.ConfigSources#systemProperties() System properties}</li>
     ...
     * </ol>
     *
     * @see io.helidon.config.Config#create()
    ...
    interface Builder {
        ...
        /**
         * Sets ordered list of {@link io.helidon.config.spi.ConfigSource} instance to be used as single source of configuration
         * to be wrapped into {@link io.helidon.config.Config} API.
         * <p>
         ...
         * {@link io.helidon.config.ConfigSources#create(java.util.function.Supplier...)} Composite ConfigSource} provided by
         * {@link io.helidon.config.ConfigSources.MergingStrategy#fallback() Fallback MergingStrategy}.
         * It is possible to {@link io.helidon.config.ConfigSources.CompositeBuilder#mergingStrategy(io.helidon.config.ConfigSources.MergingStrategy)
        ...
        /**
         * Sets a {@link io.helidon.config.spi.ConfigSource} instance to be used as a source of configuration to be wrapped into {@link io.helidon.config.Config} API.
         * <p>
         ...
         * @return an updated builder instance
         * @see io.helidon.config.Config#create(java.util.function.Supplier...)
         * @see #sources(java.util.List)
         * @see #disableEnvironmentVariablesSource()
         * @see #disableSystemPropertiesSource()
         */
        ...
        /**
         * Sets an ordered pair of {@link io.helidon.config.spi.ConfigSource} instances to be used as single source of configuration
         * to be wrapped into {@link io.helidon.config.Config} API.
         * <p>
         * Target source is composed from {@code configSource} and following sources (unless they are disabled) in order:
         * <ol>
        ...
        /**
         * Sets an ordered trio of {@link io.helidon.config.spi.ConfigSource} instances to be used as single source of configuration
         * to be wrapped into {@link io.helidon.config.Config} API.
         * <p>
        ...
        Builder addOverride(OverrideSource overridingSource);
        ...
        /**
         * Disables use of {@link io.helidon.config.ConfigSources#environmentVariables() environment variables config source}.
         *
         * @return an updated builder instance
         * @see io.helidon.config.ConfigSources#environmentVariables()
         */
        Builder disableEnvironmentVariablesSource();

        /**
         * Disables use of {@link io.helidon.config.ConfigSources#systemProperties() system properties config source}.
         *
         * @return an updated builder instance
         * @see io.helidon.config.ConfigSources#systemProperties()
         */
         ...
         * <p>
         * And the last option, {@link io.helidon.config.ConfigMappers built-in mappers} are registered.
         *
         * @param type   class of type the {@code mapper} is registered for
         * @param mapper mapping function
         * @param <T>    type the {@code mapper} is registered for
         * @return an updated builder instance
         * @see #addStringMapper(Class, java.util.function.Function)
        ...
        /**
         * Register a mapping function for specified {@link io.helidon.common.GenericType}.
         ...
         * {@link ConfigMapperProvider#mapper(io.helidon.common.GenericType)}.
         *
        ...
        /**
         * Registers simple {@link java.util.function.Function} from {@code String} for specified {@code type}.
         * The last registration of same {@code type} overwrites previous one.
         * Programmatically registered mappers have priority over other options.
         * <p>
         * As another option, mappers are loaded automatically as a {@link java.util.ServiceLoader service}
         ...
         * @return an updated builder instance
         * @see #addMapper(ConfigMapperProvider)
         * @see io.helidon.config.ConfigMappers
         * @see #disableMapperServices
         */
        ...
        /**
         * Registers a {@link ConfigParser} instance that can be used by registered {@link io.helidon.config.spi.ConfigSource}s to
         * parse {@link ConfigParser.Content configuration content}.
         * Parsers are tried to be used by {@link ConfigContext#findParser(String)}
        ...
        /**
         * Registers a {@link ConfigFilter} instance that will be used by {@link io.helidon.config.Config} to
         ...
         * #addFilter(java.util.function.Function)} or {@link #addFilter(java.util.function.Supplier)} method.
         * <p>
         ...
         * @return an updated builder instance
         * @see #addFilter(java.util.function.Function)
         * @see #addFilter(java.util.function.Supplier)
         */
        Builder addFilter(ConfigFilter configFilter);

        /**
         * Registers a {@link ConfigFilter} provider as a {@link java.util.function.Function}&lt;{@link io.helidon.config.Config}, {@link ConfigFilter}&gt;. An
         * obtained filter will be used by {@link io.helidon.config.Config} to filter elementary value before it is returned to a user.
         * <p>
         * Filters are applied in same order as was registered by the {@link #addFilter(ConfigFilter)}, {@link
         * #addFilter(java.util.function.Function)} or {@link #addFilter(java.util.function.Supplier)} method.
         * <p>
         * Registered provider's {@link java.util.function.Function#apply(Object)} method is called every time the new Config is created. Eg. when
         * this builder's {@link #build} method creates the {@link io.helidon.config.Config} or when the new
         * {@link io.helidon.config.Config#onChange(java.util.function.Consumer)} is fired with new Config instance with its own filter instance
         * is created.
         *
         * @param configFilterProvider a config filter provider as a function of {@link io.helidon.config.Config} to {@link ConfigFilter}
         * @return an updated builder instance
        ...
        /**
         * Registers a {@link ConfigFilter} provider as a {@link java.util.function.Supplier}&lt;{@link java.util.function.Function}&lt;{@link io.helidon.config.Config}, {@link
         * ConfigFilter}&gt;&gt;. An obtained filter will be used by {@link io.helidon.config.Config} to filter elementary value before it is
         * returned to a user.
         * <p>
         * Filters are applied in same order as was registered by the {@link #addFilter(ConfigFilter)}, {@link
         * #addFilter(java.util.function.Function)} or {@link #addFilter(java.util.function.Supplier)} method.
         ...
         * Registered provider's {@link java.util.function.Function#apply(Object)} method is called every time the new Config is created. Eg. when
         * this builder's {@link #build} method creates the {@link io.helidon.config.Config} or when the new
         * {@link io.helidon.config.Config#onChange(java.util.function.Consumer)} change event
         * is fired with new Config instance with its own filter instance is created.
         *
         * @param configFilterSupplier a config filter provider as a supplier of a function of {@link io.helidon.config.Config} to {@link
         *                             ConfigFilter}
         * @return an updated builder instance
         * @see #addFilter(ConfigFilter)
         * @see #addFilter(java.util.function.Function)
        ...
        /**
         * Disables caching of elementary configuration values on {@link io.helidon.config.Config} side.
         * <p>
        ...
        /**
         * Specifies "observe-on" {@link java.util.concurrent.Executor} to be used by {@link io.helidon.config.Config#onChange(java.util.function.Consumer)} to deliver
         * new Config instance.
         * Executor is also used to process reloading of config from appropriate {@link io.helidon.config.spi.ConfigSource#changes() source}.
         * <p>
         ...
         *
         * @param changesExecutor the executor to use for async delivery of {@link io.helidon.config.Config#onChange(java.util.function.Consumer)}
         * @return an updated builder instance
         * @see #changesMaxBuffer(int)
         * @see io.helidon.config.Config#onChange(java.util.function.Consumer)
         */
        Builder changesExecutor(Executor changesExecutor);

        /**
         * Specifies maximum capacity for each subscriber's buffer to be used by
         * {@link io.helidon.config.Config#onChange(java.util.function.Consumer)} to deliver new Config instance.
         * <p>
        ...
        /**
         * Builds new instance of {@link io.helidon.config.Config}.
         *
         * @return new instance of {@link io.helidon.config.Config}.
         */
        Config build();
         ...
         *     <td>{@link io.helidon.config.spi.ConfigSourceProvider#create(String, io.helidon.config.Config)}</td>
         * </tr>
         * <tr>
         *     <td>properties</td>
         *     <td>&nbsp;</td>
         *     <td>Configuration options to configure the config source (meta configuration of a source)</td>
         *     <td>{@link io.helidon.config.spi.ConfigSourceProvider#create(String, io.helidon.config.Config)},
         *      {@link io.helidon.config.MetaConfig#configSource(io.helidon.config.Config)}</td>
         * </tr>
         * <tr>
         ...
         *          {@link io.helidon.config.MetaConfig#pollingStrategy(io.helidon.config.Config)}</td>
         * </tr>
         * <tr>
         ...
         *          {@link io.helidon.config.MetaConfig#retryPolicy(io.helidon.config.Config)}</td>
         * </tr>
         * </table>
         *
