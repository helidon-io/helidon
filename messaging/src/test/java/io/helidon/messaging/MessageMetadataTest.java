...
class MessageMetadataTest {
    ...
    void storesSingleValuesUnderExactNames() {
        MessageMetadata metadata = MessageMetadata.builder()
                ...
                .set("failure", MessageHeaderValue.integer(42))
                .build();
        ...
        assertThat(metadata.value("failure").orElseThrow(), is(MessageHeaderValue.integer(42)));
    ...
    void snapshotsBuilderAndExposesImmutableValues() {
        ...
        assertThat(metadata.values(), is(Map.of("a", MessageHeaderValue.text("original"))));
        assertThrows(UnsupportedOperationException.class,
                     () -> metadata.values().put("mutable", MessageHeaderValue.text("false")));
    }
    ...
    void mergesReplacesRemovesAndClearsValues() {
        MessageMetadata added = MessageMetadata.builder()
                .set("replace", "new")
                .set("added", MessageHeaderValue.booleanValue(true))
                .build();
        ...
        assertThat(builder.build().values(),
                   is(Map.of("retained", MessageHeaderValue.text("value"),
                             "replace", MessageHeaderValue.text("new"),
                             "added", MessageHeaderValue.booleanValue(true))));
    ...
    void validatesArgumentsWithoutChangingBuilder() {
        ...
        assertThat(builder.build().values(), is(Map.of("a", MessageHeaderValue.text("original"))));
    }
}
