...
class MessageMetadataTest {
    ...
    void storesSingleValuesUnderExactNames() {
        MessageMetadata metadata = MessageMetadata.builder()
                ...
                .set("failure", MessageHeaderValue.IntegerValue.create(42))
                .build();
        ...
        assertThat(metadata.value("failure").orElseThrow(), is(MessageHeaderValue.IntegerValue.create(42)));
    ...
    void snapshotsBuilderAndExposesImmutableValues() {
        ...
        assertThat(metadata.values(), is(Map.of("a", MessageHeaderValue.TextValue.create("original"))));
        assertThrows(UnsupportedOperationException.class,
                     () -> metadata.values().put("mutable", MessageHeaderValue.TextValue.create("false")));
    }
    ...
    void mergesReplacesRemovesAndClearsValues() {
        MessageMetadata added = MessageMetadata.builder()
                .set("replace", "new")
                .set("added", MessageHeaderValue.BooleanValue.create(true))
                .build();
        ...
        assertThat(builder.build().values(),
                   is(Map.of("retained", MessageHeaderValue.TextValue.create("value"),
                             "replace", MessageHeaderValue.TextValue.create("new"),
                             "added", MessageHeaderValue.BooleanValue.create(true))));
    ...
    void supportsStandardBuilderShapeAndCopying() {
        MessageMetadata original = MessageMetadata.builder().set("first", "value").build();

        MessageMetadata copy = MessageMetadata.builder(original)
                .update(builder -> builder.set("second", "value"))
                .get();

        assertThat(copy.values(),
                   is(Map.of("first", MessageHeaderValue.TextValue.create("value"),
                             "second", MessageHeaderValue.TextValue.create("value"))));
        assertThrows(NullPointerException.class, () -> MessageMetadata.builder(null));
        assertThrows(NullPointerException.class, () -> MessageMetadata.builder().from(null));
    }
    ...
    void validatesArgumentsWithoutChangingBuilder() {
        ...
        assertThat(builder.build().values(), is(Map.of("a", MessageHeaderValue.TextValue.create("original"))));
    }
}
