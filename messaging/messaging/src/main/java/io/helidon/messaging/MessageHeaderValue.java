 ...
 * Instances are created through the {@code create} factory on each permitted value type.
 */
@Api.Preview
public sealed interface MessageHeaderValue permits MessageHeaderValue.NullValue,
    ...
    final class TextValue implements MessageHeaderValue {
        ...
        public static TextValue create(String value) {
            return new TextValue(Objects.requireNonNull(value, "value"));
        }
    ...
    final class IntegerValue implements MessageHeaderValue {
         ...
         */
        public static IntegerValue create(long value) {
         ...
         * @throws NullPointerException if {@code value} is {@code null}
         */
        public static IntegerValue create(BigInteger value) {
            return new IntegerValue(Objects.requireNonNull(value, "value"));
        }
    ...
    final class DecimalValue implements MessageHeaderValue {
         ...
         * @throws NullPointerException if {@code value} is {@code null}
         */
        public static DecimalValue create(BigDecimal value) {
            return new DecimalValue(Objects.requireNonNull(value, "value"));
        }
    ...
    final class Float32Value implements MessageHeaderValue {
         ...
         */
        public static Float32Value create(float value) {
    ...
    final class Float64Value implements MessageHeaderValue {
         ...
         * @return floating-point value
         */
        public static Float64Value create(double value) {
    ...
    final class TimestampValue implements MessageHeaderValue {
        ...
        public static TimestampValue create(Instant value) {
            return new TimestampValue(Objects.requireNonNull(value, "value"));
        }
    ...
    final class UuidValue implements MessageHeaderValue {
         ...
         * @throws NullPointerException if {@code value} is {@code null}
         */
        public static UuidValue create(UUID value) {
            return new UuidValue(Objects.requireNonNull(value, "value"));
        }
    ...
    final class BinaryValue implements MessageHeaderValue {
        ...
        public static BinaryValue create(byte[] value) {
            return new BinaryValue(Objects.requireNonNull(value, "value"));
        }
    ...
    final class NativeValue implements MessageHeaderValue {
         ...
         * <p>
         * The type identifier must identify the connector or encoding well enough for a consumer to interpret the
         * bytes. This value does not imply Java serialization or cross-connector portability; another connector can
         * interpret it only when both connectors share the identified encoding.
         *
         * @param typeId non-blank type identifier
         * @param value encoded bytes to copy
         * @return native encoded value
         * @throws NullPointerException if {@code typeId} or {@code value} is {@code null}
         * @throws IllegalArgumentException if {@code typeId} is blank
         */
        public static NativeValue create(String typeId, byte[] value) {
            String actualTypeId = Objects.requireNonNull(typeId, "typeId");
            if (actualTypeId.isBlank()) {
                throw new IllegalArgumentException("Native messaging value type identifier must not be blank");
            }
            return new NativeValue(actualTypeId, Objects.requireNonNull(value, "value"));
        }
