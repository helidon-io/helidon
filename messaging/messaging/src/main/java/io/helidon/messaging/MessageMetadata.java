...
public sealed interface MessageMetadata permits MessageMetadataImpl {
     ...
     */
    static Builder builder(MessageMetadata metadata) {
        return builder().from(metadata);
    }
     ...
     */
    final class Builder implements io.helidon.common.Builder<Builder, MessageMetadata> {
         ...
         * @throws NullPointerException if {@code metadata} is {@code null}
         */
        public Builder from(MessageMetadata metadata) {
            return addAll(metadata);
        }
        ...
        public Builder set(String name, String value) {
            String actualName = Objects.requireNonNull(name);
            MessageHeaderValue actualValue = MessageHeaderValue.TextValue.create(value);
            values.put(actualName, actualValue);
            return this;
        }
