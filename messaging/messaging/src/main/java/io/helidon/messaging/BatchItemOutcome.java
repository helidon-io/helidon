...
public final class BatchItemOutcome {
     ...
     * @return outcome
     */
    public static BatchItemOutcome failed(int index) {
        return new BatchItemOutcome(index, BatchItemStatus.FAILED, null);
    }
    ...
    public static BatchItemOutcome failed(int index, Throwable failure) {
        return new BatchItemOutcome(index, BatchItemStatus.FAILED, Objects.requireNonNull(failure, "failure"));
    }
     ...
     * @return outcome
     */
    public static BatchItemOutcome indeterminate(int index) {
        return new BatchItemOutcome(index, BatchItemStatus.INDETERMINATE, null);
    }
    ...
    public static BatchItemOutcome indeterminate(int index, Throwable failure) {
        return new BatchItemOutcome(index, BatchItemStatus.INDETERMINATE, Objects.requireNonNull(failure, "failure"));
    }
