...
public class MessagingRejectedException extends MessagingException {
     ...
     * @throws NullPointerException if {@code channel} or {@code reason} is {@code null}
     */
     ...
     * @throws NullPointerException if {@code channel}, {@code reason}, or {@code message} is {@code null}
     */
     ...
     * @throws NullPointerException if {@code channel}, {@code reason}, {@code message}, or {@code cause} is
     *                              {@code null}
     */
