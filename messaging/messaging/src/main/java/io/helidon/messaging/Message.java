 ...
 * the batch passed to {@link ConnectorDeliveryReservation#startFailed(MessageBatch, RuntimeException)} or
 * {@link ConnectorDeliveryReservation#tryStartFailed(MessageBatch, RuntimeException)}. Portable headers
