...
import static io.helidon.openapi.v30.OpenApiDocumentMapperSupport.validateDocumentStructure;
import static io.helidon.openapi.v30.OpenApiDocumentMapperSupport.validateMediaTypes;
import static io.helidon.openapi.v30.OpenApiDocumentMapperSupport.validateOperationIds;
import static io.helidon.openapi.v30.OpenApiDocumentMapperSupport.validateQueryStringParameters;
import static io.helidon.openapi.v30.OpenApiDocumentMapperSupport.validateSchemas;
...
final class OpenApi32DocumentMapper {
    ...
    static OpenApiDocument parse(Map<String, ?> document) {
        ...
        validateDocumentStructure(document, MAPPER_RULES);
        validateSchemas(document, MAPPER_RULES);
        Map<String, Object> mapped = document3x(document, MAPPER_RULES);
        validateDocumentStructure(mapped, MAPPER_RULES);
        validateSchemas(mapped, MAPPER_RULES);
        validateQueryStringParameters(mapped, MAPPER_RULES);
        validateMediaTypes(mapped, MAPPER_RULES);
        validateOperationIds(mapped);
        return OpenApiDocumentReader.read(jsonObject(mapped));
    }
    ...
    static Map<String, Object> render(OpenApiDocument document, String version) {
        ...
        validateDocumentStructure(rendered, MAPPER_RULES);
        validateSchemas(rendered, MAPPER_RULES);
        validateQueryStringParameters(rendered, MAPPER_RULES);
        validateMediaTypes(rendered, MAPPER_RULES);
        validateOperationIds(rendered);
