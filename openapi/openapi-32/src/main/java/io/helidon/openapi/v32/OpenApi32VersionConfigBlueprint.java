...
@Api.Preview
@Prototype.Blueprint
@Prototype.Configured(value = OpenApi32Version.TYPE, root = false)
@Prototype.Provides(OpenApiVersionProvider.class)
interface OpenApi32VersionConfigBlueprint extends Prototype.Factory<OpenApi32Version> {
    /**
     * Name of this version configuration.
     *
     * @return version implementation name
     */
    @Option.Default(OpenApi32Version.TYPE)
    String name();
