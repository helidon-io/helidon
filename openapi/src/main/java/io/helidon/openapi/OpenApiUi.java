 ...
 */
public interface OpenApiUi extends HttpService {

    /**
     * Default subcontext within the {@link OpenApiFeature} instance's web context
     * (which itself defaults to {@value OpenApiFeature#DEFAULT_CONTEXT}.
     */
    ...
    interface Builder<B extends Builder<B, T>, T extends OpenApiUi> extends io.helidon.common.Builder<B, T> {
        ...
        /**
         * Config prefix within the {@value OpenApiFeature.Builder#CONFIG_KEY} section containing UI settings.
         */
         ...
         * {@value io.helidon.openapi.OpenApiFeature.Builder#CONFIG_KEY} config section.
         *
