...
public class TestUtil {
     ...
     * @throws java.io.IOException in case of errors reading the HTTP response payload
     */
    public static String stringYAMLFromResponse(HttpURLConnection cnx) throws IOException {
        ...
        assertThat("Unexpected returned media type",
                returnedMediaType.test(MediaTypes.APPLICATION_OPENAPI_YAML), is(true));
    ...
    public static HttpMediaType mediaTypeFromResponse(HttpURLConnection cnx) {
        ...
        if (!returnedMediaType.charset().isPresent()) {
            returnedMediaType = HttpMediaType.builder()
     ...
     * @throws java.io.IOException in case of errors reading the returned payload as
     * config
     */
     ...
     * @throws java.io.IOException in case of errors reading the response
     */
     ...
     * @throws java.util.concurrent.ExecutionException if the stop operation failed as it ran
     * @throws java.util.concurrent.TimeoutException if the stop operation timed out
     */
     ...
     * @throws InterruptedException if the start was interrupted
    ...
    public static WebServer startServer(
        ...
        for (OpenApiFeature.Builder<?, ?> openApiBuilder : openApiBuilders) {
     ...
     * @throws java.io.IOException in case of errors reading the response payload
     */
