...
public final class OpenApi {
     ...
     * <p>
     * Declarative OpenAPI generation supports {@link #SIMPLE} style for path and header parameters, {@link #COOKIE}
     * style for cookie parameters in OpenAPI 3.2, {@link #FORM} style for cookie parameters in earlier OpenAPI versions,
     * and {@link #FORM}, {@link #SPACE_DELIMITED}, or {@link #PIPE_DELIMITED} style for query parameters. Delimited query
     * styles require list-valued parameters and cannot use {@link Explode#TRUE}. Header parameters cannot use
     * {@link Explode#TRUE}. {@link #DEEP_OBJECT}, {@link #MATRIX}, and {@link #LABEL} are not supported by declarative HTTP
     * parameter binding.
     */
    public enum Style {
        /**
     ...
     * {@link #required()} to make an optional input required. A required input cannot be documented as optional because
     ...
     * Type-level usage on a declarative REST endpoint contract also applies to its implementations.
     * An inherited empty container conflicts with a non-empty security requirement from an unrelated endpoint contract
     * and causes declarative OpenAPI code generation to fail.
