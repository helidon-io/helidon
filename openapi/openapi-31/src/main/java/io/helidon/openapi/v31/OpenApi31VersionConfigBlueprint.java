...
@Api.Preview
@Prototype.Blueprint
@Prototype.Configured(value = OpenApi31Version.TYPE, root = false)
@Prototype.Provides(OpenApiVersionProvider.class)
interface OpenApi31VersionConfigBlueprint extends Prototype.Factory<OpenApi31Version> {
    /**
     * Name of this version configuration.
     *
     * @return version implementation name
     */
    @Option.Default(OpenApi31Version.TYPE)
    String name();
