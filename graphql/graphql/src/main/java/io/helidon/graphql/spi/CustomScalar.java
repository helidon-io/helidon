 ...
 * <p>
 * Declarative integrations generate the matching {@link GraphQlScalar} adapter from the annotated scalar Java type and
 * delegate conversion to this contract.
 *
...
@Api.Since("27.0.0")
@Service.Contract
public interface CustomScalar<T> {
    /**
