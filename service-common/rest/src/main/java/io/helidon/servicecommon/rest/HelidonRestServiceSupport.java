...
public abstract class HelidonRestServiceSupport implements RestServiceSupport {
    ...
    public abstract static class Builder<B extends Builder<B, T>, T extends HelidonRestServiceSupport>
        ...
        /**
         * Creates a new buider using the provided class and default web context.
         *
         * @param builderClass class of {@code Builder}
         ...
         * @return updated builder instance
         */
        @ConfiguredOption(key = CorsEnabledServiceHelper.CORS_CONFIG_KEY, type = CrossOriginConfig.Builder.class)
