 ...
 * <p>
 * This service owns propagation and lifecycle notification. A
 * {@link TxLifeCycle} listener in the data JDBC provider associates
 * connections lazily, so this module does not depend on the data module.
 */
@Service.Singleton
